# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/management/administration/users.py#3 $
...
ENTRY_USER_NAME_LINK_EXTUSER  = lambda table_name,row: '//%s/table[@class=\'pairs\']/tbody/tr[%s]/th[1]/text()' % (table_name,row,)
ENTRY_USER_VALUE_LINK_EXTUSER  = lambda table_name,row: '//%s/table[@class=\'pairs\']/tbody/tr[%s]/td[1]/text()' % (table_name,row,)
...
class Users(GuiCommon):
    ...
    def users_edit_external_authentication(self, auth_type, radius_servers=None,
        ...
        Parameters:
            - `auth_type`: authentication type to use: 'LDAP' or 'RADIUS'.
