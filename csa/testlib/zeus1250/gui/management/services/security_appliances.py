# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/management/services/security_appliances.py#3 $
...
DELETE_WEB_APPL_TABLE_CELL = lambda row: WEB_APPL_TABLE_PREFIX + \
    "table[not(following-sibling::div[@class='group'])][1]//tr[%s]/td[7]/img" % (row,)
...
class SecurityAppliances(GuiCommon):
    ...
    def security_appliances_edit_web_appliance(self, name, newname=None,
        ...
        config_master=None, establish_timeout=60):
