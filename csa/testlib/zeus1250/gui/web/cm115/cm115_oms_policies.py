#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm115/cm115_oms_policies.py#3 $ $DateTime: 2019/06/07 02:45:52 $ $Author: sarukakk $

from coeus1100.gui.manager.oms_policies import OMS_Policies
class Cm110OmsPolicies(OMS_Policies):

    """
    Keywords library for WebUI page Web -> Configuration Master 11.5 -> Outbound Malware Scanning
    """
    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.5', 'Outbound Malware Scanning')

    def get_keyword_names(self):
        return [
             'cm115_oms_policies_add',
             'cm115_oms_policies_delete',
             'cm115_oms_policies_edit',
             'cm115_oms_policies_edit_destinations',
             'cm115_oms_policies_edit_amw_filters'
             ]

    def cm115_oms_policies_add(self,
            name,
            description=None,
            order=None,
            identities=None,
            ...
            match_agents=None):
        """Add new policy from Configuration Master 11.5
        ...
        *Examples*
        | CM115 OMS Policies Add | three | description=Adding policy  |
        ...
        | ... | user_agents=ie-all |
        | CM115 OMS Policies Add | zero | subnets=192.168.20.0/24  |
        """
    ...
    def cm115_oms_policies_edit(self,
            name,
            description=None,
            order=None,
            identities=None,
            ...
            common_user_agents=None,
            match_agents=None):
        """Edits specified policy from Configuration Master 11.5
        ...
        *Examples*
        | CM115 OMS Policies Edit | three | description=Editing policy |
        ...
        | CM115 OMS Policies Edit | zero | subnets=192.168.20.0/24 |
        """
    ...
    def cm115_oms_policies_delete(self, name):
        """Deletes specified policy from Configuration Master 11.5
        ...
        *Example*
        | CM115 OMS Policies Delete | three |
        """
        self.oms_policies_delete(name)

    def cm115_oms_policies_edit_amw_filters(self,
             name,
             settings_type,
             amw_actions=None,
             amw_select_all=None,
        ...
        *Examples*
        | CM115 OMS Policies Edit AMW Filters | three | global |
    ...
    def cm115_oms_policies_edit_destinations(self,
             name,
             settings_type,
             dest_to_scan=None,
             cust_url=None,
