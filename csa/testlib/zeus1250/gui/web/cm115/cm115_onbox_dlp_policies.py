# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm115/cm115_onbox_dlp_policies.py#3 $ $DateTime: 2019/06/07 02:45:52 $ $Author: sarukakk $
...
class Cm110OnboxDlpPolicies(OnboxDlpPolicies):
    ...
    """
    Keywords for Web -> Configuration Master 11.5 -> Cisco Data Security
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.5', 'Cisco Data Security')

    def get_keyword_names(self):
        return [
             'cm115_onbox_dlp_policies_add',
             'cm115_onbox_dlp_policies_delete',
             'cm115_onbox_dlp_policies_edit',
             'cm115_onbox_dlp_policies_edit_url_categories',
             'cm115_onbox_dlp_policies_edit_content',
             'cm115_onbox_dlp_policies_edit_wbrs',
             ]

    def cm115_onbox_dlp_policies_add(self,
            name,
            description=None,
            order=None,
            ...
            user_agents=None,
            match_agents=True):
        """Add new IDS policy from Configuration Master 11.5
        ...
        *Examples*
        | CM115 Onbox DLP Policies Add | three | description=Adding policy |
        ...
        | ... | user_agents=ie-all |
        | CM115 Onbox DLP Policies Add | zero | description=other policy |
        """
    ...
    def cm115_onbox_dlp_policies_delete(self, name):
        """Delete IDS policy from Configuration Master 11.5
        ...
        *Examples*
        | CM115 Onbox DLP Policies Delete | three |
        """
        self.onbox_dlp_policies_delete(name)

    def cm115_onbox_dlp_policies_edit(self,
            name,
            new_name=None,
            description=None,
            order=None,
            ...
            user_agents=None,
            match_agents=True):
        """Edit IDS policy from Configuration Master 11.5
        ...
        *Examples*
        | CM115 Onbox DLP Policies Edit | three | description=Adding policy |
        | ... | identities=Global Identity Policy | protocols=http, ftpoverhttp |
    ...
    def cm115_onbox_dlp_policies_edit_url_categories(self,
            name,
            set_custom_all=None,
        ...
        *Examples*
        | CM115 Onbox DLP Policies Edit URL Categories  | three |
    ...
    def cm115_onbox_dlp_policies_edit_content(self,
            name,
        ...
        """Edit content setting for IDS policy from Configuration Master 11.5
        ...
        *Examples*
        | CM115 Onbox DLP Policies Edit Content | three | blocking_settings=custom |
        ...
        | CM115 Onbox DLP Policies Edit Content | zero | http_file_size=10 mb |
    ...
    def cm115_onbox_dlp_policies_edit_wbrs(self,
            name,
            settings_type=None,
            score=None,
            ):

        """Edit the WBRS for the IDS policy  from Configuration Master 11.5
        ...
        *Examples*
        | CM115 Onbox DLP Policies Edit WBRS | three | settings_type=custom  |
        | CM115 Onbox DLP Policies Edit WBRS | zero | settings_type=custom  |
        """
