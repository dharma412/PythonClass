# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm115/cm115_socks_policies.py#3 $
...
class Cm110SOCKSPolicies(SOCKSPolicies):
    """
    Keywords for Web -> Configuration Master 11.5 -> SOCKS Policies
    """
    def _open_page(self):
        """Go to SOCKS Policies configuration page."""

        self._navigate_to('Web', 'Configuration Master 11.5', 'SOCKS Policies')
    ...
    def get_keyword_names(self):
        return ['cm115_socks_policies_add',
             'cm115_socks_policies_edit',
             'cm115_socks_policies_delete',
             'cm115_socks_policies_edit_destination_ports',
             'cm115_socks_policies_edit_destination_urls',
             'cm115_socks_policies_disable_policy',
             'cm115_socks_policies_enable_policy',
             'cm115_socks_policies_is_enabled_policy',
             'cm115_socks_policies_get_list',
             ]

    def cm115_socks_policies_add(self,
        name,
        description=None,
        order=None,
        identities=None,
        ...
        Examples:
        - | CM115 SOCKS Policies Add | myDefaultPol | description=This policy uses Global Identity Policy | identities=Global Identity Policy |
        - | CM115 SOCKS Policies Add | myOtherPol | description=This policy uses specified identity | identities=myID:authenticated |
        - | CM115 SOCKS Policies Add | myOtherPol2 | proxy_ports=10110 |
    ...
    def cm115_socks_policies_delete(self, name):
        ...
        Example:
        - | CM115 SOCKS Policies Delete | myDefaultPol |
    ...
    def cm115_socks_policies_edit(self,
        name,
        new_name=None,
        description=None,
        order=None,
    ...
    def cm115_socks_policies_edit_destination_ports(self,
        name,
        ports_settings=None,
        tcp_ports=None,
        udp_ports=None,
        ...
        Examples:
        - | CM115 SOCKS Policies Edit Destination Ports | myPolicy |
    ...
    def cm115_socks_policies_edit_destination_urls(self,
        name,
        setting_type=None,
        ...
        Examples:
        - | CM115 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=global |
        - | CM115 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=block_all |
        - | CM115 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=allow_all |
        - | CM115 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=allow_specified | specified_url_categories=all |
        - | CM115 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=allow_specified | specified_url_categories=cats, dogs |
    ...
    def cm115_socks_policies_is_enabled_policy(self, name):
        ...
        Examples:
            | ${enabled}= | CM115 SOCKS Policies Is Enabled Policy | myDefaultAccPol |
        """

        self._open_page()
        return self._is_enabled(name)

    def cm115_socks_policies_get_list(self):
        """
        ...
        | ${policies}= | CM115 SOCKS Policies Get List |
    ...
    def cm115_socks_policies_enable_policy(self, name):
        ...
        Examples:
            | CM115 SOCKS Policies Enable Policy | myDefaultPol |
        """

        self._open_page()
        self._enable(name)

    def cm115_socks_policies_disable_policy(self, name):
        ...
        Examples:
            | CM115 SOCKS Policies Disable Policy | myDefaultPol |
        """
