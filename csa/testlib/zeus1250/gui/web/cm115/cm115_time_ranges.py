# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm115/cm115_time_ranges.py#3 $
# $DateTime: 2019/06/07 02:45:52 $
#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm115/cm115_time_ranges.py#3 $ $DateTime: 2019/06/07 02:45:52 $ $Author: sarukakk $

from coeus1100.gui.manager.time_ranges import TimeRanges

class Cm110TimeRanges(TimeRanges):

    """
    Keywords for Web -> Configuration Master 11.5 -> Defined Time Ranges
    """

    def _open_define_timerange_and_quota_page(self):
        self._navigate_to('Web', 'Configuration Master 11.5', 'Defined Time Ranges')

    def get_keyword_names(self):
        return [
             'cm115_time_ranges_add',
             'cm115_time_ranges_edit',
             'cm115_time_ranges_delete',
             'cm115_time_ranges_get_list',
             ]

    def cm115_time_ranges_get_list(self):
        """
        ...
        | ${policies}= | CM115 Time Ranges Get List |
    ...
    def cm115_time_ranges_add(self,
             name,
             week_days,
             region=None,
             country=None,
             time_zone=None,
             time_of_day='all day'):
        """Adds new custom time range from Configuration Master 11.5
        ...
        *Examples*
        | CM115 Time Ranges Add | myTime | Monday,Thursday |
        | CM115 Time Ranges Add | myTime | Monday,Thursday | time_of_day=09:00,111.00 |
        | CM115 Time Ranges Add | myTime | Monday,Thursday | region=Europe |
    ...
    def cm115_time_ranges_edit(self,
             name,
             week_days,
             row=0,
             region=None,
             ...
             time_zone=None,
             time_of_day='all day'):
        """Edits the custom time range from Configuration Master 11.5
        ...
        *Examples*
        | CM115 Time Ranges Edit | myTime | Monday,Sunday | region=Pacific |
        | ... | country=Fiji | time_zone= Fiji | time_of_day=09:00,19:00 |
        | CM115 Time Ranges Edit | myTime | Monday,Wednesday | row=1 |
    ...
    def cm115_time_ranges_delete(self, name):
        """Deletes the custom time range from Configuration Master 11.5
        ...
        *Example*
        | CM115 Time Ranges Delete | myTimeRange |
        """
        self._open_define_timerange_and_quota_page()
