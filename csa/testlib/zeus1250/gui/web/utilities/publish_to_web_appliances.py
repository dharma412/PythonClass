#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/utilities/publish_to_web_appliances.py#3 $
...
APPLIANCES_CHECKBOX_CELL =\
    lambda row: "//div[@id='add_edit_job_appliances_list_div']//table//tr[%s]/td[1]/div/input[@name='appliances_list[]']" %\
    (row)
