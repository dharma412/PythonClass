# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/utilities/configuration_masters.py#3 $ $DateTime: 2019/06/07 02:45:52 $ $Author: sarukakk $
...
EDIT_ASSIGNMENT_BUTTON = 'xpath=//input[@value="Edit Appliance Assignment List..."]'
DISABLED_EDIT_ASSIGNMENT_BUTTON = 'xpath=//input[@value="Edit Appliance Assignment List..." '\
...
class ConfigurationMasters(GuiCommon):
    ...
    def edit_config_master(self,config_master):
        ...
        for i in range(2,rows+3):
            ...
            if self._is_element_present(CONFIG_MASTER_VALUE(i, 1)):
                 if self.get_text(CONFIG_MASTER_VALUE(i,1)) == config_master:
                     print "config_master", config_master
