#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/utilities/publish_history.py#3 $
...
class PublishHistory(GuiCommon):
    ...
    def _get_job_appliances(self, job_name):
        ...
        appliance_details_loc = "//*[normalize-space(text())='%s']/ancestor-or-self::*[parent::dd]/following-sibling::table[1]//tr" % ('Appliance Details for Job',)
    ...
    def _get_job_appliance_data(self, job_name, appliance_name):
        ...
        appliance_row = "//*[normalize-space(text())='%s']/ancestor-or-self::*[parent::dd]/following-sibling::table[1]//a[normalize-space(text())='%s']/ancestor::tr[1]" % ('Appliance Details for Job', appliance_name)
