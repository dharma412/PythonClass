# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm118/cm118_edit_policy_order.py#3 $
...
class Cm110EditPolicyOrder(GuiCommon):
    """ Keywords for CM118 Edit Policy Order page where policies
    can be ordered by drag-and-drop.
    """
    def get_keyword_names(self):
        return [
             'cm118_edit_policy_order',
             ]

    def _open_policy_page(self, policy):
        """Go to specific Policies page."""
        self._navigate_to('Web', 'Configuration Master 11.8', policy)
    ...
    def cm118_edit_policy_order(self, policy, submit, *items):
        ...
        *Parameters:*
        ...
        to be reordered. It is string containing name of menu item in CM118 menu.
        Requried.
        ...
        *Examples:*
        | CM118 Edit Policy Order | Identities | ${True} |
        | Policy 1 | Policy 2 |

        | CM118 Edit Policy Order | SOCKS Policies | ${True} |
        | Policy 1 |
        | Policy 2 |
        | Policy 3 |
        | Policy 4 |
