# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm118/cm118_time_ranges.py#3 $
# $DateTime: 2019/06/07 02:45:52 $
#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm118/cm118_time_ranges.py#3 $ $DateTime: 2019/06/07 02:45:52 $ $Author: sarukakk $

from coeus1180.gui.manager.time_ranges import TimeRanges

class Cm110TimeRanges(TimeRanges):

    """
    Keywords for Web -> Configuration Master 11.8 -> Defined Time Ranges
    """

    def _open_define_timerange_and_quota_page(self):
        self._navigate_to('Web', 'Configuration Master 11.8', 'Defined Time Ranges')

    def get_keyword_names(self):
        return [
             'cm118_time_ranges_add',
             'cm118_time_ranges_edit',
             'cm118_time_ranges_delete',
             'cm118_time_ranges_get_list',
             ]

    def cm118_time_ranges_get_list(self):
        """
        ...
        | ${policies}= | CM118 Time Ranges Get List |
    ...
    def cm118_time_ranges_add(self,
             name,
             week_days,
             region=None,
             country=None,
             time_zone=None,
             time_of_day='all day'):
        """Adds new custom time range from Configuration Master 11.8
        ...
        *Examples*
        | CM118 Time Ranges Add | myTime | Monday,Thursday |
        | CM118 Time Ranges Add | myTime | Monday,Thursday | time_of_day=09:00,111.00 |
        | CM118 Time Ranges Add | myTime | Monday,Thursday | region=Europe |
    ...
    def cm118_time_ranges_edit(self,
             name,
             week_days,
             row=0,
             region=None,
             ...
             time_zone=None,
             time_of_day='all day'):
        """Edits the custom time range from Configuration Master 11.8
        ...
        *Examples*
        | CM118 Time Ranges Edit | myTime | Monday,Sunday | region=Pacific |
        | ... | country=Fiji | time_zone= Fiji | time_of_day=09:00,19:00 |
        | CM118 Time Ranges Edit | myTime | Monday,Wednesday | row=1 |
    ...
    def cm118_time_ranges_delete(self, name):
        """Deletes the custom time range from Configuration Master 11.8
        ...
        *Example*
        | CM118 Time Ranges Delete | myTimeRange |
        """
        self._open_define_timerange_and_quota_page()
