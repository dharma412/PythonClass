# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm118/cm118_offbox_dlp_policies.py#3 $ $DateTime: 2019/06/07 02:45:52 $ $Author: sarukakk $

from coeus1180.gui.manager.offbox_dlp_policies import OffboxDlpPolicies

class Cm110OffboxDlpPolicies(OffboxDlpPolicies):
    """
    Keywords for Web -> Configuration Master 11.8 -> External Data Loss Prevention
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.8', 'External Data Loss Prevention')

    def get_keyword_names(self):
        return [
             'cm118_offbox_dlp_policies_add',
             'cm118_offbox_dlp_policies_delete',
             'cm118_offbox_dlp_policies_edit',
             'cm118_offbox_dlp_policies_edit_destinations'
             ]

    def cm118_offbox_dlp_policies_add(self,
            name,
            description=None,
            order=1,
            ...
            user_agents=None,
            match_agents=True):
        """Add new DLP policy from Configuration Master 11.8
        ...
        *Examples*
        | CM118 Offbox DLP Policies Add | three | description=Adding policy  |
        ...
        | CM118 Offbox DLP Policies Add | zero |
        """
    ...
    def cm118_offbox_dlp_policies_edit(self,
            name,
            new_name=None,
            description=None,
            order=1,
            ...
            user_agents=None,
            match_agents=True):
        """Edit DLP policy from Configuration Master 11.8
        ...
        *Examples*
        | CM118 Offbox DLP Policies Edit |
        ...
        | CM118 Offbox DLP Policies Edit | zero | protocols=others |
        """
    ...
    def cm118_offbox_dlp_policies_delete(self, name):
        """Delete DLP policy from Configuration Master 11.8
        ...
        *Examples*
        | CM118 Offbox DLP Policies Delete | three |
        """
        self.offbox_dlp_policies_delete(name)

    def cm118_offbox_dlp_policies_edit_destinations(self,
            name,
            scan_uploads=None,
            url_categories=None,
            settings_type=None):
