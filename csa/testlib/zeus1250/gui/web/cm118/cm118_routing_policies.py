# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm118/cm118_routing_policies.py#3 $
# $DateTime: 2019/06/07 02:45:52 $
#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm118/cm118_routing_policies.py#3 $ $DateTime: 2019/06/07 02:45:52 $  $Author: sarukakk $

from coeus1180.gui.manager.routing_policies import RoutingPolicies
class Cm110RoutingPolicies(RoutingPolicies):

    """
    Keywords for Web -> Configuration Master 11.8 -> Routing Policies
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.8', 'Routing Policies')

    def get_keyword_names(self):
        return [
             'cm118_routing_policies_add',
             'cm118_routing_policies_delete',
             'cm118_routing_policies_edit',
             'cm118_routing_policies_edit_destination',
             'cm118_routing_policies_get_list',
             ]

    def cm118_routing_policies_get_list(self):
        """
    ...
    def cm118_routing_policies_add(self,
            ...
            match_agents=True):
        """
        Add new routing policy from Configuration Master 11.8
        ...
        *Examples*
        | CM118 Routing Policies Add | three | description=Adding policy |
    ...
    def cm118_routing_policies_edit(self,
            name,
            description=None,
            order=None,
            identities=None,
            ...
            match_agents=True):
        """
        Edit routing policy from Configuration Master 11.8
        ...
        *Examples*
        | CM118 RoutingPolicies Edit | three | description=Editing policy |
        | ... | order=None | identities=Global Identity Policy |
        ...
        | CM118 RoutingPolicies Edit | zero | new description |
        """
    ...
    def cm118_routing_policies_delete(self, name):
        """
        Delete routing policy from Configuration Master 11.8

        *Parameters*
        - `name`: name of the policy to delete.

        *Example*
        | CM118 RoutingPolicies Delete | three |

        """
        self.routing_policies_delete(name)

    def cm118_routing_policies_edit_destination(self, name, proxy_group):
        """
        Setup the destination for given routing policy from Configuration Master 11.8
        ...
        *Examples*
        | CM118 RoutingPolicies Edit Destination| three | upstream2 |
        | CM118 RoutingPolicies Edit Destination| three | Use Global Policy Settings |
