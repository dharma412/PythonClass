# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm117/cm117_decryption_policies.py#3 $
# $DateTime: 2019/06/07 02:45:52 $
#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm117/cm117_decryption_policies.py#3 $ $DateTime: 2019/06/07 02:45:52 $ $Author: sarukakk $

from coeus1170.gui.manager.decryption_policies import DecryptionPolicies

class Cm110DecryptionPolicies(DecryptionPolicies):

    """
    Keywords library for WebUI page Web -> Configuration Master 11.7 -> Decryption Policies
    """

    def _open_decr_policy_page(self):
        self._navigate_to('Web', 'Configuration Master 11.7', 'Decryption Policies')

    def get_keyword_names(self):
        return ['cm117_decryption_policies_add',
             'cm117_decryption_policies_delete',
             'cm117_decryption_policies_edit',
             'cm117_decryption_policies_edit_url_categories',
             'cm117_decryption_policies_edit_default_action',
             'cm117_decryption_policies_edit_wbrs',
             'cm117_decryption_policies_get_list',
             ]

    def cm117_decryption_policies_get_list(self):
        """
    ...
    def cm117_decryption_policies_add(self,
             ...
             user_agents=None,
             match_agents=True):
        """Adds new decryption policy from Configuration Master 11.7
        ...
        *Examples*
        | CM117 Decryption Policies Add | myDefaultDecrPol |
        | ... | description=This policy uses Global Identity Policy |
        | ... | identities=Global Identity Policy |
        | CM117 Decryption Policies Add | myOtherDecrPol |
    ...
    def cm117_decryption_policies_delete(self, name):
        """Deletes specified decryption policy from Configuration Master 11.7
        ...
        *Example*
        | CM117 Decryption Policies Delete | myDecrPol |
        """
        self.decryption_policies_delete(name)

    def cm117_decryption_policies_edit(self,
             name,
             new_name=None,
             description=None,
             order=None,
             ...
             user_agents=None,
             match_agents=True):
        """Edits decryption policy from Configuration Master 11.7
        ...
        *Examples*
        | CM117 Decryption Policies Edit | myDecrPol |
        | ... | identities=All Identities:selected:joe.smith |
        | CM117 Decryption Policies Edit | myDecrPol |
        | ... | identities=All Identities:all | time_range=myTime |
        | ... | proxy_ports=3128 |
        | CM117 Decryption Policies Edit | myDecrPol | identities=All Identities |
    ...
    def cm117_decryption_policies_edit_url_categories(self,
             name,
             url_categories=None,
        ...
        *Examples*
        ...
        | CM117 Decryption Policies Edit Url Categories | ${id1} |
    ...
    def cm117_decryption_policies_edit_wbrs(self,
             name,
             score_range=None,
        ...
        *Examples*
        | CM117 Decryption Policies Edit Wbrs | myDecrPol | setting_type=disable |
        | CM117 Decryption Policies Edit Wbrs | myDecrPol |
    ...
    def cm117_decryption_policies_edit_default_action(self, name, action):
        ...
        *Exceptions*
        ...
        Example:
        | CM117 Decryption Policies Edit Default Action | myDecrPol | action=decrypt |
        """
