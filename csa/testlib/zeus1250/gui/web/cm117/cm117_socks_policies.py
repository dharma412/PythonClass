# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm117/cm117_socks_policies.py#3 $
# $DateTime: 2019/06/07 02:45:52 $
# $Author: sarukakk $

import common.gui.guiexceptions as guiexceptions
from coeus1170.gui.manager.socks_policies import SOCKSPolicies

class Cm110SOCKSPolicies(SOCKSPolicies):
    """
    Keywords for Web -> Configuration Master 11.7 -> SOCKS Policies
    """
    def _open_page(self):
        """Go to SOCKS Policies configuration page."""

        self._navigate_to('Web', 'Configuration Master 11.7', 'SOCKS Policies')
    ...
    def get_keyword_names(self):
        return ['cm117_socks_policies_add',
             'cm117_socks_policies_edit',
             'cm117_socks_policies_delete',
             'cm117_socks_policies_edit_destination_ports',
             'cm117_socks_policies_edit_destination_urls',
             'cm117_socks_policies_disable_policy',
             'cm117_socks_policies_enable_policy',
             'cm117_socks_policies_is_enabled_policy',
             'cm117_socks_policies_get_list',
             ]

    def cm117_socks_policies_add(self,
        name,
        description=None,
        order=None,
        identities=None,
        ...
        Examples:
        - | CM117 SOCKS Policies Add | myDefaultPol | description=This policy uses Global Identity Policy | identities=Global Identity Policy |
        - | CM117 SOCKS Policies Add | myOtherPol | description=This policy uses specified identity | identities=myID:authenticated |
        - | CM117 SOCKS Policies Add | myOtherPol2 | proxy_ports=10110 |
    ...
    def cm117_socks_policies_delete(self, name):
        ...
        Example:
        - | CM117 SOCKS Policies Delete | myDefaultPol |
    ...
    def cm117_socks_policies_edit(self,
        name,
        new_name=None,
        description=None,
        order=None,
    ...
    def cm117_socks_policies_edit_destination_ports(self,
        name,
        ports_settings=None,
        tcp_ports=None,
        udp_ports=None,
        ...
        Examples:
        - | CM117 SOCKS Policies Edit Destination Ports | myPolicy |
    ...
    def cm117_socks_policies_edit_destination_urls(self,
        name,
        setting_type=None,
        ...
        Examples:
        - | CM117 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=global |
        - | CM117 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=block_all |
        - | CM117 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=allow_all |
        - | CM117 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=allow_specified | specified_url_categories=all |
        - | CM117 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=allow_specified | specified_url_categories=cats, dogs |
    ...
    def cm117_socks_policies_is_enabled_policy(self, name):
        ...
        Examples:
            | ${enabled}= | CM117 SOCKS Policies Is Enabled Policy | myDefaultAccPol |
        """

        self._open_page()
        return self._is_enabled(name)

    def cm117_socks_policies_get_list(self):
        """
        ...
        | ${policies}= | CM117 SOCKS Policies Get List |
    ...
    def cm117_socks_policies_enable_policy(self, name):
        ...
        Examples:
            | CM117 SOCKS Policies Enable Policy | myDefaultPol |
        """

        self._open_page()
        self._enable(name)

    def cm117_socks_policies_disable_policy(self, name):
        ...
        Examples:
            | CM117 SOCKS Policies Disable Policy | myDefaultPol |
        """
