# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm117/cm117_identities.py#3 $
# $DateTime: 2019/06/07 02:45:52 $
# $Author: sarukakk $
#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm117/cm117_identities.py#3 $ $DateTime: 2019/06/07 02:45:52 $ $Author: sarukakk $

from coeus1170.gui.manager.identities import Identities

class Cm110Identities(Identities):
    """
    Keywords library for WebUI page Web -> Configuration Master 11.7 -> Identities
    """
    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.7', 'Identification Profiles')

    def get_keyword_names(self):
        return [
             'cm117_identities_add_policy',
             'cm117_identities_edit_policy',
             'cm117_identities_delete_policy',
             'cm117_identities_enable_policy',
             'cm117_identities_disable_policy',
             'cm117_identities_is_enabled_policy',
             'cm117_identities_get_list',
             ]

    def cm117_identities_get_list(self):
        """
        ...
        | ${policies}= | CM117 Identities Get List |
    ...
    def cm117_identities_add_policy(self,
        name,
        description=None,
        order=None,
        subnet=None,
        ...
        """Adds new identity policy from Configuration Master 11.7
        ...
        *Examples*
        ...
        self.identities_add_policy(
            ...
            use_machine_id=use_machine_id,
            machine_ids=machine_ids,
            machine_groups=machine_groups,
            ise_fallback=ise_fallback
        )

    def cm117_identities_edit_policy(self,
        name,
        new_name=None,
        description=None,
        order=None,
        ...
        """Edits existing identity policy from Configuration Master 11.7
        ...
        *Examples*
           ...
           | ... | subnet=1.2.3.0/24 |
           | Identities Edit policy | subnet | proxy_ports=110, 3128 |
        """
    ...
    def cm117_identities_delete_policy(self, name):
        """Deletes existing identity policy from Configuration Master 11.7

        *Parameters*
        - `name`: name of identity to be deleted.

        *Example*
        | CM117 Identities Delete Policy | myID |
        """
        self.identities_delete_policy(name)

    def cm117_identities_enable_policy(self, name):
        """Enables existing identity policy from Configuration Master 11.7

        *Parameters*
        - `name` name of identity to enable

        *Example*
        | CM117 Identities Disable Policy | myID |
        """

        self.identities_enable_policy(name)

    def cm117_identities_disable_policy(self, name):
        """Disables existing identity policy from Configuration Master 11.7
    ...
    def cm117_identities_is_enabled_policy(self, name):
        ...
        *Examples*
            | ${enabled}= | CM117 Identities Is Enabled Policy | myID |
        """
