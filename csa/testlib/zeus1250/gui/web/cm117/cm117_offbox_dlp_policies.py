# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm117/cm117_offbox_dlp_policies.py#3 $ $DateTime: 2019/06/07 02:45:52 $ $Author: sarukakk $

from coeus1170.gui.manager.offbox_dlp_policies import OffboxDlpPolicies

class Cm110OffboxDlpPolicies(OffboxDlpPolicies):
    """
    Keywords for Web -> Configuration Master 11.7 -> External Data Loss Prevention
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.7', 'External Data Loss Prevention')

    def get_keyword_names(self):
        return [
             'cm117_offbox_dlp_policies_add',
             'cm117_offbox_dlp_policies_delete',
             'cm117_offbox_dlp_policies_edit',
             'cm117_offbox_dlp_policies_edit_destinations'
             ]

    def cm117_offbox_dlp_policies_add(self,
            name,
            description=None,
            order=1,
            ...
            user_agents=None,
            match_agents=True):
        """Add new DLP policy from Configuration Master 11.7
        ...
        *Examples*
        | CM117 Offbox DLP Policies Add | three | description=Adding policy  |
        ...
        | CM117 Offbox DLP Policies Add | zero |
        """
    ...
    def cm117_offbox_dlp_policies_edit(self,
            name,
            new_name=None,
            description=None,
            order=1,
            ...
            user_agents=None,
            match_agents=True):
        """Edit DLP policy from Configuration Master 11.7
        ...
        *Examples*
        | CM117 Offbox DLP Policies Edit |
        ...
        | CM117 Offbox DLP Policies Edit | zero | protocols=others |
        """
    ...
    def cm117_offbox_dlp_policies_delete(self, name):
        """Delete DLP policy from Configuration Master 11.7
        ...
        *Examples*
        | CM117 Offbox DLP Policies Delete | three |
        """
        self.offbox_dlp_policies_delete(name)

    def cm117_offbox_dlp_policies_edit_destinations(self,
            name,
            scan_uploads=None,
            url_categories=None,
            settings_type=None):
