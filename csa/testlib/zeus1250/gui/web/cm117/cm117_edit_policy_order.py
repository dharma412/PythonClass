# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm117/cm117_edit_policy_order.py#3 $
...
class Cm110EditPolicyOrder(GuiCommon):
    """ Keywords for CM117 Edit Policy Order page where policies
    can be ordered by drag-and-drop.
    """
    def get_keyword_names(self):
        return [
             'cm117_edit_policy_order',
             ]
    ...
    def cm117_edit_policy_order(self, policy, submit, *items):
        ...
        *Parameters:*
        ...
        to be reordered. It is string containing name of menu item in CM117 menu.
        Requried.
        ...
        *Examples:*
        | CM117 Edit Policy Order | Identities | ${True} |
        | Policy 1 | Policy 2 |

        | CM117 Edit Policy Order | SOCKS Policies | ${True} |
        | Policy 1 |
        | Policy 2 |
        | Policy 3 |
        | Policy 4 |
