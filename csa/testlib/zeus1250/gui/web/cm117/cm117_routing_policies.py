# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm117/cm117_routing_policies.py#3 $
# $DateTime: 2019/06/07 02:45:52 $
#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1250/gui/web/cm117/cm117_routing_policies.py#3 $ $DateTime: 2019/06/07 02:45:52 $  $Author: sarukakk $

from coeus1170.gui.manager.routing_policies import RoutingPolicies
class Cm110RoutingPolicies(RoutingPolicies):

    """
    Keywords for Web -> Configuration Master 11.7 -> Routing Policies
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.7', 'Routing Policies')

    def get_keyword_names(self):
        return [
             'cm117_routing_policies_add',
             'cm117_routing_policies_delete',
             'cm117_routing_policies_edit',
             'cm117_routing_policies_edit_destination',
             'cm117_routing_policies_get_list',
             ]

    def cm117_routing_policies_get_list(self):
        """
    ...
    def cm117_routing_policies_add(self,
            ...
            match_agents=True):
        """
        Add new routing policy from Configuration Master 11.7
        ...
        *Examples*
        | CM117 Routing Policies Add | three | description=Adding policy |
    ...
    def cm117_routing_policies_edit(self,
            name,
            description=None,
            order=None,
            identities=None,
            ...
            match_agents=True):
        """
        Edit routing policy from Configuration Master 11.7
        ...
        *Examples*
        | CM117 RoutingPolicies Edit | three | description=Editing policy |
        | ... | order=None | identities=Global Identity Policy |
        ...
        | CM117 RoutingPolicies Edit | zero | new description |
        """
    ...
    def cm117_routing_policies_delete(self, name):
        """
        Delete routing policy from Configuration Master 11.7

        *Parameters*
        - `name`: name of the policy to delete.

        *Example*
        | CM117 RoutingPolicies Delete | three |

        """
        self.routing_policies_delete(name)

    def cm117_routing_policies_edit_destination(self, name, proxy_group):
        """
        Setup the destination for given routing policy from Configuration Master 11.7
        ...
        *Examples*
        | CM117 RoutingPolicies Edit Destination| three | upstream2 |
        | CM117 RoutingPolicies Edit Destination| three | Use Global Policy Settings |
