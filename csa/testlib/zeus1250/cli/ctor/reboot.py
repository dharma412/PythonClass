#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1250/cli/ctor/reboot.py#3 $
...
class reboot(clictorbase.IafCliConfiguratorBase):
    ...
    def __call__(self, delay=30, confirm_continue=YES, just_return=None):
        # added for delay handling.
        command = 'reboot'

        if delay is not None:
            command = ' '.join([command, str(delay)])
