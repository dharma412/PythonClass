...
# $Id: //prod/main/sarf_centos/testlib/phoebe1200/gui/manager/mail_flow_policies_def/policy_edit_controllers.py#2 $ $DateTime: 2019/08/06 22:31:52 $ $Author
...
from policy_properties import Name, ConnectionBehavior, MaxMsgsPerCon, \
    ...
    SpamDetection, AMPDetection, VirusProtection, TLS, \
