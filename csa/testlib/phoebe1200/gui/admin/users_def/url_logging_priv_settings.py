...
# $Id: //prod/main/sarf_centos/testlib/phoebe1200/gui/admin/users_def/url_logging_priv_settings.py#1 $
...
CHECKBOX_XPATH = lambda row: \
    "xpath=//table[@class='cols']/tbody/tr[%s]/td[3]/input" % (row,)


class UrlLoggingPrivSettings(InputsOwner):
    @set_speed(0, 'gui')
