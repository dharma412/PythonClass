...
# $Id: //prod/main/sarf_centos/testlib/phoebe1200/gui/admin/smart_licenses.py#1 $
...
CONFIRM_OK_BUTTON = "//button[@id='yui-gen23-button']"
...
class SmartLicenses(GuiCommon):
    ...
    def smart_license_get_license_details(self):
        ...
        *Return:*
        ...
        Email Security Appliance Anti-Spam License: Not requested
        Email Security Appliance Bounce Verification: In Compliance
        Email Security Appliance Cloudmark Anti-Spam: Not requested
        Email Security Appliance Data Loss Prevention: Not requested
        Email Security Appliance External Threat Feeds: Not requested
        ...
        Email Security Appliance Outbreak Filters: Not requested
        Email Security Appliance PXE Encryption: Not requested
        Email Security Appliance Sophos Anti-Malware: Not requested
