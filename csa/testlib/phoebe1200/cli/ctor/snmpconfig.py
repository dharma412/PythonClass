#! /usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1200/cli/ctor/snmpconfig.py#1 $
...
class snmpconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def setup(self, input_dict=None, **kwargs):
        ...
        param_map['snmpv1v2_network_ipv6'] = ['From which IPv6 networks shall SNMP V1/V2c requests be allowed?',
                                              DEFAULT]
