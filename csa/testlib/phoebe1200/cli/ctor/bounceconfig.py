#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1200/cli/ctor/bounceconfig.py#1 $
...
class bounceconfig(ccb.IafCliConfiguratorBase):
    class ProfileNameExistError(ccb.IafCliError):
        pass

    class ProfileNameError(ccb.IafCliError):
        pass

    class DefaultProfileDeleteError(ccb.IafCliError):
        pass
