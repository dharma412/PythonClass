#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1200/cli/ctor/websecurityadvancedconfig.py#3 $ $DateTime: 2019/08/19 00:11:32 $ $Author: saurgup5 $
...
class websecurityadvancedconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def __call__(self, input_dict=None, **kwargs):
        ...
        param_map['max_urls_attachment'] = [
            'Enter the maximum number of URLs that can be scanned in the attachments in a message:', DEFAULT]
        param_map['max_urls'] = ['Enter the maximum number of URLs that can be scanned in a message body', DEFAULT]
        ...
        param_map['enable_urlfitering_for_shortened_urls'] = ['Do you want to enable URL filtering for shortened URLs',
                                                              DEFAULT]
