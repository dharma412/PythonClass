#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1200/cli/ctor/threatfeedconfig.py#1 $
...
class Setup(threatfeedconfig):
    ...
    def setup(self, input_dict=None, **kwargs):
        ...
        param_map['confirm_disable'] = [
            'The system will no longer scan messages for threats using External Threat Feeds', NO]
