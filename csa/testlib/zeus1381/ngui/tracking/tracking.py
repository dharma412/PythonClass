...
MESSAGE_TRACKING.CISCO_HOSTS = "//*[@name='ciscoHost']"
MESSAGE_TRACKING.ROW_COLLAPSE = "//div[@class='row collapse']"

# Button
MESSAGE_TRACKING.SEARCH_BUTTON = "//*[@id='controlBtn_search0']"
MESSAGE_TRACKING.CLEAR_BUTTON = "//*[@id='controlBtn_clear_search1']"
MESSAGE_TRACKING.SHOW_FILTER = "//*[@class='message-tracking_show-filter-button']"
...
class SearchResult:
    ...
    timestamp = "//*[@id='message-tracking-results__table-details%s']//span[@class='message-tracking-results__table-details_timestamp message-tracking-results__table-details__card-text ng-binding']"
    message_checkbox = "/div/div/div/div/ngsma-search-result-checkbox"
    policy_match_header = "//*[@id='message-tracking-results__table-details%s']//span[@id='message-tracking-results__policies']"
    policy_match_value = "//*[@id='message-tracking-results__table-details%s']//div[@class='message-tracking-results__table-details__card-text message-tracking-results__table-details__policy ng-binding']"
    sender_values = "//*[@id='message-tracking-results__table-details%s']/div[2]/div/div[%s]"
    sender_values_info = "//*[@id='message-tracking-results__table-details%s']/div[2]/div/div[%s]//span"
    ...
    message_mid = "/div/div/div[@class='message-tracking-results__table-details__card-item message-tracking-results__mid']/div"
...
class SearchResultRemediate:
    Remediate_button = "//*[@class='remediate__text ng-scope']"
    remediate_all = "//*[text()='Message Details']//preceding::label[@class='custom_checkbox_inner']"
...
class SearchResultMoreDetails:
    ...
    last_state_value="//div[@class='details-info__content__message-status-container ng-binding']"
    ...
    policy_match = "//*[@translate='message-tracking.search.results.card_titles.incoming']"
    policy_match_value = "//*[@translate='message-tracking.search.results.card_titles.incoming']/../div[2]"
    ...
    summary="//div[@class='processing-details-tabs__content']"
