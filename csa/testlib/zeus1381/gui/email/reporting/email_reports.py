...
class EmailReporting(ReportsBase):
    """
        Keywords for actions and verifications on email reports
        (Overview, Users, email Sites, URL Categories, Application Visibility,
        Anti-Malware, Client Malware Risk, email Reputation Filters, L4 Traffic Monitor,
    ...
    def get_keyword_names(self):
        return [
                'email_reporting_open',
                'email_reporting_select_time_range',
                'email_reporting_select_items_display',
                'email_reporting_select_chart_option',
                'email_reporting_select_table_columns',
                'email_reporting_filter_table',
                'email_reporting_get_table',
                'email_reporting_check_table',
                'email_reporting_get_cell_value',
                'email_reporting_check_cell_value',
                'email_reporting_save_pdf',
                'email_reporting_section_export',
                'email_reporting_follow_table_link',
                'email_reporting_follow_chart_link',
                'email_reporting_check_chart_presence',
                'email_reporting_move_column',
                'email_reporting_sort_column',
        ]

    def _open_page(self, report_type):
        self._navigate_to('email', 'Reporting', report_type)
    ...
    def email_reporting_open(self, report_type, report_subtype=None):
        """
            Open email report (indicated by `report_type` parameter).

            Parameters:
                - `report_type`: Label of email report, indicated in 'Web' > 'Reporting' menu.
                - `report_subtype`: Label of sub-report (like it is on 'Reports by User Location'
                email report), indicated on the report page.

            Examples:
            | email Reporting Open | Users |
        """
    ...
    def email_reporting_select_time_range(self, time_range=None):
        """
            Selects time range for opened email report.
            ...
            Examples:
            | email Reporting Select Time Range |
            | ... | time_range=day |
        """
        self.error_message = ''
    ...
    def email_reporting_select_items_display(self, section_name, items_display=None):
        """
            Selects number of items to display in a table of a section of currently opened email report.
    ...
    def email_reporting_select_chart_option(self, option, chart_number=1):
        """
            Selects columns to display in a table of a section of currently opened email report.
            ...
            Examples:
            | email Reporting Select Chart Option |
            | ... | Bandwidth Used |
            | ... | 1 |
        """
        self.error_message = ''
    ...
    def email_reporting_select_table_columns(self, section_name, columns=None, clear_others=True):
        """
            Selects columns to display in a table of a section of currently opened email report.
            ...
            Examples:
            | email Reporting Select Columns |
            | ... | Users |
            | ... | columns=all |
            | email Reporting Select Columns |
            | ... | Users |
    ...
    def email_reporting_filter_table(self, section_name, filter=None):
        """
            Fiters table in a section of currently opened email report page.
    ...
    def email_reporting_get_table(self, section_name):
        """
    ...
    def email_reporting_check_table(self, section_name, expected_values, data_in_first_column=True, number_precision=None, time_precision=None):
        """
    ...
    def email_reporting_get_cell_value(self, section_name, row, column=None):
        """
            Get value of a cell.
            ...
            Examples:
            | ${item_value}= | email Reporting Get Cell Value |
            | ... | Users |
            | ... | rtester |
    ...
    def email_reporting_check_cell_value(self, section_name, row, column, criterion):
        """
            ...
            Examples:
            | email Reporting Check Cell Value |
            | ... | Users |
            | ... | rtester |
            | ... | Transactions Completed |
            | ... | >0 |
    ...
    def email_reporting_save_pdf(self):
        """
            ...
            Examples:
            | ${filename}= | email Reporting Save PDF |
        """
        return self._pdf()

    def email_reporting_section_export(self, section_name=None):
        """
            ...
            Examples:
            | ${filename}= | email Reporting Section Export | Users |
        """
        return self._export(section_name)

    def email_reporting_follow_table_link(self, section_name, row=None, column=None):
        """
            ...
            Examples:
            | email Reporting Follow Table Link |
            | ... | Users |
            | ... | row=rtester |
    ...
    def email_reporting_follow_chart_link(self, section_name, link):
        """
            Follow a link in a cell of a section on currently opened page.
            ...
            Examples:
            | email Reporting Follow Chart Link |
    ...
    def email_reporting_check_chart_presence(self, section_name):
        """
    ...
    def email_reporting_move_column(self, section_name, column_name, target_column):
        """
    ...
    def email_reporting_sort_column(self, section_name, column_name):
        """
            Change order of table columns.
