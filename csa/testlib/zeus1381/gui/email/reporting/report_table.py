# $Id: //prod/main/sarf_centos/testlib/zeus1360/gui/email/reporting/report_table.py#1 $ $DateTime: 2020/03/05 19:45:32 $ $Author: sarukakk $
...
class ReportTableKeywordsContainer(GuiCommon, object):
