# $Id: //prod/main/sarf_centos/testlib/zeus1380/gui/management/network/ip_interfaces.py#2 $ $DateTime: 2020/06/18 05:28:57 $ $Author: mrmohank $
...
API_HTTP_CHECKBOX = 'api_httpd'
API_HTTP_TEXTBOX = 'api_httpdport'
API_HTTPS_CHECKBOX = 'api_httpsd'
API_HTTPS_TEXTBOX = 'api_httpsdport'
...
class IPInterfaces(GuiCommon):
    ...
    def _select_services(self, ftp, telnet, ssh, http, https, http_redirect,
        isq_http, isq_https, isq_http_redirect, isq_default,api_http,api_https):
        ...
        for checkbox, textbox, value in (
                ...
                (API_HTTP_CHECKBOX, API_HTTP_CHECKBOX, api_http),
                (API_HTTPS_CHECKBOX, API_HTTPS_TEXTBOX, api_https),
    ...
    def ip_interfaces_add(self, name, ip_address, hostname, netmask=None,
        ...
        isq_default=None,api_http_service=None,api_https_service=None):
        """Add new interface.
        ...
        self._select_services(ftp_service, telnet_service, ssh_service,
            ...
            isq_https_service, redirect_isq_http, isq_default,api_http_service,api_https_service)
    ...
    def ip_interfaces_edit(self, name, new_name=None, ip_address=None,
        ...
        isq_https_service=None, redirect_isq_http=None, isq_default=None,api_http_service=None,api_https_service=None):
