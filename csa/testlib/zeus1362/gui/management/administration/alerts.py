#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1362/gui/management/administration/alerts.py#2 $ $DateTime: 2020/06/18 05:28:57 $ $Author: mrmohank $
...
DELETE_RECIPIENT_LINK = lambda index: '%s//tr[%s]//td[6]/img' % (ALERTS_TABLE, index)
