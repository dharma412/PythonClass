#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1362/gui/management/administration/network_access.py#1 $
...
CLI_TIMEOUT_TEXTBOX = 'cli_session_timeout'
...
class NetworkAccess(GuiCommon):
    ...
    def network_access_edit_settings(self, timeout=None, mode=None,
        user_ip=None, proxy_ip=None, header=None,cli_timeout=None):
        ...
        if cli_timeout is not None:
            self.input_text(CLI_TIMEOUT_TEXTBOX, cli_timeout)
