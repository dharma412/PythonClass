#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1380/cli/ctor/destconfig.py#1 $

"""
IAF 2 CLI command: destconfig
"""
...
class destconfig(clictorbase.IafCliConfiguratorBase):
    ...
    class ValidationProfileNameError(IafCliError): pass
    class TableActionError(IafCliError): pass
    class ProfileNameError(IafCliError): pass
    class DomainFindError(IafCliError): pass
    ...
    def new(self, input_dict=None, **kwargs):
        ...
        param_map['msg_per_conn'] = ['apply a messages-per-connection', 
                                           DEFAULT]
        param_map['msg_per_conn_limit'] = \
                       ['max number of messages to deliver', DEFAULT]
    ...
    def default(self, input_dict=None, **kwargs):
        ...
        param_map['msg_per_conn_limit'] = \
                       ['default maximum number of messages', DEFAULT]
    ...
    def setup(self, input_dict=None, **kwargs):
        param_map = IafCliParamMap(end_of_command='Choose the operation')
        param_map['send_alert'] = ['send an alert', DEFAULT]
        param_map.update(input_dict or kwargs)
...
if __name__ == '__main__':
    ...
    destc().new(domain='191.1.1.1', concurrency_config=YES, concurrency='400',
               msg_per_conn=YES, msg_per_conn_limit='55',
    ...
    destc().edit(domain='191.1.1.2', concurrency_config=YES,
                concurrency='123', msg_per_conn=YES, msg_per_conn_limit='60',
                limit_config=YES, limit='40',
    ...
    destc().default(concurrency='123', limit_config=YES, limit='40',
                   msg_per_conn_limit='52', recipients='300', 
