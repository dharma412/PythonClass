...
ENABLE_VALIDATE_LDAP_SERVER_CERTIFICATE_RADIOBUTTON = "//input[@id='ldap_certificate_verify_yes']"
DISABLE_VALIDATE_LDAP_SERVER_CERTIFICATE_RADIOBUTTON = "//input[@id='ldap_certificate_verify_no']"
...
class LDAP(GuiCommon):
    ...
    def ldap_edit_global_settings(self, interface=None, validate_ldap_server=False):
        """Edit global LDAP settings.

        Parameters:
        - `interface`: interface to use for LDAP traffic.
        - 'validate_ldap_server' : Validate LDAP Server Certificate.

        Examples:
        | LDAP Edit Global Settings | Management | ${True} |
        | LDAP Edit Global Settings | Auto | ${False} |
        """
        self._open_page()
        ...
        if validate_ldap_server:
            self._click_radio_button(ENABLE_VALIDATE_LDAP_SERVER_CERTIFICATE_RADIOBUTTON)
        else:
            self._click_radio_button(DISABLE_VALIDATE_LDAP_SERVER_CERTIFICATE_RADIOBUTTON)
