...
class TimeSettings(GuiCommon):
    ...
    def time_settings_edit_settings(self, keeping_method, ntp_servers=None, interface=None, local_time=None,ntp_authentication=None,key_numbers=None,key_passes=None):
