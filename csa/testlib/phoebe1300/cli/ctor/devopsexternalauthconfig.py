#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1300/cli/ctor/devopsexternalauthconfig.py#1 $
# $DateTime: 2019/07/22 05:41:27 $
# $Author: nthallap $

""" SARF ctor class for devopsexternalauthconfig CLI"""
...
class devopsexternalauthconfig(IafCliConfiguratorBase):
    def __init__(self, sess):
        IafCliConfiguratorBase.__init__(self, sess)

    def __call__(self):
        self._writeln('devopsexternalauthconfig')
        self._writeln('SAML')
        return self
    ...
    def new(self, input_dict=None, **kwargs):
        ...
        param_map['idp_profile_name'] = ['Enter the IDP Profile Name', REQUIRED]
        actual_dict = {}
    ...
    def edit_idp(self, input_dict=None, **kwargs):
        ...
        if 'idp_metadata_edit_action' in kwargs:
            ...
            if kwargs['idp_metadata_edit_action'].lower() == 'paste':
                ...
                raise IafUnknownOptionError("Unknown option [%s] passed for " \
                                            "[idp_metadata_edit_action] paramter" % (
                                            kwargs['idp_metadata_edit_action']))
        else:
