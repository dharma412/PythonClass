...
# $Id: //prod/main/sarf_centos/testlib/phoebe1300/cli/ctor/scanconfig.py#2 $
...
class scanconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def safeprint(self, input_dict=None, **kwargs):
        ...
        param_map['use_recommended_image_quality'] = [
            'use the recommended image quality value to safe print an attachment', DEFAULT]
