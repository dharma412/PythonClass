...
# $Id: //prod/main/sarf_centos/testlib/phoebe1300/gui/manager/content_filters_def/incoming_filter_containers.py#3 $
...
from content_filter_properties import MessageBodyOrAttachmentProperty, \
    ...
    GeoCountriesProperty, DomainReputationProperty, ForgedEmailDetectionProperty, \
    SafePrintProperty
