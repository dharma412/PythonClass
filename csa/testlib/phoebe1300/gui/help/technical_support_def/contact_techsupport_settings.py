#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1300/gui/help/technical_support_def/contact_techsupport_settings.py#1 $ $DateTime: 2019/06/27 23:26:24 $ $Author: aminath $
