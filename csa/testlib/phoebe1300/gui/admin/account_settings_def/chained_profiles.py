#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1300/gui/admin/account_settings_def/chained_profiles.py#2 $
# $DateTime: 2019/09/25 07:52:29 $
# $Author: saurgup5 $
...
class ChainedProfiles(InputsOwner, Logger):
    ...
    def set(self, new_value):
        ...
        for index in range(number_of_profiles):
            self.gui.select_from_dropdown_list(
