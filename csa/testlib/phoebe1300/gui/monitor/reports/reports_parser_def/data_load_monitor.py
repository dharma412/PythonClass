...
# $Id: //prod/main/sarf_centos/testlib/phoebe1300/gui/monitor/reports/reports_parser_def/data_load_monitor.py#1 $
...
def change_time_range(gui, new_range):
    current_range = gui._get_selected_label(TIME_RANGE_COMBO)
