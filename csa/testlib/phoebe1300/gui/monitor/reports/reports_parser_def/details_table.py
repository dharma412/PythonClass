# $Id: //prod/main/sarf_centos/testlib/phoebe1300/gui/monitor/reports/reports_parser_def/details_table.py#2 $
# $DateTime: 2019/09/17 22:57:37 $
# $Author: saurgup5 $
...
class DetailsTable(BaseReportingTable):
    ...
    def get_available_table_names(cls):
        return ['User Mail Flow Details', 'Incoming Mail Details',
                ...
                'Past Year Virus Outbreaks', 'Incoming Malicious Threat Files',
                'Completed Analysis Requests from This Appliance',
                'Summary of Top URLs in Incoming Spam Messages',
                'Summary of Incoming Messages Containing Malicious and Neutral URLs',
                'Summary of Top URL Categories in Incoming Messages',
                'Web Interaction Tracking Details',
                'Pending Analysis Requests from This Appliance',
                'Total Incoming Mail Connections by Country',
                'Outgoing Malicious Threat Files', 'External Threat Feed Sources',
                'Summary of Indicator of Compromise (IOC) Matches within Source',
                'Top File Hash', 'External Threat Feed Source Distribution of File Hash',
                'External Threat Feed Source Distribution of URL',
                'External Threat Feed Source Distribution of IP',
                'External Threat Feed Source Distribution of Domain',
                'Top IP', 'Top URL', 'Top Domain',
                'Summary of External Threat Feed Sources by incoming mail connections',
                'Domains by DMARC Verification Details',
                'Summary of Safe Print File Types']
