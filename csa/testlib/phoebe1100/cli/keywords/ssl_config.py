#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/cli/keywords/ssl_config.py#1 $ $DateTime: 2019/03/22 01:36:06 $ $Author: aminath $
...
class SslConfig(CliKeywordBase):
    ...
    def ssl_config_inbound(self, *args):
        ...
        *Parameters:*
        - `method`: The inbound SMTP ssl method.
        | 1 | SSL v2 |
        | 2 | SSL v3 |
        | 3 | TLS v1 |
        | 4 | SSL v2 and v3 |
        ...
        - `cipher`: The inbound SMTP ssl cipher.
    ...
    def ssl_config_outbound(self, *args):
        ...
        *Parameters:*
        - `method`: The outbound SMTP ssl method.
        | 1 | SSL v2 |
        | 2 | SSL v3 |
        | 3 | TLS v1 |
        | 4 | SSL v2 and v3 |
        | 5 | SSL v3 and TLS v1 |
        | 6 | SSL v2, v3 and TLS v1 |
        - `cipher`: The outbound SMTP ssl cipher.
