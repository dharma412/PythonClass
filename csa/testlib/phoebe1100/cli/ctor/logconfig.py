...
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/cli/ctor/logconfig.py#1 $ $DateTime: 2019/03/22 01:36:06 $ $Author: aminath $
...
class logconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def new(self, input_dict=None, **kwargs):
        ...
        param_map['include_pass'] = ['include passphrases', DEFAULT]
