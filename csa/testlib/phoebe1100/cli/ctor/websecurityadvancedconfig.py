#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/cli/ctor/websecurityadvancedconfig.py#1 $ $DateTime: 2019/03/22 01:36:06 $ $Author: aminath $
...
class websecurityadvancedconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def __call__(self, input_dict=None, **kwargs):
        ...
        param_map['max_urls'] = ['Enter the maximum number of URLs that should be scanned:', DEFAULT]
