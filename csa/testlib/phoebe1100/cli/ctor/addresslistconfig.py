#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/cli/ctor/addresslistconfig.py#1 $
...
class addresslistconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def new(self, list_name=REQUIRED, list_desc=DEFAULT, email_addr=DEFAULT,
            addr_list=DEFAULT):
        self._query_response('NEW')
        self._query_response(list_name)
        self._query_response(list_desc)
        self._query_response(email_addr)
