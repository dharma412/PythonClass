#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/cli/ctor/showconfig.py#1 $
...
if __name__ == '__main__':
    ...
    show_file = scfg(option=1)
    print "configuration file %s showing with masked passwords" % show_file
    show_file = scfg(option=2)
    print "configuration file %s showing with encrypted passwords" % show_file
    show_file = scfg(option=3)
    print "configuration file %s showing with plain passwords" % show_file
