# $Id: //prod/main/sarf_centos/testlib/phoebe1100/gui/monitor/tracking/message_tracking.py#1 $
...
ADVANCED_CLOSED = "//*[@id='adv_closed']/tr[1]/th/a"
...
class MessageTracking(GuiCommon):
    ...
    def message_tracking_search(self,
        ...
        messages that match specified criteria.
         ...
         Parameters:
          ...
          - `sender_comparator`: accepts _Contains_ or _Is_ or _Begins With_
        ...
        if self._is_visible(ADVANCED_CLOSED):
            self.click_element(ADVANCED_CLOSED, "don't wait")
        if sender_data:
        ...
        self._fill_mesg_event_data(message_event, dlp_policy, url_clicked, vof_threat_category_name,
                                   ...
                                   amp_protection_mailflow_directions)
    ...
    def _fill_mail_data(self, data, data_locator, comparator=None,
        ...
        if comparator:
            if comparator in ['Contains', 'Is', 'Begins With']:
