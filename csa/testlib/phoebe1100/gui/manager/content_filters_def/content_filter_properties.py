...
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/gui/manager/content_filters_def/content_filter_properties.py#1 $
...
class URLCategoryActionProperty(ContentFilterProperty):
    ...
    ADD_BUTTON = "//*[@id='ruleform_UrlCategoryAction']/table/tbody/tr[1]/td/table/tbody/tr[2]/td[2]/input[1]"

    SELECTED_CATEGORIES_COMBO = "//select[@id='UrlCategoryAction_action_categories_chosen_action_categories']"
    REMOVE_BUTTON = "//*[@id='ruleform_UrlCategoryAction']/table/tbody/tr[1]/td/table/tbody/tr[2]/td[2]/input[2]"
