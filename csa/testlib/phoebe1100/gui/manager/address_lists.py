...
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/gui/manager/address_lists.py#1 $ $DateTime: 2019/03/22 01:36:06 $ $Author: aminath $
...
DELETE_ADDR_LIST_CHECKBOX = lambda name: \
    "%s//td[.//a[normalize-space()='%s']]/following-sibling::td[4]/input" % \
    (CONTAINER, name)
