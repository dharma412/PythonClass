...
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/gui/admin/upgrade_def/wizard_pages.py#1 $ $DateTime: 2019/03/22 01:36:06 $ $Author
...
class BaseWizardPage(InputsOwner):
...
class UpgradeProgressPage(BaseWizardPage):
    CONTINUE_BUTTON = "//input[@name='action:Respond']"
    REBOOT_BUTTON = "//input[@name='action:Reboot']"
