...
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/gui/admin/users.py#1 $
...
EXT_AUTH_EDIT_BUTTON = "//input[@type='button' and contains(@onclick, 'FormEditExtAuth')]"
...
class Users(GuiCommon):
    ...
    def users_external_auth_is_enabled(self):
        ...
        *Examples:*
        ...
        """
        EXT_AUTH_NOT_ENABLED_MARK = 'External Authentication is disabled.'
        return not self._is_text_present(EXT_AUTH_NOT_ENABLED_MARK)
    ...
    def users_external_auth_enable(self, settings):
        ...
        *Examples:*
        ...
        | Users External Auth Disable |
        """
        self.click_button(EXT_AUTH_EDIT_BUTTON)
