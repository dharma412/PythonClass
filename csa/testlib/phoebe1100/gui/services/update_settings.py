#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/gui/services/update_settings.py#1 $
...
class UpdateSettings(GuiCommon):
    ...
    def _fill_server_info(self, name=None, server=None, user=None, passwd=None,
        ...
        server_locators = {
            'url': ('//input[@id="upd_static_url"]', '//input[@id="base_url"]',
                    '//input[@id="proxy_server"]',),
            'port': ('//input[@id="upd_port"]', '//input[@id="port"]',
                     '//input[@id="proxy_port"]',),
            'user': ('//input[@id="upd_username"]', '//input[@id="username"]',
                     '//input[@id="proxy_username"]',),
            'passwd': ('//input[@id="upd_password"]', '//input[@id="password"]',
                       '//input[@id="proxy_password"]',),
            'repasswd': ('//input[@id="upd_retype_password"]',
                         '//input[@id="retype_password"]',
                         '//input[@id="proxy_retype_password"]',)}
