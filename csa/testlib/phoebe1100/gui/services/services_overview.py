...
# $Id: //prod/main/sarf_centos/testlib/phoebe1100/gui/services/services_overview.py#1 $
...
class ServicesOverview(GuiCommon):
    ...
    @set_speed(0)
    @go_to_page(PAGE_PATH)
    def services_overview_update(self, *args):
        """
    ...
    @set_speed(0)
    @go_to_page(PAGE_PATH)
    def services_overview_get_available_versions(self, *args):
        """
    ...
    @set_speed(0)
    @go_to_page(PAGE_PATH)
    def services_overview_modify_version(self, *args):
        """
