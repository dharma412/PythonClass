#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/sudo.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class sudo(clictorbase.IafCliConfiguratorBase):
    ...
    class WrongPasswordError(IafCliError): pass
    class BadCommandError(IafCliError): pass
