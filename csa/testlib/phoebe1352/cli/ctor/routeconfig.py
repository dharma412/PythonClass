#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/routeconfig.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class routeconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def __call__(self,ip_prot = DEFAULT):
        self._writeln('routeconfig')
        self._query('Configure routes for')
        self._query_select_list_item(ip_prot)
        return self
