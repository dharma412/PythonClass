...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/incomingrelayconfig.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class incomingrelayconfigRelaylist(clictorbase.IafCliConfiguratorBase):
    ...
    class InvalidHostError(IafCliError): pass
    class InvalidHeaderError(IafCliError): pass
