...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/logconfig.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class logconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def delete(self, log_to_delete='1'):
        ...
        buf = self._sess.getbuf(clear_buf=False)
        self._query()
        self._select_list_item(log_to_delete, buf)
        self._to_the_top(1)
