#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/network/listeners.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
ADVANCED_SETTINGS_ARROW_CLOSED = "//*[@id='optionsLinkClosed' and text()[contains(.,'Advanced')]]"
...
class Listeners(GuiCommon):
    ...
    def listeners_configure_advanced_settings(self,
        ...
        *Examples*:
        ...
        self._open_edit_listener_page(listener_name=listener_name)
        if not self._is_visible(ADVANCED_SETTINGS_MAX_CONCURRENCY):
