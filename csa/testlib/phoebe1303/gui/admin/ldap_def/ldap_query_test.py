...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/admin/ldap_def/ldap_query_test.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class ExternalAuthenticationQueriesTest(LdapQueryTest):
    # Users
    USER_LOGIN = ('Login',
                    "//input[@id='test_externalauth_user_login']")
    USER_PASSWORD = ('Passphrase (for LDAP BIND)',
                     "//input[@id='test_externalauth_password']")
    # Group Membership
    GROUP_LOGIN = ('Group Membership Login',
                  "//input[@id='test_externalauth_membership_login']")
    @classmethod
    def get_parent_query_type(cls):
