# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/monitor/tracking/message_tracking.py#1 $
...
class MessageTracking(GuiCommon):
    ...
    def message_tracking_search(self,
        ...
        messages that match specified criteria.
         ...
         Parameters:
          ...
          Options are:
            ...
            Unscannable
            Not Scanned
          - `app_forwarding_result` : Advanced Phishing Forwarding Result.
	     Options are:
             Succesful
	     Failed
         Return:
         ...
         | ... |  message_event=${message_event} |
         | ... |  url_category_options=${urls} |
	     | ... | app_forwarding_result=${app_result_types} |
         | Log |  ${result_list} |
        """
        ...
        self._fill_mesg_event_data(message_event, dlp_policy, url_clicked, vof_threat_category_name,
              ...
              sender_domain_reputation_types, message_filter_name, app_forwarding_result)
    ...
    def _fill_mesg_event_data(self, message_event, dlp_policy, url_clicked, vof_threat_category_name,
        ...
        message_event_option = {'virus positive':'id=event_virus',
                                ...
                                'safe print':'id=event_safeprint_file_ext',
                                'message filters':'id=message_filters',
				                'advanced phishing protection forwarding':'id=event_app_forwarding'
                                }
        ...
        app_result_types = {
		        'successful':'id=event_app_submitted',
		        'failed':'id=event_app_failed'
        }
        ...
        if self._is_checked(message_event_option['advanced phishing protection forwarding']):
	        if app_forwarding_result:
	            for app_result_type in app_forwarding_result:
		            self.select_checkbox(app_result_types[app_result_type.lower()])
