#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/monitor/quarantines/quarantine.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class Quarantine(QuarantinesCommon):
    ...
    def _add_edit_quarantine(self,
        ...
        if retain_time_units:
            self.select_from_list_by_label(QUARANTINE_RETAIN_PERIOD_UNITS, retain_time_units)
