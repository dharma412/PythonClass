#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/monitor/quarantines/spam.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
