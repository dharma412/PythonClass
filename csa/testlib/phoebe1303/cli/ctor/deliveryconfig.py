#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/deliveryconfig.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class deliveryconfig(ccb.IafCliConfiguratorBase):
    ...
    def setup(self, input_dict=None, **kwargs):
        ...
        param_map['attempt_to_connect_without_TLS'] = \
        ['attempt to connect without TLS', DEFAULT]
