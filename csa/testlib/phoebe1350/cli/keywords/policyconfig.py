#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/keywords/policyconfig.py#2 $
...
class PolicyConfig(CliKeywordBase):
    ...
    def get_keyword_names(self):
        return ['spam_params_get',
                ...
                'policyconfig_edit_advanced_phishing_protection_enable',
                'policyconfig_edit_advanced_phishing_protection_disable',
                'policyconfig_edit_advanced_phishing_protection_default',
                'policyconfig_edit_advanced_phishing_protection_edit',
                'policyconfig_priority_add',
                'policyconfig_priority_delete'
                ]
    ...
    def advancedmalware_params_get(self,*args):
        ...
        *Parameters*:
        ...
        - `edit_action_message_error`: to edit the actions for Unscannable Message due to message errors, Yes or No
        - `edit_action_rate_limit_hit`: to edit the actions for Unscannable Message due to rate limit hit, Yes or No
        - `edit_action_amp_unavailable`: to edit the actions for Unscannable Message due to AMP Service not available, Yes or No
    ...
    def action_cond_params_get(self,*args):
        ...
        *Parameters*:
        ...
        - `sender_domain_reputation_source`: Select source of domain reputation
        - `sender_domain_reputation_condition`: Select the condition to configure
        - `sender_domain_reputation_verdict`: Choose range of sender domain reputation verdict to match
        - `sender_domain_reputation_age`: Filter messages where Sender Domain Age is
        - `sender_domain_reputation_age_unit`: Choose the unit of domain age
        - `sender_domain_reputation_age_value`: Enter the domain age
        - `sender_domain_reputation_age_condition`: Choose which condition the messages with domain age will match
        - `sender_domain_reputation_configure_domain_exception: Do you want to configure Domain exception list
        - `sender_domain_reputation_domain_exception_list`: Select a Domain Exception list
    ...
    def policyconfig_new(self, policy_type, *args):
        ...
        *Parameters*:
        ...
        - `assign_user_role`: Assign any user roles to access, "Yes" or "No".
                Default: No
        - `advanced_phishing_protection_enable`: Enables Advanced Phishing
                Protection for the policy. "Yes" or "No". Default: No
        - `advanced_phishing_protection_use_default_table`: Use the policy
                table default, "Yes" or "No". Default: Yes
        - `advanced_phishing_protection_enable_email_forwarding`: Enable email
                forwarding for the policy. "Yes" or "No". Default: No
    ...
    def policyconfig_clear(self, policy_type, confirm=YES):
        ...
        *Examples*:
        ...
        """
        try:
            self._cli.policyconfig().choose(policy_type).clear(confirm)
        except Exception,e:
            self._cli.restart()
            traceback.print_exc()
            raise e
        ...
        *Examples*:
        ...
        try:
            self._cli.policyconfig().choose(policy_type).edit(policy).antivirus().enable(antivirus_dict,
                  repaired_dict, encrypted_dict,unscannable_dict, infected_dict)
        except Exception,e:
            self._cli.restart()
            traceback.print_exc()
            raise e
    ...
    def policyconfig_edit_graymail_enable(self, policy_type, policy, safe_unsubscribe_dict=None,
            marketing_email_dict=None, social_networking_email_dict=None, bulk_email_dict=None):
        """
        ...
        *Examples*:
        ...
        try:
            self._cli.policyconfig().choose(policy_type).edit(policy).graymail().\
                enable(safe_unsubscribe_dict, marketing_email_dict, social_networking_email_dict, bulk_email_dict, policy_type)
        except Exception,e:
            self._cli.restart()
            traceback.print_exc()
            raise e
    ...
    def policyconfig_edit_graymail_edit(self, policy_type, policy, safe_unsubscribe_dict=None,
        ...
        *Examples*:
        ...
        try:
            self._cli.policyconfig().choose(policy_type).edit(policy).graymail().\
                edit(safe_unsubscribe_dict, marketing_email_dict, social_networking_email_dict, bulk_email_dict, policy_type)
        except Exception,e:
            self._cli.restart()
            traceback.print_exc()
            raise e

    def policyconfig_edit_advanced_phishing_protection_enable(self,
        policy_type, policy, *args):
        """
        This keyword enables Advanced Phishing Protection for a given
        Incoming policy and also changes its config.

        policyconfig -> incoming -> edit -> Advanced Phishing Protection -> Enable

        *Parameters*:
        - `policy_type`: Policy Type, incoming or outgoing.
        - `policy`: Incoming or outgoing policy name.
        - `enable_email_forwarding`: Do you want to enable email forwarding. Yes | No
        ...
        *Examples*:
        ...
        try:
            kwargs = self._convert_to_dict(args)
            self._cli.policyconfig().choose(policy_type).edit(policy). \
                    advancedphishing().enable(**kwargs)
        except Exception,e:
            self._cli.restart()
            traceback.print_exc()
            raise e

    def policyconfig_edit_advanced_phishing_protection_disable(self, policy_type, policy):
        """
        This keyword disables Advanced Phishing Protection for a given incoming policy

        policyconfig -> incoming -> Edit -> Advanced Phishing Protection -> Disable
        ...
        *Examples*:
        ...
        | Policyconfig Edit Advanced Phishing Protection Disable | Incoming | DEFAULT |

        """
        try:
            self._cli.policyconfig().choose(policy_type).edit(policy).advancedphishing().disable()
        except Exception,e:
            self._cli.restart()
            traceback.print_exc()
            raise e

    def policyconfig_edit_advanced_phishing_protection_default(self, policy_type, policy):
        """
        This keyword resets Advanced Phishing Protection config to DEFAULT for
        a given incoming policy

        policyconfig -> incoming -> Edit -> Advanced Phishing Protection -> Default
        ...
        *Examples*:
        ...
        | Policyconfig Edit Advanced Phishing Protection Default | Incoming | mypolicy |

        """
        try:
            self._cli.policyconfig().choose(policy_type).edit(policy).advancedphishing().default()
        except Exception,e:
            self._cli.restart()
            traceback.print_exc()
            raise e

    def policyconfig_edit_advanced_phishing_protection_edit(self, policy_type, policy, *args):
        """
        This keyword edit Advanced Phishing Protection configurations for a
        given incoming policy

        policyconfig -> incoming -> Edit -> Advanced Phishing Protection -> Edit
        ...
        *Examples*:
        | Policyconfig Edit Advanced Phishing Protection Edit   |
        | ... | Incoming                                        |
        | ... | DEFAULT                                         |
        | ... | enable_email_forwarding=No                      |
        """
        try:
            kwargs = self._convert_to_dict(args)
            self._cli.policyconfig().choose(policy_type).edit(policy). \
                    advancedphishing().edit(**kwargs)
        except Exception,e:
            self._cli.restart()
            traceback.print_exc()
            raise e

    def policyconfig_priority_add(self, policy_type, *args):
        """
        This keyword will create new policy for Header Priority
        policyconfig -> headerpriority -> add
        *Parameters*:
        - `policy_type`: Policy Type, "Match"
        - `from_header`: Add "From" Header as priority header, 1="Yes" or 2="No".
                Default: 2
        - `replyto_header`: Add "Reply-To" Header as priority header, 1="Yes" or 2="No"
                Default: 2
        - `sender_header`: Add "Sender" Header as priority header, 1="Yes" or 2="No"
                Default: 2
        *Examples*:
        | Policyconfig Priority Add | Match    |
        | ... | from_header=1                  |
        | ... | replyto_header=2               |
        | ... | sender_header=2                |
        """
        kwargs = self._convert_to_dict(args)
        self._cli.policyconfig().choose(policy_type).headerpriorityadd(**kwargs)

    def policyconfig_priority_delete(self, policy_type, priority_number):
        """
        This keyword will delete given Headerpriority item
        policyconfig -> headerpriority -> delete
        *Parameters*:
        - `policy_type`: Policy Type, headerpriority.
        - `priority_number`: Number of the priority to be deleted.
        *Examples*:
        | Policyconfig Priority Delete | Match | 2 |
        """
        self._cli.policyconfig().choose(policy_type).headerprioritydelete(priority_number)
