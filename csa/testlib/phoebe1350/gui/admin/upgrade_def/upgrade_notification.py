...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/admin/upgrade_def/upgrade_notification.py#2 $ $DateTime: 2020/01/07 21:45:27 $ $Author: saurgup5 $
...
class NotificationBalloon(object):
    ...
    def clear(self):
        self.gui.mouse_over(UPGRADE_BUTTON)
        if self.gui._is_element_present(ARROW_DOWN_IMG):
            self.gui.click_element(ARROW_DOWN_IMG, 'don\'t wait')
