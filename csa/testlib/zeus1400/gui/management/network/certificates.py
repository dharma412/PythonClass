...
CERT_CUSTOM_LIST_ENABLE_FQDN_CHECKBOX = "//input[@id='fqdn_validation']"
...
class Certificates(GuiCommon):
    ...
    def _click_enable_fqdn_validation(self):
        self.click_button(CERT_CUSTOM_LIST_ENABLE_FQDN_CHECKBOX, "don't wait")
        self._info('Clicked "Enable and Disable fqdn validation in Custom List" checkbox.')
    ...
    def cert_authorities_custom_list_enable_disable(self, enable=False, cert_path=None, fqdn_validation=None):
        ...
        if enable:
            ...
            if fqdn_validation:
                self._click_enable_fqdn_validation()
    ...
    def edit_certificate_authorities(self, custom_list_enable=False,
        ...
        self.cert_authorities_custom_list_enable_disable(custom_list_enable, custom_list_cert_path, fqdn_validation)
    ...
    def delete_custom_trusted_root_cert(self, cert_name):
        ...
        if cert_name in cert_list:
            ...
            self._info("Custom certificate deleted : " % cert_list)
        else:
    ...
    def override_trusted_root_certificate(self,certificate_position,enable=True):
        """Use the checkboxes to override entries
                ...
                *Examples*
                Trusted Root Certificate Overridden  1  ${True}
        """
