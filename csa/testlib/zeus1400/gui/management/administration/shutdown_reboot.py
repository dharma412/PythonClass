#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1380/gui/management/administration/shutdown_reboot.py#1 $ $DateTime: 2020/05/25 00:19:30 $ $Author: sarukakk $
...
class ShutdownReboot(GuiCommon):
    ...
    def _select_operation(self, operation):
        ...
        self.select_from_list_by_label('halt_action', operation_types[operation])
