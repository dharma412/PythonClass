...
# $Id:  //prod/main/csa/testlib/zeus1400/gui/management/administration/users_def/sfauth_settings.py#1 $ $DateTime: 2020/02/28 02:03:15 $ $Author: aminath $
...
class TfAuthSettings(InputsOwner):
