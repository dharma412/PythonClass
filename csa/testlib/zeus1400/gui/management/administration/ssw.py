...
from zeus1380.cli.keywords.reset_config import ResetConfig
from zeus1380.cli.keywords.suspend import Suspend
from common.cli.clicommon import CliKeywordBase
from zeus1380.cli.keywords.passwd import Passwd
...
class SystemSetupWizard(GuiCommon):
    ...
    def _process_system_setting_page(self, alert_rcpt, region, country,
        ...
        sys_gen_passwd = self._process_password(passwd,generate_passphrase)
    ...
    def _process_password(self, passwd,generate_passphrase):
        ...
        GENERATED_PASSWD = "//input[@id='sysgen']"
        ...
        if generate_passphrase is not None and \
            ...
            return self.get_value(GENERATED_PASSWD)
    ...
    def system_setup_wizard_run(self,
        ...
        sys_gen_passwd = self._process_system_setting_page(alert_rcpt, region, country,
