# $Id: //prod/main/sarf_centos/testlib/zeus1380/gui/management/administration/configuration_file.py#1 $ $DateTime: 2020/05/25 00:19:30 $ $Author: sarukakk $
...
RESTORE_BUTTON_DISABLED =     'xpath=//input[@name="slbl_restore" and contains(@class, "disabled")]'
...
class ConfigurationFile(GuiCommon):
    ...
    def _is_slbl_enabled(self):
        ...
        if self._is_element_present(BACKUP_NOW_BUTTON) and           self._is_element_present(RESTORE_BUTTON):
