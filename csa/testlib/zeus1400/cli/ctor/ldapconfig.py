#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1380/cli/ctor/ldapconfig.py#1 $ $DateTime: 2020/05/25 00:19:30 $ $Author: sarukakk $
...
class ldapconfig(ccb.IafCliConfiguratorBase):
    ...
    def new(self, input_dict=None, **kwargs):
        ...
        if args.get('password'):
            args['retype_passwd'] = args['password']
    ...
    def setup(self, interface=DEFAULT, negative=DEFAULT, certificate=DEFAULT):
...
class ldapconfigEdit(ccb.IafCliConfiguratorBase):
    ...
    def __init__(self,sess):
        ...
        self.__param_map['test_addr']     = ['Address to use in query:',
                                             REQUIRED]
        self.__param_map['isq_passwd'] = ['Password to use in query', REQUIRED]
...
class ldapconfigEditServer(ccb.IafCliConfiguratorBase):
    ...
    def authtype(self, input_dict=None, **kwargs):
        ...
        param_map['username']   = ['Please enter the bind username:',
                                   REQUIRED]
        param_map['password']   = ['Please enter the bind password', REQUIRED]
        param_map['retype_passwd'] = ['enter the new password again', REQUIRED]
        param_map['ssl_using']  = ['Use SSL to connect', DEFAULT]
        param_map['port']       = ['enter the port number', DEFAULT]
