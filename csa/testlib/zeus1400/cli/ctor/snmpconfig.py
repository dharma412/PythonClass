...
class snmpconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def setup(self, input_dict=None, **kwargs):
        ...
        param_map['snmp_security_level'] = ['Select SNMPv3 security level', DEFAULT, True]
        param_map['snmpv3_passphrase'] = ['Enter the SNMPv3 authentication passphrase', [REQUIRED, REQUIRED]]
        ...
        param_map['snmpv3_privacy_passwd'] = ['Enter the SNMPv3 privacy passphrase', [REQUIRED, REQUIRED]]
        param_map['snmpv3_traps_version'] = ['version for SNMP traps', DEFAULT]
