# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/email/tracking/message_tracking.py#1 $
...
class MessageTracking(GuiCommon):
    ...
    def email_message_tracking_search(self,
        ...
        self._fill_mesg_event_data(message_event, dlp_policy, url_clicked, vof_threat_category_name,
                                   ...
                                   sender_domain_reputation_types, dmarc_failures, dmarc_failures_from_domain,
                                   dmarc_actions)
