# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/email/quarantine/spam_quarantine.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $
...
class SpamQuarantine(GuiCommon):
    ...
    def spam_quarantine_search_page_open(self,
        ...
        """
        self._spam_quarantine_add_certificate(override_type="MU")
        ...
        try:
            ...
            self._spam_quarantine_add_certificate(override_type="MUT")
            self.launch_dut_browser()
            self.log_into_dut(user, password)
