# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/email/reporting/details_table.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $
...
TABLE_NAMES = {'User Mail Flow Details': (('Email', 'Reporting', 'Internal Users'),
               ...
               ('Email', 'Reporting', 'External Threat Feeds'),
               (2, 1))}
...
CONTENT_CELL_BY_IDX = lambda coords, col_idx, row_idx: '%s//div[@id=\'ss_0_%d_%d\']' \
                                                       ...
                                                       % (report_table.REPORT_TABLE, coords[0], coords[1], row_idx,
                                                          col_idx)
