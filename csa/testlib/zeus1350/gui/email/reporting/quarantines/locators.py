...
QUARANTINE_RETAIN_PERIOD_UNITS = "//*[@name='periodUnits']"
...
SPAM_QUARANTINE_NOTIFICATION_SCHEDULE_DAY = "//*[@id='notification_frequency_weekly']/select"
...
QUARANTINE_SEARCH_TABLE_HANLDE_DIALOG_OK_CANCEL_BUTTON = lambda locator, text: "%s//button[text()='%s']" % (
locator, text)
...
SEARCH_QUARANTINE_ENVELOPE_SENDER_METHOD = "%s//select[@name='senderMethod']" % SEARCH_QUARANTINE_CONTENT_TABLE
