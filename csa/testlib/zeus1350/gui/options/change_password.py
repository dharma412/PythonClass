#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/options/change_password.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $


from common.gui.guicommon import GuiCommon

OLD_PASSWORD_TEXTBOX = 'name=old_pwd'
NEW_PASSWORD_TEXTBOX = 'name=new_pwd'
RETYPE_NEW_PASSWORD_TEXTBOX = 'name=retype_new_pwd'
...
class ChangePassword(GuiCommon):
    ...
    def _open_page(self):
        self._navigate_to('Options', 'Change Password')
