#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/management/services/spam_quarantine.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $
...
class SpamQuarantine(GuiCommon):
    ...
    def _select_on_dialog(self, items_list, clear_others=False):
        ...
        for label_num in range(1, labels_count + 1):
            ...
            if checkbox_needed and (not checkbox_state):
                self._click(checkbox_loc, "don't wait")
    ...
    def spam_quarantine_edit(self, interface=None, port=None,
        ...
        | ... | delete_after=80 |
        | ... | send_copy=${True} |
        | ... | logo=~/work/sarf/tests/testdata/euq_ironport_default_logo.gif |
    ...
    def spam_quarantine_edit_enduser_access(self, end_user_access_enable=None,
                                            ...
                                            end_user_mail_security=None, end_user_mail_port=None,
                                            end_user_mail_domain=None,
                                            end_user_mail_test_user=None, end_user_mail_test_password=None,
                                            end_user_mail_test=None,
        ...
        if (end_user_mail_type is not None) and enable_end_user_access_checked:
            ...
            if end_user_mail_type == 'pop':
                ...
                raise ValueError(
                    "Mail method '%s' was not found in 'End-User Authentication' form." % end_user_mail_method)
    ...
    def spam_quarantine_edit_notification(self,
        ...
        if (spam_notif_freq is not None) and spam_notif_enable_checked:
            ...
            if spam_notif_freq == 'monthly':
                ...
                raise ValueError(
                    "Spam Notification Frequency '%s' was not found in 'Spam Notification' form." % spam_notif_freq)
