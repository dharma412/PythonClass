# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/management/services/security_appliances.py#1 $
...
DELETE_WEB_APPL_TABLE_CELL = lambda row: WEB_APPL_TABLE_PREFIX + \
                                         "table[not(following-sibling::div[@class='group'])][1]//tr[%s]/td[9]/img" % (
                                         row,)
...
class SecurityAppliances(GuiCommon):
    ...
    def security_appliances_add_email_appliance(self, name, address, isq=None,
                                                pvo=None, reporting=None, tracking=None, ssh_credentials=None,
    ...
    def security_appliances_add_web_appliance(self, name, address, iccm=None,
                                              reporting=None, upgrade=None, ssh_credentials=None, config_master=None,
                                              establish_timeout=360):
    ...
    def security_appliances_edit_web_appliance(self, name, newname=None,
                                               address=None, reporting=None, iccm=None, upgrade=None,
