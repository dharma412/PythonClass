#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/management/administration/log_subscriptions.py#1 $
...
class LogSubscriptions(GuiCommon):
    ...
    * Log Types Constants *
    ...
    def _fill_log_subscription_page(self, log_type, log_name, filename,
                                    log_size, rollover_interval, log_level, include_pwd):
    ...
    def log_subscriptions_edit_log(self, log_name, new_log_name=None,
                                   ...
                                   log_level=None, include_pwd=None):
