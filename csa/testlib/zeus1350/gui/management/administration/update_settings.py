#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/management/administration/update_settings.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $
...
class UpdateSettings(GuiCommon):
    ...
    def update_settings_edit_settings(self, image_server=None, list_server=None,
                                      auto_update=None, update_interval=None, interface=None, http_proxy=None,
                                      https_proxy=None):
