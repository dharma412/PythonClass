#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm80/cm80_oms_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus80.gui.manager.oms_policies import OMSPolicies


class Cm80OmsPolicies(OMSPolicies):
    """
    Keywords library for WebUI page Web -> Configuration Master 8.0 -> Outbound Malware Scanning
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 8.0', 'Outbound Malware Scanning')

    def get_keyword_names(self):
        return [
            'cm80_oms_policies_add',
            'cm80_oms_policies_delete',
            'cm80_oms_policies_edit',
            'cm80_oms_policies_edit_destinations',
            'cm80_oms_policies_edit_amw_filters'
        ]

    def cm80_oms_policies_add(self,
                              name,
                              description=None,
                              order=None,
                              identities=None,
                              ...
                              match_agents=None):
        """Add new policy from Configuration Master 8.0
        ...
        *Examples*
        | CM80 OMS Policies Add | three | description=Adding policy  |
        ...
        | ... | user_agents=ie-all |
        | CM80 OMS Policies Add | zero | subnets=192.168.20.0/24  |
        """
    ...
    def cm80_oms_policies_edit(self,
                               name,
                               description=None,
                               order=None,
                               identities=None,
                               ...
                               common_user_agents=None,
                               match_agents=None):
        """Edits specified policy from Configuration Master 8.0
        ...
        *Examples*
        | CM80 OMS Policies Edit | three | description=Editing policy |
        ...
        | CM80 OMS Policies Edit | zero | subnets=192.168.20.0/24 |
        """
    ...
    def cm80_oms_policies_delete(self, name):
        """Deletes specified policy from Configuration Master 8.0
        ...
        *Example*
        | CM80 OMS Policies Delete | three |
        """
        self.oms_policies_delete(name)

    def cm80_oms_policies_edit_amw_filters(self,
                                           name,
                                           settings_type,
                                           amw_actions=None,
                                           amw_select_all=None,
        ...
        *Examples*
        | CM80 OMS Policies Edit AMW Filters | three | global |
        | Cm80 OMS Policies Edit AMW Filters | three | custom |
    ...
    def cm80_oms_policies_edit_destinations(self,
                                            name,
                                            settings_type,
                                            dest_to_scan=None,
                                            cust_url=None,
