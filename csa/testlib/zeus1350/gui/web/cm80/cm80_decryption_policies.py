# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm80/cm80_decryption_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm80/cm80_decryption_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus80.gui.manager.decryption_policies import DecryptionPolicies


class Cm80DecryptionPolicies(DecryptionPolicies):
    """
    Keywords library for WebUI page Web -> Configuration Master 8.0 -> Decryption Policies
    """

    def _open_decr_policy_page(self):
        self._navigate_to('Web', 'Configuration Master 8.0', 'Decryption Policies')

    def get_keyword_names(self):
        return ['cm80_decryption_policies_add',
                'cm80_decryption_policies_delete',
                'cm80_decryption_policies_edit',
                'cm80_decryption_policies_edit_url_categories',
                'cm80_decryption_policies_edit_default_action',
                'cm80_decryption_policies_edit_wbrs',
                'cm80_decryption_policies_get_list',
                ]

    def cm80_decryption_policies_get_list(self):
        """
    ...
    def cm80_decryption_policies_add(self,
                                     ...
                                     user_agents=None,
                                     match_agents=True):
        """Adds new decryption policy from Configuration Master 8.0
        ...
        *Examples*
        | CM80 Decryption Policies Add | myDefaultDecrPol |
        | ... | description=This policy uses Global Identity Policy |
        | ... | identities=Global Identity Policy |
        | CM80 Decryption Policies Add | myOtherDecrPol |
    ...
    def cm80_decryption_policies_delete(self, name):
        """Deletes specified decryption policy from Configuration Master 8.0
        ...
        *Example*
        | CM80 Decryption Policies Delete | myDecrPol |
        """
        self.decryption_policies_delete(name)

    def cm80_decryption_policies_edit(self,
                                      name,
                                      new_name=None,
                                      description=None,
                                      order=None,
                                      ...
                                      user_agents=None,
                                      match_agents=True):
        """Edits decryption policy from Configuration Master 8.0
        ...
        *Examples*
        | CM80 Decryption Policies Edit | myDecrPol |
        | ... | identities=All Identities:selected:joe.smith |
        | CM80 Decryption Policies Edit | myDecrPol |
        | ... | identities=All Identities:all | time_range=myTime |
        | ... | proxy_ports=3128 |
        | CM80 Decryption Policies Edit | myDecrPol | identities=All Identities |
    ...
    def cm80_decryption_policies_edit_url_categories(self,
                                                     name,
                                                     url_categories=None,
        ...
        *Examples*
        ...
        | CM80 Decryption Policies Edit Url Categories | ${id1} |
    ...
    def cm80_decryption_policies_edit_wbrs(self,
                                           name,
                                           score_range=None,
        ...
        *Examples*
        | CM80 Decryption Policies Edit Wbrs | myDecrPol | setting_type=disable |
        | CM80 Decryption Policies Edit Wbrs | myDecrPol |
    ...
    def cm80_decryption_policies_edit_default_action(self, name, action):
        ...
        *Exceptions*
        ...
        Example:
        | CM80 Decryption Policies Edit Default Action | myDecrPol | action=decrypt |
        """
