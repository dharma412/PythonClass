# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm110/cm110_time_ranges.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm110/cm110_time_ranges.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $
...
class Cm110TimeRanges(TimeRanges):
    """
    Keywords for Web -> Configuration Master 11.0 -> Defined Time Ranges
    """

    def _open_define_timerange_and_quota_page(self):
        self._navigate_to('Web', 'Configuration Master 11.0', 'Defined Time Ranges')

    def get_keyword_names(self):
        return [
            'cm110_time_ranges_add',
            'cm110_time_ranges_edit',
            'cm110_time_ranges_delete',
            'cm110_time_ranges_get_list',
        ]

    def cm110_time_ranges_get_list(self):
        """
        ...
        | ${policies}= | CM110 Time Ranges Get List |
    ...
    def cm110_time_ranges_add(self,
                              name,
                              week_days,
                              region=None,
                              country=None,
                              time_zone=None,
                              time_of_day='all day'):
        """Adds new custom time range from Configuration Master 11.0
        ...
        *Examples*
        | CM110 Time Ranges Add | myTime | Monday,Thursday |
        | CM110 Time Ranges Add | myTime | Monday,Thursday | time_of_day=09:00,111.00 |
        | CM110 Time Ranges Add | myTime | Monday,Thursday | region=Europe |
    ...
    def cm110_time_ranges_edit(self,
                               name,
                               week_days,
                               row=0,
                               region=None,
                               ...
                               time_zone=None,
                               time_of_day='all day'):
        """Edits the custom time range from Configuration Master 11.0
        ...
        *Examples*
        | CM110 Time Ranges Edit | myTime | Monday,Sunday | region=Pacific |
        | ... | country=Fiji | time_zone= Fiji | time_of_day=09:00,19:00 |
        | CM110 Time Ranges Edit | myTime | Monday,Wednesday | row=1 |
    ...
    def cm110_time_ranges_delete(self, name):
        """Deletes the custom time range from Configuration Master 11.0
        ...
        *Example*
        | CM110 Time Ranges Delete | myTimeRange |
        """
        self._open_define_timerange_and_quota_page()
