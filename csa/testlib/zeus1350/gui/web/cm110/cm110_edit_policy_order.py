# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm110/cm110_edit_policy_order.py#1 $
...
class Cm110EditPolicyOrder(GuiCommon):
    """ Keywords for CM110 Edit Policy Order page where policies
    can be ordered by drag-and-drop.
    """

    def get_keyword_names(self):
        return [
            'cm110_edit_policy_order',
        ]
    ...
    def cm110_edit_policy_order(self, policy, submit, *items):
        ...
        *Parameters:*
        ...
        to be reordered. It is string containing name of menu item in CM110 menu.
        Requried.
        ...
        *Examples:*
        | CM110 Edit Policy Order | Identities | ${True} |
        | Policy 1 | Policy 2 |

        | CM110 Edit Policy Order | SOCKS Policies | ${True} |
        | Policy 1 |
        | Policy 2 |
        | Policy 3 |
        | Policy 4 |
