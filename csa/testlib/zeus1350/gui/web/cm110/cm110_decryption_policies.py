# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm110/cm110_decryption_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm110/cm110_decryption_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1100.gui.manager.decryption_policies import DecryptionPolicies


class Cm110DecryptionPolicies(DecryptionPolicies):
    """
    Keywords library for WebUI page Web -> Configuration Master 11.0 -> Decryption Policies
    """

    def _open_decr_policy_page(self):
        self._navigate_to('Web', 'Configuration Master 11.0', 'Decryption Policies')

    def get_keyword_names(self):
        return ['cm110_decryption_policies_add',
                'cm110_decryption_policies_delete',
                'cm110_decryption_policies_edit',
                'cm110_decryption_policies_edit_url_categories',
                'cm110_decryption_policies_edit_default_action',
                'cm110_decryption_policies_edit_wbrs',
                'cm110_decryption_policies_get_list',
                ]

    def cm110_decryption_policies_get_list(self):
        """
    ...
    def cm110_decryption_policies_add(self,
                                      ...
                                      user_agents=None,
                                      match_agents=True):
        """Adds new decryption policy from Configuration Master 11.0
        ...
        *Examples*
        | CM110 Decryption Policies Add | myDefaultDecrPol |
        | ... | description=This policy uses Global Identity Policy |
        | ... | identities=Global Identity Policy |
        | CM110 Decryption Policies Add | myOtherDecrPol |
    ...
    def cm110_decryption_policies_delete(self, name):
        """Deletes specified decryption policy from Configuration Master 11.0
        ...
        *Example*
        | CM110 Decryption Policies Delete | myDecrPol |
        """
        self.decryption_policies_delete(name)

    def cm110_decryption_policies_edit(self,
                                       name,
                                       new_name=None,
                                       description=None,
                                       order=None,
                                       ...
                                       user_agents=None,
                                       match_agents=True):
        """Edits decryption policy from Configuration Master 11.0
        ...
        *Examples*
        | CM110 Decryption Policies Edit | myDecrPol |
        | ... | identities=All Identities:selected:joe.smith |
        | CM110 Decryption Policies Edit | myDecrPol |
        | ... | identities=All Identities:all | time_range=myTime |
        | ... | proxy_ports=3128 |
        | CM110 Decryption Policies Edit | myDecrPol | identities=All Identities |
    ...
    def cm110_decryption_policies_edit_url_categories(self,
                                                      name,
                                                      url_categories=None,
        ...
        *Examples*
        ...
        | CM110 Decryption Policies Edit Url Categories | ${id1} |
    ...
    def cm110_decryption_policies_edit_wbrs(self,
                                            name,
                                            score_range=None,
        ...
        *Examples*
        | CM110 Decryption Policies Edit Wbrs | myDecrPol | setting_type=disable |
        | CM110 Decryption Policies Edit Wbrs | myDecrPol |
    ...
    def cm110_decryption_policies_edit_default_action(self, name, action):
        ...
        *Exceptions*
        ...
        Example:
        | CM110 Decryption Policies Edit Default Action | myDecrPol | action=decrypt |
        """
