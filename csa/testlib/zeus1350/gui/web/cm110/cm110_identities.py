# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm110/cm110_identities.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm110/cm110_identities.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $
...
class Cm110Identities(Identities):
    """
    Keywords library for WebUI page Web -> Configuration Master 11.0 -> Identities
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.0', 'Identification Profiles')

    def get_keyword_names(self):
        return [
            'cm110_identities_add_policy',
            'cm110_identities_edit_policy',
            'cm110_identities_delete_policy',
            'cm110_identities_enable_policy',
            'cm110_identities_disable_policy',
            'cm110_identities_is_enabled_policy',
            'cm110_identities_get_list',
        ]

    def cm110_identities_get_list(self):
        """
        ...
        | ${policies}= | CM110 Identities Get List |
    ...
    def cm110_identities_add_policy(self,
                                    name,
                                    description=None,
                                    order=None,
                                    subnet=None,
        ...
        """Adds new identity policy from Configuration Master 11.0
    ...
    def cm110_identities_edit_policy(self,
                                     name,
                                     new_name=None,
                                     description=None,
                                     order=None,
        ...
        """Edits existing identity policy from Configuration Master 11.0
    ...
    def cm110_identities_delete_policy(self, name):
        """Deletes existing identity policy from Configuration Master 11.0

        *Parameters*
        - `name`: name of identity to be deleted.

        *Example*
        | CM110 Identities Delete Policy | myID |
        """
        self.identities_delete_policy(name)

    def cm110_identities_enable_policy(self, name):
        """Enables existing identity policy from Configuration Master 11.0

        *Parameters*
        - `name` name of identity to enable

        *Example*
        | CM110 Identities Disable Policy | myID |
        """

        self.identities_enable_policy(name)

    def cm110_identities_disable_policy(self, name):
        """Disables existing identity policy from Configuration Master 11.0
    ...
    def cm110_identities_is_enabled_policy(self, name):
        ...
        *Examples*
            | ${enabled}= | CM110 Identities Is Enabled Policy | myID |
        """
