# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm110/cm110_onbox_dlp_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1100.gui.manager.onbox_dlp_policies import OnboxDlpPolicies


class Cm110OnboxDlpPolicies(OnboxDlpPolicies):
    """
    Keywords for Web -> Configuration Master 11.0 -> Cisco Data Security
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.0', 'Cisco Data Security')

    def get_keyword_names(self):
        return [
            'cm110_onbox_dlp_policies_add',
            'cm110_onbox_dlp_policies_delete',
            'cm110_onbox_dlp_policies_edit',
            'cm110_onbox_dlp_policies_edit_url_categories',
            'cm110_onbox_dlp_policies_edit_content',
            'cm110_onbox_dlp_policies_edit_wbrs',
        ]

    def cm110_onbox_dlp_policies_add(self,
                                     name,
                                     description=None,
                                     order=None,
                                     ...
                                     user_agents=None,
                                     match_agents=True):
        """Add new IDS policy from Configuration Master 11.0
        ...
        *Examples*
        | CM110 Onbox DLP Policies Add | three | description=Adding policy |
        ...
        | ... | user_agents=ie-all |
        | CM110 Onbox DLP Policies Add | zero | description=other policy |
        """
    ...
    def cm110_onbox_dlp_policies_delete(self, name):
        """Delete IDS policy from Configuration Master 11.0
        ...
        *Examples*
        | CM110 Onbox DLP Policies Delete | three |
        """
        self.onbox_dlp_policies_delete(name)

    def cm110_onbox_dlp_policies_edit(self,
                                      name,
                                      new_name=None,
                                      description=None,
                                      order=None,
                                      ...
                                      user_agents=None,
                                      match_agents=True):
        """Edit IDS policy from Configuration Master 11.0
        ...
        *Examples*
        | CM110 Onbox DLP Policies Edit | three | description=Adding policy |
        | ... | identities=Global Identity Policy | protocols=http, ftpoverhttp |
        | ... | proxy_ports=110 | subnets=911.0.1.0/24 |
    ...
    def cm110_onbox_dlp_policies_edit_url_categories(self,
                                                     name,
                                                     set_custom_all=None,
        ...
        *Examples*
        | CM110 Onbox DLP Policies Edit URL Categories  | three |
        | ... | url_categories=${webcats.CHAT}:block, ${webcats.ADULT}:block |
        | ... | set_predefined_all=monitor | uncategorized_action=global |
        | CM110 Onbox DLP Policies Edit URL Categories | three |
    ...
    def cm110_onbox_dlp_policies_edit_content(self,
                                              name,
        ...
        """Edit content setting for IDS policy from Configuration Master 11.0
        ...
        *Examples*
        | CM110 Onbox DLP Policies Edit Content | three | blocking_settings=custom |
        | ... | http_file_size=10 mb | ftp_file_size=no_limit |
        ...
        | CM110 Onbox DLP Policies Edit Content | zero | http_file_size=10 mb |
    ...
    def cm110_onbox_dlp_policies_edit_wbrs(self,
                                           name,
                                           settings_type=None,
                                           score=None,
                                           ):
        """Edit the WBRS for the IDS policy  from Configuration Master 11.0
        ...
        *Examples*
        | CM110 Onbox DLP Policies Edit WBRS | three | settings_type=custom  |
        | CM110 Onbox DLP Policies Edit WBRS | zero | settings_type=custom  |
        """
