# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm120/cm120_offbox_dlp_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1201.gui.manager.offbox_dlp_policies import OffboxDlpPolicies


class Cm110OffboxDlpPolicies(OffboxDlpPolicies):
    """
    Keywords for Web -> Configuration Master 12.0 -> External Data Loss Prevention
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 12.0', 'External Data Loss Prevention')

    def get_keyword_names(self):
        return [
            'cm120_offbox_dlp_policies_add',
            'cm120_offbox_dlp_policies_delete',
            'cm120_offbox_dlp_policies_edit',
            'cm120_offbox_dlp_policies_edit_destinations'
        ]

    def cm120_offbox_dlp_policies_add(self,
                                      name,
                                      description=None,
                                      order=1,
                                      ...
                                      user_agents=None,
                                      match_agents=True):
        """Add new DLP policy from Configuration Master 12.0
        ...
        *Examples*
        | CM120 Offbox DLP Policies Add | three | description=Adding policy  |
        ...
        | CM120 Offbox DLP Policies Add | zero |
        """
    ...
    def cm120_offbox_dlp_policies_edit(self,
                                       name,
                                       new_name=None,
                                       description=None,
                                       order=1,
                                       ...
                                       user_agents=None,
                                       match_agents=True):
        """Edit DLP policy from Configuration Master 12.0
        ...
        *Examples*
        | CM120 Offbox DLP Policies Edit |
        ...
        | CM120 Offbox DLP Policies Edit | zero | protocols=others |
        """
    ...
    def cm120_offbox_dlp_policies_delete(self, name):
        """Delete DLP policy from Configuration Master 12.0
        ...
        *Examples*
        | CM120 Offbox DLP Policies Delete | three |
        """
        self.offbox_dlp_policies_delete(name)

    def cm120_offbox_dlp_policies_edit_destinations(self,
                                                    name,
                                                    scan_uploads=None,
                                                    url_categories=None,
                                                    settings_type=None):
