#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm120/cm120_saas_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1201.gui.manager.saas_policies import SaasPolicies


class Cm110SaasPolicies(SaasPolicies):
    """
    Keywords library for WebUI page Web -> Configuration Master 12.0 -> SaaS Policies
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 12.0', 'SaaS Policies')

    def get_keyword_names(self):
        return [
            'cm120_saas_policies_enable_saas_application',
            'cm120_saas_policies_disable_saas_application',
            'cm120_saas_policies_add_saas_application',
            'cm120_saas_policies_edit_saas_application',
            'cm120_saas_policies_delete_saas_application',
        ]

    def cm120_saas_policies_enable_saas_application(self, name):
        """
        Enable SaaS Application Authentication Policy from Configuration Master 12.0
        ...
        *Examples*
        | CM120 Saas Policies Enable Application | myAppName |
        """
        self.saas_policies_enable_saas_application(name)

    def cm120_saas_policies_disable_saas_application(self, name):
        """Disable SaaS Application Authentication Policy  from Configuration Master 12.0
        ...
        *Examples*
        | CM120 Saas Policies Disable Application | myAppName |
        """
        self.saas_policies_disable_saas_application(name)

    def cm120_saas_policies_add_saas_application(self,
                                                 name,
                                                 sp_metadata,
                                                 description=None,
                                                 auth_realm=None,
        ...
        """Add SaaS Application policy from Configuration Master 12.0
        ...
        *Examples*
        ...
        | CM120 Saas Policies Add Saas Application | myAppPolicy |
        | ... | ${METADATA} |
        ...
        | CM120 Saas Policies Add Saas Application | zero | ${METADATA} |
        | ... | test policy |
        """
    ...
    def cm120_saas_policies_edit_saas_application(self,
                                                  name,
                                                  sp_metadata,
                                                  description=None,
                                                  auth_realm=None,
        ...
        """Edit SaaS Application from Configuration Master 12.0
        ...
        *Exceptions*
        ...
        | CM120 Saas Policies Edit Saas Application | myAppPolicy |
        | ... | ${ALT_METADATA} |
        | ... | description=test saas app |
        | ... | auth_realm=test |
        | ... | saas_sso_authentication_prompt=Transparently sign in SaaS users |
    ...
    def cm120_saas_policies_delete_saas_application(self, name):
        """Delete SaaS Application from Configuration Master 12.0
        ...
        *Example*
        | CM120 Saas Policies Delete Saas Application | myAppName |
        """
