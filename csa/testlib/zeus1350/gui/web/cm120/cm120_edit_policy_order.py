# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm120/cm120_edit_policy_order.py#1 $
...
class Cm110EditPolicyOrder(GuiCommon):
    """ Keywords for CM120 Edit Policy Order page where policies
    can be ordered by drag-and-drop.
    """

    def get_keyword_names(self):
        return [
            'cm120_edit_policy_order',
        ]

    def _open_policy_page(self, policy):
        """Go to specific Policies page."""
        self._navigate_to('Web', 'Configuration Master 12.0', policy)
    ...
    def cm120_edit_policy_order(self, policy, submit, *items):
        ...
        *Parameters:*
        ...
        to be reordered. It is string containing name of menu item in CM120 menu.
        Requried.
        ...
        *Examples:*
        | CM120 Edit Policy Order | Identities | ${True} |
        | Policy 1 | Policy 2 |

        | CM120 Edit Policy Order | SOCKS Policies | ${True} |
        | Policy 1 |
        | Policy 2 |
        | Policy 3 |
        | Policy 4 |
