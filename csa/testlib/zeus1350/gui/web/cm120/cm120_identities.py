#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm120/cm120_identities.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1201.gui.manager.identities import Identities


class Cm110Identities(Identities):
    """
    Keywords library for WebUI page Web -> Configuration Master 12.0 -> Identities
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 12.0', 'Identification Profiles')

    def get_keyword_names(self):
        return [
            'cm120_identities_add_policy',
            'cm120_identities_edit_policy',
            'cm120_identities_delete_policy',
            'cm120_identities_enable_policy',
            'cm120_identities_disable_policy',
            'cm120_identities_is_enabled_policy',
            'cm120_identities_get_list',
        ]

    def cm120_identities_get_list(self):
        """
        ...
        | ${policies}= | CM120 Identities Get List |
    ...
    def cm120_identities_add_policy(self,
                                    name,
                                    description=None,
                                    order=None,
                                    subnet=None,
        ...
        """Adds new identity policy from Configuration Master 12.0
    ...
    def cm120_identities_edit_policy(self,
                                     name,
                                     new_name=None,
                                     description=None,
                                     order=None,
        ...
        """Edits existing identity policy from Configuration Master 12.0
    ...
    def cm120_identities_delete_policy(self, name):
        """Deletes existing identity policy from Configuration Master 12.0

        *Parameters*
        - `name`: name of identity to be deleted.

        *Example*
        | CM120 Identities Delete Policy | myID |
        """
        self.identities_delete_policy(name)

    def cm120_identities_enable_policy(self, name):
        """Enables existing identity policy from Configuration Master 12.0

        *Parameters*
        - `name` name of identity to enable

        *Example*
        | CM120 Identities Disable Policy | myID |
        """

        self.identities_enable_policy(name)

    def cm120_identities_disable_policy(self, name):
        """Disables existing identity policy from Configuration Master 12.0
    ...
    def cm120_identities_is_enabled_policy(self, name):
        ...
        *Examples*
            | ${enabled}= | CM120 Identities Is Enabled Policy | myID |
        """
