#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/utilities/security_services_display.py#1 $
...
masters_map = {
    ...
    sma_config_masters.CM120: 'coeus_12_0_'
}
...
class SecurityServicesDisplay(GuiCommon):
    ...
    def _get_attributes(self, cm):
        ...
        elif cm == sma_config_masters.CM120:
            available_attributes = DisplayOptions.cm120_attributes
    ...
    def _set_web_reputation_filters(self, cm, mode, scanning=None):
        if mode is not None:
            if not mode:
                ...
                if cm in (
                sma_config_masters.CM91, sma_config_masters.CM105, sma_config_masters.CM110, sma_config_masters.CM117):
...
class DisplayOptions(cfgholder.CfgHolder):
    ...
    cm120_attributes = cm118_attributes
    ...
    def __init__(self, cm, all=None, **kwargs):
        ...
        elif str(cm) == sma_config_masters.CM120:
            attributes = self.cm120_attributes
        else:
