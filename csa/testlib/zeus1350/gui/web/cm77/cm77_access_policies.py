# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm77/cm77_access_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $

from coeus77.gui.manager.access_policies import AccessPolicies


class Cm77AccessPolicies(AccessPolicies):
    """
    Keywords for Web -> Configuration Master 7.7 -> Access Policies
    """

    def _open_acc_pol_page(self):
        """Go to Access Policies configuration page."""

        self._navigate_to('Web', 'Configuration Master 7.7', 'Access Policies')

    def get_keyword_names(self):
        return ['cm77_access_policies_add',
                'cm77_access_policies_edit',
                'cm77_access_policies_delete',
                'cm77_access_policies_edit_protocols_and_user_agents',
                'cm77_access_policies_edit_objects',
                'cm77_access_policies_edit_url_categories',
                'cm77_access_policies_edit_applications',
                'cm77_access_policies_edit_wbrs_and_ams_settings',
                'cm77_access_policies_edit_content_filtering_settings',
                'cm77_access_policies_disable_policy',
                'cm77_access_policies_enable_policy',
                'cm77_access_policies_is_enabled_policy',
                'cm77_access_policies_get_list',
                ]

    def cm77_access_policies_get_list(self):
        """
        ...
        Examples:
        | ${policies}= | CM77 Access Policies Get List |
    ...
    def cm77_access_policies_add(self,
                                 name,
                                 description=None,
                                 order=None,
                                 ...
                                 match_agents=None):
        """Adds new access policy from Configuration Master 7.7
        ...
        Examples:
        | CM77 Access Policies Add | myDefaultAccPol |
        | ... | description=This policy uses Global Identity Policy |


        | CM77 Access Policies Add | myOtherAccPol |
        | ... | description=This policy uses custom identity |
        | ... | identity=myID |

        | CM77 Access Policies Add | myNewPolicy |
    ...
    def cm77_access_policies_edit(self,
                                  name,
                                  description=None,
                                  order=None,
                                  identity='Global Identity Policy',
                                  ...
                                  common_user_agents=None,
                                  match_agents=True):
        """Edits specified access policy from Configuration Master 7.7
        ...
        Example:
        | CM77 Access Policies Edit | myNewTestPolicy |
    ...
    def cm77_access_policies_delete(self, name):
        """Deletes specified access policy from Configuration Master 7.7

        `name`: name of access policy to be deleted.

        Example:
        | CM77 Access Policy Delete | myAccPol |
        """
        self.access_policies_delete(name)

    def cm77_access_policies_edit_protocols_and_user_agents(self,
                                                            name,
                                                            setting_type='custom',
                                                            block_protocols=None,
                                                            connect_ports=None,
                                                            block_user_agents=None):
        """Sets protocol blocking from Configuration Master 7.7
        ...
        | CM77 Access Policies Edit Protocols And User Agents | myAccPol |
    ...
    def cm77_access_policies_edit_objects(self,
                                          name,
                                          setting_type='global',
                                          http_size=None,
                                          ftp_size=None,
        ...
        | CM77 Access Policies Edit Objects | myTestPolicy |
        | ... | setting_type=custom |
        | ... | http_size=1024 |
        | ... | ftp_size=1024 |
    ...
    def cm77_access_policies_edit_content_filtering_settings(self,
                                                             name,
                                                             setting_type='custom',
        ...
        | CM77 Access Policies Edit Content Filtering Settings | ${pol} |
        | ... | setting_type=global |
    ...
    def cm77_access_policies_edit_wbrs_and_ams_settings(self,
                                                        name,
                                                        setting_type='custom',
                                                        wbrs_setting=None,
                                                        sua_setting=None,
        ...
        Settings from Configuration Master 7.7
        ...
        | CM77 Access Policies Edit WBRS And AMS Settings | ${pol} |
        | ... | setting_type=global |
    ...
    def cm77_access_policies_edit_applications(self,
                                               name,
                                               defaults=None,
                                               actions=None,
        ...
        | CM77 Access Policies Edit Applications | Global Policy |
        | ... | defaults=${defs} |
        | ... | actions=${apps} |

        | CM77 Access Policies Edit Applications | test |
        | ... | actions=${apps1} |
        """
    ...
    def cm77_access_policies_edit_url_categories(self,
                                                 name,
                                                 url_categories=None,
        ...
        | CM77 Access Policies Edit Url Categories | myNewTestPolicy |
        | ... | ${url_cats} |
        | ... | block |
        ...
        | CM77 Access Policies Edit Url Categories | testPolicyWithTimebasedCategories |
        | ... | ${url_cats} |

        | CM77 Access Policies Edit Url Categories | testPolicyWithRedirectCategories |
    ...
    def cm77_access_policies_enable_policy(self, name):
        """Enables existing policy from Configuration Master 7.7

        Parameters:
            - `name` policy name to enable

        Examples:
            | CM77 Access Policies Enable Policy | myDefaultAccPol |
        """
        self.access_policies_enable_policy(name)

    def cm77_access_policies_disable_policy(self, name):
        """Disables existing policy from Configuration Master 7.7

        Parameters:
            - `name` policy name to enable

        Examples:
            | CM77 Access Policies Disable Policy | myDefaultAccPol |
        """
        self.access_policies_disable_policy(name)

    def cm77_access_policies_is_enabled_policy(self, name):
        ...
        Examples:
            | ${enabled}= | CM77 Access Policies Is Enabled Policy | myDefaultAccPol |
        """
