# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm77/cm77_onbox_dlp_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus77.gui.manager.onbox_dlp_policies import OnboxDlpPolicies


class Cm77OnboxDlpPolicies(OnboxDlpPolicies):
    """
    Keywords for Web -> Configuration Master 7.7 -> Cisco Data Security
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 7.7', 'Cisco Data Security')

    def get_keyword_names(self):
        return [
            'cm77_onbox_dlp_policies_add',
            'cm77_onbox_dlp_policies_delete',
            'cm77_onbox_dlp_policies_edit',
            'cm77_onbox_dlp_policies_edit_url_categories',
            'cm77_onbox_dlp_policies_edit_content',
            'cm77_onbox_dlp_policies_edit_wbrs',
        ]

    def cm77_onbox_dlp_policies_add(self,
                                    name,
                                    description=None,
                                    order=None,
                                    ...
                                    user_agents=None,
                                    match_agents=True):
        """Add new IDS policy from Configuration Master 7.7
        ...
        *Examples*
        | CM77 Onbox DLP Policies Add | three | description=Adding policy |
        ...
        | ... | user_agents=ie-all |
        | CM77 Onbox DLP Policies Add | zero | description=other policy |
        """
    ...
    def cm77_onbox_dlp_policies_delete(self, name):
        """Delete IDS policy from Configuration Master 7.7
        ...
        *Examples*
        | CM77 Onbox DLP Policies Delete | three |
        """
        self.onbox_dlp_policies_delete(name)

    def cm77_onbox_dlp_policies_edit(self,
                                     name,
                                     new_name=None,
                                     description=None,
                                     order=None,
                                     ...
                                     user_agents=None,
                                     match_agents=True):
        """Edit IDS policy from Configuration Master 7.7
        ...
        *Examples*
        | CM77 Onbox DLP Policies Edit | three | description=Adding policy |
        | ... | identities=Global Identity Policy | protocols=http, ftpoverhttp |
        | ... | proxy_ports=80 | subnets=99.1.1.0/24 |
    ...
    def cm77_onbox_dlp_policies_edit_url_categories(self,
                                                    name,
                                                    set_custom_all=None,
        ...
        *Examples*
        | CM77 Onbox DLP Policies Edit URL Categories  | three |
    ...
    def cm77_onbox_dlp_policies_edit_content(self,
                                             name,
        ...
        """Edit content setting for IDS policy from Configuration Master 7.7
        ...
        *Examples*
        | CM77 Onbox DLP Policies Edit Content | three | blocking_settings=custom |
        ...
        | CM77 Onbox DLP Policies Edit Content | zero | http_file_size=10 mb |
    ...
    def cm77_onbox_dlp_policies_edit_wbrs(self,
                                          name,
                                          settings_type=None,
                                          score=None,
                                          ):
        """Edit the WBRS for the IDS policy  from Configuration Master 7.7
        ...
        *Examples*
        | CM77 Onbox DLP Policies Edit WBRS | three | settings_type=custom  |
        | CM77 Onbox DLP Policies Edit WBRS | zero | settings_type=custom  |
        """
