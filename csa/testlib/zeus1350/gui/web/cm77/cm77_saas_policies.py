#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm77/cm77_saas_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus77.gui.manager.saas_policies import SaasPolicies


class Cm77SaasPolicies(SaasPolicies):
    """
    Keywords library for WebUI page Web -> Configuration Master 7.7 -> SaaS Policies
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 7.7', 'SaaS Policies')

    def get_keyword_names(self):
        return [
            'cm77_saas_policies_enable_saas_application',
            'cm77_saas_policies_disable_saas_application',
            'cm77_saas_policies_add_saas_application',
            'cm77_saas_policies_edit_saas_application',
            'cm77_saas_policies_delete_saas_application',
        ]

    def cm77_saas_policies_enable_saas_application(self, name):
        """
        Enable SaaS Application Authentication Policy from Configuration Master 7.7
        ...
        *Examples*
        | CM77 Saas Policies Enable Application | myAppName |
        """
        self.saas_policies_enable_saas_application(name)

    def cm77_saas_policies_disable_saas_application(self, name):
        """Disable SaaS Application Authentication Policy  from Configuration Master 7.7
        ...
        *Examples*
        | CM77 Saas Policies Disable Application | myAppName |
        """
        self.saas_policies_disable_saas_application(name)

    def cm77_saas_policies_add_saas_application(self,
                                                name,
                                                sp_metadata,
                                                description=None,
                                                auth_realm=None,
        ...
        """Add SaaS Application policy from Configuration Master 7.7
        ...
        *Examples*
        ...
        | CM77 Saas Policies Add Saas Application | myAppPolicy |
        | ... | ${METADATA} |
        ...
        | CM77 Saas Policies Add Saas Application | zero | ${METADATA} |
        | ... | test policy |
        """
    ...
    def cm77_saas_policies_edit_saas_application(self,
                                                 name,
                                                 sp_metadata,
                                                 description=None,
                                                 auth_realm=None,
        ...
        """Edit SaaS Application from Configuration Master 7.7
        ...
        *Exceptions*
        ...
        | CM77 Saas Policies Edit Saas Application | myAppPolicy |
        | ... | ${ALT_METADATA} |
        | ... | description=test saas app |
        | ... | auth_realm=test |
        | ... | saas_sso_authentication_prompt=Transparently sign in SaaS users |
    ...
    def cm77_saas_policies_delete_saas_application(self, name):
        """Delete SaaS Application from Configuration Master 7.7
        ...
        *Example*
        | CM77 Saas Policies Delete Saas Application | myAppName |
        """
