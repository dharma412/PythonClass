# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm75/cm75_routing_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $

from coeus75.gui.manager.routing_policies import RoutingPolicies


class Cm75RoutingPolicies(RoutingPolicies):
    """
    Keywords for Web -> Configuration Master 7.5 -> Routing Policies
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 7.5', 'Routing Policies')

    def get_keyword_names(self):
        return [
            'cm75_routing_policies_add',
            'cm75_routing_policies_delete',
            'cm75_routing_policies_edit',
            'cm75_routing_policies_edit_destination',
            'cm75_routing_policies_get_list',
        ]

    def cm75_routing_policies_get_list(self):
        """
    ...
    def cm75_routing_policies_add(self,
                                  ...
                                  match_agents=True):
        """
        Add new routing policy from Configuration Master 7.5
        ...
        Example:
        | CM75 Routing Policies Add | three |
    ...
    def cm75_routing_policies_edit(self,
                                   name,
                                   description=None,
                                   order=None,
                                   identities=None,
                                   ...
                                   match_agents=True):
        """
        Edit routing policy from Configuration Master 7.5
        ...
        Example:
        | CM75 RoutingPolicies Edit | three |
    ...
    def cm75_routing_policies_delete(self, name):
        """
        Delete routing policy from Configuration Master 7.5

        Parameters:
        - `name`: name of the policy to delete.

        Example:
        | CM75 RoutingPolicies Delete | three |

        """
        self.routing_policies_delete(name)

    def cm75_routing_policies_edit_destination(self, name, proxy_group):
        """
        Setup the destination for given routing policy from Configuration Master 7.5
        ...
        Examples:
        | CM75 RoutingPolicies Edit Destination| three | upstream2 |
        | CM75 RoutingPolicies Edit Destination| three | Use Global Policy Settings |
