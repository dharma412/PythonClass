# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm75/cm75_access_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $

from coeus75.gui.manager.access_policies import AccessPolicies


class Cm75AccessPolicies(AccessPolicies):
    """
    Keywords for Web -> Configuration Master 7.5 -> Access Policies
    """

    def _open_acc_pol_page(self):
        """Go to Access Policies configuration page."""

        self._navigate_to('Web', 'Configuration Master 7.5', 'Access Policies')

    def get_keyword_names(self):
        return ['cm75_access_policies_add',
                'cm75_access_policies_edit',
                'cm75_access_policies_delete',
                'cm75_access_policies_edit_protocols_and_user_agents',
                'cm75_access_policies_edit_objects',
                'cm75_access_policies_edit_url_categories',
                'cm75_access_policies_edit_applications',
                'cm75_access_policies_edit_wbrs_and_ams_settings',
                'cm75_access_policies_edit_content_filtering_settings',
                'cm75_access_policies_disable_policy',
                'cm75_access_policies_enable_policy',
                'cm75_access_policies_is_enabled_policy',
                'cm75_access_policies_get_list',
                ]

    def cm75_access_policies_get_list(self):
        """
        ...
        Examples:
        | ${policies}= | CM75 Access Policies Get List |
    ...
    def cm75_access_policies_add(self,
                                 name,
                                 description=None,
                                 order=None,
                                 ...
                                 match_agents=None):
        """Adds new access policy from Configuration Master 7.5
        ...
        Examples:
        | CM75 Access Policies Add | myDefaultAccPol |
        | ... | description=This policy uses Global Identity Policy |


        | CM75 Access Policies Add | myOtherAccPol |
        | ... | description=This policy uses custom identity |
        | ... | identity=myID |

        | CM75 Access Policies Add | myNewPolicy |
    ...
    def cm75_access_policies_edit(self,
                                  name,
                                  description=None,
                                  order=None,
                                  identity='Global Identity Policy',
                                  ...
                                  common_user_agents=None,
                                  match_agents=True):
        """Edits specified access policy from Configuration Master 7.5
        ...
        Example:
        | CM75 Access Policies Edit | myNewTestPolicy |
    ...
    def cm75_access_policies_delete(self, name):
        """Deletes specified access policy from Configuration Master 7.5

        `name`: name of access policy to be deleted.

        Example:
        | CM75 Access Policy Delete | myAccPol |
        """
        self.access_policies_delete(name)

    def cm75_access_policies_edit_protocols_and_user_agents(self,
                                                            name,
                                                            setting_type='custom',
                                                            block_protocols=None,
                                                            connect_ports=None,
                                                            block_user_agents=None):
        """Sets protocol blocking from Configuration Master 7.5
        ...
        | CM75 Access Policies Edit Protocols And User Agents | myAccPol |
    ...
    def cm75_access_policies_edit_objects(self,
                                          name,
                                          setting_type='global',
                                          http_size=None,
                                          ftp_size=None,
        ...
        | CM75 Access Policies Edit Objects | myTestPolicy |
        | ... | setting_type=custom |
        | ... | http_size=1024 |
        | ... | ftp_size=1024 |
    ...
    def cm75_access_policies_edit_content_filtering_settings(self,
                                                             name,
                                                             setting_type='custom',
        ...
        | CM75 Access Policies Edit Content Filtering Settings | ${pol} |
        | ... | setting_type=global |
    ...
    def cm75_access_policies_edit_wbrs_and_ams_settings(self,
                                                        name,
                                                        setting_type='custom',
                                                        wbrs_setting=None,
                                                        sua_setting=None,
        ...
        Settings from Configuration Master 7.5
        ...
        | CM75 Access Policies Edit WBRS And AMS Settings | ${pol} |
        | ... | setting_type=global |
    ...
    def cm75_access_policies_edit_applications(self,
                                               name,
                                               defaults=None,
                                               actions=None,
        ...
        | CM75 Access Policies Edit Applications | Global Policy |
        | ... | defaults=${defs} |
        | ... | actions=${apps} |

        | CM75 Access Policies Edit Applications | test |
        | ... | actions=${apps1} |
        """
    ...
    def cm75_access_policies_edit_url_categories(self,
                                                 name,
                                                 url_categories=None,
        ...
        | CM75 Access Policies Edit Url Categories | myNewTestPolicy |
        | ... | ${url_cats} |
        | ... | block |
        ...
        | CM75 Access Policies Edit Url Categories | testPolicyWithTimebasedCategories |
        | ... | ${url_cats} |

        | CM75 Access Policies Edit Url Categories | testPolicyWithRedirectCategories |
    ...
    def cm75_access_policies_enable_policy(self, name):
        """Enables existing policy from Configuration Master 7.5

        Parameters:
            - `name` policy name to enable

        Examples:
            | CM75 Access Policies Enable Policy | myDefaultAccPol |
        """
        self.access_policies_enable_policy(name)

    def cm75_access_policies_disable_policy(self, name):
        """Disables existing policy from Configuration Master 7.5

        Parameters:
            - `name` policy name to enable

        Examples:
            | CM75 Access Policies Disable Policy | myDefaultAccPol |
        """
        self.access_policies_disable_policy(name)

    def cm75_access_policies_is_enabled_policy(self, name):
        ...
        Examples:
            | ${enabled}= | CM75 Access Policies Is Enabled Policy | myDefaultAccPol |
        """
