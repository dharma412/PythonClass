# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm75/cm75_decryption_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $

from coeus75.gui.manager.decryption_policies import DecryptionPolicies


class Cm75DecryptionPolicies(DecryptionPolicies):
    """
    Keywords for Web -> Configuration Master 7.5 -> Decryption Policies
    """

    def _open_decr_policy_page(self):
        self._navigate_to('Web', 'Configuration Master 7.5', 'Decryption Policies')

    def get_keyword_names(self):
        return ['cm75_decryption_policies_add',
                'cm75_decryption_policies_delete',
                'cm75_decryption_policies_edit',
                'cm75_decryption_policies_edit_url_categories',
                'cm75_decryption_policies_edit_default_action',
                'cm75_decryption_policies_edit_wbrs',
                'cm75_decryption_policies_get_list',
                ]

    def cm75_decryption_policies_get_list(self):
        """
    ...
    def cm75_decryption_policies_add(self,
                                     ...
                                     user_agents=None,
                                     match_agents=True):
        """Adds new decryption policy from Configuration Master 7.5

       Exceptions:
       - GuiFeatureDisabledError:Decryption Policies are currently disabled
       - ConfigError:Decryption group with the name xxx already exists
        ...
        Examples:
        | CM75 Decryption Policies Add | myDefaultDecrPol | description=This policy uses Global Identity Policy | identities=Global Identity Policy |
        | CM75 Decryption Policies Add | myOtherDecrPol | description=This policy uses custom identity | identities=myID:authenticated |
        | CM75 Decryption Policies Add | myOtherDecrPol | description=This policy uses custom identity | identities=myID:selected:jsmith |
        """
    ...
    def cm75_decryption_policies_delete(self, name):
        """Deletes specified decryption policy from Configuration Master 7.5
       ...
       - GuiFeatureDisabledError:Decryption Policies are currently disabled
        ...
        Example:
        | CM75 Decryption Policies Delete | myDecrPol |
        """
        self.decryption_policies_delete(name)

    def cm75_decryption_policies_edit(self,
                                      name,
                                      new_name=None,
                                      description=None,
                                      order=None,
                                      ...
                                      user_agents=None,
                                      match_agents=True):
        """Edits decryption policy from Configuration Master 7.5
       ...
       - GuiFeatureDisabledError:Decryption Policies are currently disabled
        ...
        Examples:
        | CM75 Decryption Policies Edit | myDecrPol | identities=All Identities:selected:joe.smith |
        | CM75 Decryption Policies Edit | myDecrPol | identities=All Identities:all | time_range=myTime | proxy_ports=3128 |
        | CM75 Decryption Policies Edit | myDecrPol | identities=All Identities | time_range=myTime | proxy_ports=3128 | url_categories=Weapons,Adult |
        """
    ...
    def cm75_decryption_policies_edit_url_categories(self,
                                                     name,
                                                     url_categories=None,
       ...
       - ValueE::Time based action does not have select all'
       ...
       - ValueError:Customed URL for Global Policy does not have select all global settings
        ...
        | CM75 Decryption Policies Edit Url Categories | ${id1} |
    ...
    def cm75_decryption_policies_edit_wbrs(self,
                                           name,
                                           score_range=None,
       ...
       Exceptions:
       - GuiFeatureDisabledError:Decryption Policies are currently disabled
       - GuiFeatureDisabledError:Web Reputation Filtering is disabled globally
       - ValueError:Invalid WBRS settings - xxx

        Examples:
        | CM75 Decryption Policies Edit Wbrs | myDecrPol | setting_type=disable |
        | CM75 Decryption Policies Edit Wbrs | myDecrPol | score_range=-3:5 | no_score_action=decrypt |
        """
    ...
    def cm75_decryption_policies_edit_default_action(self, name, action):
       ...
       - GuiFeatureDisabledError:Decryption Policies are currently disabled
        ...
        Example:
        | CM75 Decryption Policies Edit Default Action | myDecrPol | action=decrypt |
        """
