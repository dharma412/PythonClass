# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm75/cm75_saas_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus75.gui.manager.saas_policies import SaasPolicies


class Cm75SaasPolicies(SaasPolicies):
    """
    Keywords for Web -> Configuration Master 7.5 -> SaaS Policies
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 7.5', 'SaaS Policies')

    def get_keyword_names(self):
        return [
            'cm75_saas_policies_enable_saas_application',
            'cm75_saas_policies_disable_saas_application',
            'cm75_saas_policies_add_saas_application',
            'cm75_saas_policies_edit_saas_application',
            'cm75_saas_policies_delete_saas_application',
        ]

    def cm75_saas_policies_enable_saas_application(self, name):
        """
        Enable SaaS Application Authentication Policy from Configuration Master 7.5
        ...
        Example:
        | CM75 Saas Policies Enable Application | myAppName |
        """
        self.saas_policies_enable_saas_application(name)

    def cm75_saas_policies_disable_saas_application(self, name):
        """Disable SaaS Application Authentication Policy  from Configuration Master 7.5
        ...
        Example:
        | CM75 Saas Policies Disable Application | myAppName |
        """
        self.saas_policies_disable_saas_application(name)

    def cm75_saas_policies_add_saas_application(self,
                                                name,
                                                sp_metadata,
                                                description=None,
                                                auth_realm=None,
        ...
        """Add SaaS Application policy from Configuration Master 7.5
        ...
        Either `Prompt` or 'Transparently'. First value used by default.
        ...
        | CM75 Saas Policies Add Saas Application | myAppPolicy |
        | ... | ${METADATA} |
    ...
    def cm75_saas_policies_edit_saas_application(self,
                                                 name,
                                                 sp_metadata,
                                                 description=None,
                                                 auth_realm=None,
        ...
        """Edit SaaS Application from Configuration Master 7.5
        ...
        authentication credentials, or to always prompt users for their
        credentials when accessing the SaaS application. String.
        Either `Prompt` or 'Transparently'.
        - `saml_username_mapping`: Specify how the Web Proxy should represent user
        names to the service provider in the SAML assertion. List with 2
        elements. First element represents one of methods:  'No mapping',
        'LDAP query', 'Fixed Rule mapping'. Second element used when method is
        ...
        | CM75 Saas Policies Edit Saas Application | myAppPolicy |
        | ... | ${ALT_METADATA} |
        | ... | description=test saas app |
        | ... | auth_realm=test |
        | ... | saas_sso_authentication_prompt=Transparently sign in SaaS users |
    ...
    def cm75_saas_policies_delete_saas_application(self, name):
        """Delete SaaS Application from Configuration Master 7.5
        ...
        Example:
        | CM75 Saas Policies Delete Saas Application | myAppName |
        """
