# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm115/cm115_identities.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm115/cm115_identities.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1100.gui.manager.identities import Identities


class Cm110Identities(Identities):
    """
    Keywords library for WebUI page Web -> Configuration Master 11.5 -> Identities
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.5', 'Identification Profiles')

    def get_keyword_names(self):
        return [
            'cm115_identities_add_policy',
            'cm115_identities_edit_policy',
            'cm115_identities_delete_policy',
            'cm115_identities_enable_policy',
            'cm115_identities_disable_policy',
            'cm115_identities_is_enabled_policy',
            'cm115_identities_get_list',
        ]

    def cm115_identities_get_list(self):
        """
        ...
        | ${policies}= | CM115 Identities Get List |
    ...
    def cm115_identities_add_policy(self,
                                    name,
                                    description=None,
                                    order=None,
                                    subnet=None,
        ...
        """Adds new identity policy from Configuration Master 11.5
    ...
    def cm115_identities_edit_policy(self,
                                     name,
                                     new_name=None,
                                     description=None,
                                     order=None,
        ...
        """Edits existing identity policy from Configuration Master 11.5
    ...
    def cm115_identities_delete_policy(self, name):
        """Deletes existing identity policy from Configuration Master 11.5

        *Parameters*
        - `name`: name of identity to be deleted.

        *Example*
        | CM115 Identities Delete Policy | myID |
        """
        self.identities_delete_policy(name)

    def cm115_identities_enable_policy(self, name):
        """Enables existing identity policy from Configuration Master 11.5

        *Parameters*
        - `name` name of identity to enable

        *Example*
        | CM115 Identities Disable Policy | myID |
        """

        self.identities_enable_policy(name)

    def cm115_identities_disable_policy(self, name):
        """Disables existing identity policy from Configuration Master 11.5
    ...
    def cm115_identities_is_enabled_policy(self, name):
        ...
        *Examples*
            | ${enabled}= | CM115 Identities Is Enabled Policy | myID |
        """
