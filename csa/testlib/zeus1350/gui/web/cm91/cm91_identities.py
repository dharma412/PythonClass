# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm91/cm91_identities.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm91/cm91_identities.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus90.gui.manager.identities import Identities


class Cm91Identities(Identities):
    """
    Keywords library for WebUI page Web -> Configuration Master 9.1 -> Identities
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 9.1', 'Identification Profiles')

    def get_keyword_names(self):
        return [
            'cm91_identities_add_policy',
            'cm91_identities_edit_policy',
            'cm91_identities_delete_policy',
            'cm91_identities_enable_policy',
            'cm91_identities_disable_policy',
            'cm91_identities_is_enabled_policy',
            'cm91_identities_get_list',
        ]

    def cm91_identities_get_list(self):
        """
        ...
        | ${policies}= | CM91 Identities Get List |
    ...
    def cm91_identities_add_policy(self,
                                   name,
                                   description=None,
                                   order=None,
                                   subnet=None,
        ...
        """Adds new identity policy from Configuration Master 9.1
    ...
    def cm91_identities_edit_policy(self,
                                    name,
                                    new_name=None,
                                    description=None,
                                    order=None,
        ...
        """Edits existing identity policy from Configuration Master 9.1
        ...
        *Examples*
           ...
           | ... | subnet=1.2.3.0/24 |
           | Identities Edit policy | subnet | proxy_ports=91, 3128 |
        """
    ...
    def cm91_identities_delete_policy(self, name):
        """Deletes existing identity policy from Configuration Master 9.1

        *Parameters*
        - `name`: name of identity to be deleted.

        *Example*
        | CM91 Identities Delete Policy | myID |
        """
        self.identities_delete_policy(name)

    def cm91_identities_enable_policy(self, name):
        """Enables existing identity policy from Configuration Master 9.1

        *Parameters*
        - `name` name of identity to enable

        *Example*
        | CM91 Identities Disable Policy | myID |
        """

        self.identities_enable_policy(name)

    def cm91_identities_disable_policy(self, name):
        """Disables existing identity policy from Configuration Master 9.1
    ...
    def cm91_identities_is_enabled_policy(self, name):
        ...
        *Examples*
            | ${enabled}= | CM91 Identities Is Enabled Policy | myID |
        """
