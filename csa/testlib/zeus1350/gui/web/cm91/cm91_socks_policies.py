# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm91/cm91_socks_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $

import common.gui.guiexceptions as guiexceptions
from coeus90.gui.manager.socks_policies import SOCKSPolicies


class Cm91SOCKSPolicies(SOCKSPolicies):
    """
    Keywords for Web -> Configuration Master 9.1 -> SOCKS Policies
    """

    def _open_page(self):
        """Go to SOCKS Policies configuration page."""

        self._navigate_to('Web', 'Configuration Master 9.1', 'SOCKS Policies')
    ...
    def get_keyword_names(self):
        return ['cm91_socks_policies_add',
                'cm91_socks_policies_edit',
                'cm91_socks_policies_delete',
                'cm91_socks_policies_edit_destination_ports',
                'cm91_socks_policies_edit_destination_urls',
                'cm91_socks_policies_disable_policy',
                'cm91_socks_policies_enable_policy',
                'cm91_socks_policies_is_enabled_policy',
                'cm91_socks_policies_get_list',
                ]

    def cm91_socks_policies_add(self,
                                name,
                                description=None,
                                order=None,
                                identities=None,
        ...
        Examples:
        - | CM91 SOCKS Policies Add | myDefaultPol | description=This policy uses Global Identity Policy | identities=Global Identity Policy |
        - | CM91 SOCKS Policies Add | myOtherPol | description=This policy uses specified identity | identities=myID:authenticated |
        - | CM91 SOCKS Policies Add | myOtherPol2 | proxy_ports=1091 |
    ...
    def cm91_socks_policies_delete(self, name):
        ...
        Example:
        - | CM91 SOCKS Policies Delete | myDefaultPol |
    ...
    def cm91_socks_policies_edit(self,
                                 name,
                                 new_name=None,
                                 description=None,
                                 order=None,
    ...
    def cm91_socks_policies_edit_destination_ports(self,
                                                   name,
                                                   ports_settings=None,
                                                   tcp_ports=None,
                                                   udp_ports=None,
        ...
        Examples:
        - | CM91 SOCKS Policies Edit Destination Ports | myPolicy |
    ...
    def cm91_socks_policies_edit_destination_urls(self,
                                                  name,
                                                  setting_type=None,
        ...
        Examples:
        - | CM91 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=global |
        - | CM91 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=block_all |
        - | CM91 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=allow_all |
        - | CM91 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=allow_specified | specified_url_categories=all |
        - | CM91 SOCKS Policies Edit Destination Urls | myPolicy | setting_type=allow_specified | specified_url_categories=cats, dogs |
    ...
    def cm91_socks_policies_is_enabled_policy(self, name):
        ...
        Examples:
            | ${enabled}= | CM91 SOCKS Policies Is Enabled Policy | myDefaultAccPol |
        """

        self._open_page()
        return self._is_enabled(name)

    def cm91_socks_policies_get_list(self):
        """
        ...
        | ${policies}= | CM91 SOCKS Policies Get List |
    ...
    def cm91_socks_policies_enable_policy(self, name):
        ...
        Examples:
            | CM91 SOCKS Policies Enable Policy | myDefaultPol |
        """

        self._open_page()
        self._enable(name)

    def cm91_socks_policies_disable_policy(self, name):
        ...
        Examples:
            | CM91 SOCKS Policies Disable Policy | myDefaultPol |
        """
