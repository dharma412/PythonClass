# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm91/cm91_routing_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm91/cm91_routing_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $  $Author: sarukakk $

from coeus90.gui.manager.routing_policies import RoutingPolicies


class Cm91RoutingPolicies(RoutingPolicies):
    """
    Keywords for Web -> Configuration Master 9.1 -> Routing Policies
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 9.1', 'Routing Policies')

    def get_keyword_names(self):
        return [
            'cm91_routing_policies_add',
            'cm91_routing_policies_delete',
            'cm91_routing_policies_edit',
            'cm91_routing_policies_edit_destination',
            'cm91_routing_policies_get_list',
        ]

    def cm91_routing_policies_get_list(self):
        """
    ...
    def cm91_routing_policies_add(self,
                                  ...
                                  match_agents=True):
        """
        Add new routing policy from Configuration Master 9.1
        ...
        *Examples*
        | CM91 Routing Policies Add | three | description=Adding policy |
    ...
    def cm91_routing_policies_edit(self,
                                   name,
                                   description=None,
                                   order=None,
                                   identities=None,
                                   ...
                                   match_agents=True):
        """
        Edit routing policy from Configuration Master 9.1
        ...
        *Examples*
        | CM91 RoutingPolicies Edit | three | description=Editing policy |
        | ... | order=None | identities=Global Identity Policy |
        ...
        | CM91 RoutingPolicies Edit | zero | new description |
        """
    ...
    def cm91_routing_policies_delete(self, name):
        """
        Delete routing policy from Configuration Master 9.1

        *Parameters*
        - `name`: name of the policy to delete.

        *Example*
        | CM91 RoutingPolicies Delete | three |

        """
        self.routing_policies_delete(name)

    def cm91_routing_policies_edit_destination(self, name, proxy_group):
        """
        Setup the destination for given routing policy from Configuration Master 9.1
        ...
        *Examples*
        | CM91 RoutingPolicies Edit Destination| three | upstream2 |
        | CM91 RoutingPolicies Edit Destination| three | Use Global Policy Settings |
