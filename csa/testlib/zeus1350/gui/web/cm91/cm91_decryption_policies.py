# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm91/cm91_decryption_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm91/cm91_decryption_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus90.gui.manager.decryption_policies import DecryptionPolicies


class Cm91DecryptionPolicies(DecryptionPolicies):
    """
    Keywords library for WebUI page Web -> Configuration Master 9.1 -> Decryption Policies
    """

    def _open_decr_policy_page(self):
        self._navigate_to('Web', 'Configuration Master 9.1', 'Decryption Policies')

    def get_keyword_names(self):
        return ['cm91_decryption_policies_add',
                'cm91_decryption_policies_delete',
                'cm91_decryption_policies_edit',
                'cm91_decryption_policies_edit_url_categories',
                'cm91_decryption_policies_edit_default_action',
                'cm91_decryption_policies_edit_wbrs',
                'cm91_decryption_policies_get_list',
                ]

    def cm91_decryption_policies_get_list(self):
        """
    ...
    def cm91_decryption_policies_add(self,
                                     ...
                                     user_agents=None,
                                     match_agents=True):
        """Adds new decryption policy from Configuration Master 9.1
        ...
        *Examples*
        | CM91 Decryption Policies Add | myDefaultDecrPol |
        | ... | description=This policy uses Global Identity Policy |
        | ... | identities=Global Identity Policy |
        | CM91 Decryption Policies Add | myOtherDecrPol |
    ...
    def cm91_decryption_policies_delete(self, name):
        """Deletes specified decryption policy from Configuration Master 9.1
        ...
        *Example*
        | CM91 Decryption Policies Delete | myDecrPol |
        """
        self.decryption_policies_delete(name)

    def cm91_decryption_policies_edit(self,
                                      name,
                                      new_name=None,
                                      description=None,
                                      order=None,
                                      ...
                                      user_agents=None,
                                      match_agents=True):
        """Edits decryption policy from Configuration Master 9.1
        ...
        *Examples*
        | CM91 Decryption Policies Edit | myDecrPol |
        | ... | identities=All Identities:selected:joe.smith |
        | CM91 Decryption Policies Edit | myDecrPol |
        | ... | identities=All Identities:all | time_range=myTime |
        | ... | proxy_ports=3128 |
        | CM91 Decryption Policies Edit | myDecrPol | identities=All Identities |
    ...
    def cm91_decryption_policies_edit_url_categories(self,
                                                     name,
                                                     url_categories=None,
        ...
        *Examples*
        ...
        | CM91 Decryption Policies Edit Url Categories | ${id1} |
    ...
    def cm91_decryption_policies_edit_wbrs(self,
                                           name,
                                           score_range=None,
        ...
        *Examples*
        | CM91 Decryption Policies Edit Wbrs | myDecrPol | setting_type=disable |
        | CM91 Decryption Policies Edit Wbrs | myDecrPol |
    ...
    def cm91_decryption_policies_edit_default_action(self, name, action):
        ...
        *Exceptions*
        ...
        Example:
        | CM91 Decryption Policies Edit Default Action | myDecrPol | action=decrypt |
        """
