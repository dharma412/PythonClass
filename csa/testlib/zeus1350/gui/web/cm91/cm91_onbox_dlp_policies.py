# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm91/cm91_onbox_dlp_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus90.gui.manager.onbox_dlp_policies import OnboxDlpPolicies


class Cm91OnboxDlpPolicies(OnboxDlpPolicies):
    """
    Keywords for Web -> Configuration Master 9.1 -> Cisco Data Security
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 9.1', 'Cisco Data Security')

    def get_keyword_names(self):
        return [
            'cm91_onbox_dlp_policies_add',
            'cm91_onbox_dlp_policies_delete',
            'cm91_onbox_dlp_policies_edit',
            'cm91_onbox_dlp_policies_edit_url_categories',
            'cm91_onbox_dlp_policies_edit_content',
            'cm91_onbox_dlp_policies_edit_wbrs',
        ]

    def cm91_onbox_dlp_policies_add(self,
                                    name,
                                    description=None,
                                    order=None,
                                    ...
                                    user_agents=None,
                                    match_agents=True):
        """Add new IDS policy from Configuration Master 9.1
        ...
        *Examples*
        | CM91 Onbox DLP Policies Add | three | description=Adding policy |
        ...
        | ... | user_agents=ie-all |
        | CM91 Onbox DLP Policies Add | zero | description=other policy |
        """
    ...
    def cm91_onbox_dlp_policies_delete(self, name):
        """Delete IDS policy from Configuration Master 9.1
        ...
        *Examples*
        | CM91 Onbox DLP Policies Delete | three |
        """
        self.onbox_dlp_policies_delete(name)

    def cm91_onbox_dlp_policies_edit(self,
                                     name,
                                     new_name=None,
                                     description=None,
                                     order=None,
                                     ...
                                     user_agents=None,
                                     match_agents=True):
        """Edit IDS policy from Configuration Master 9.1
        ...
        *Examples*
        | CM91 Onbox DLP Policies Edit | three | description=Adding policy |
        | ... | identities=Global Identity Policy | protocols=http, ftpoverhttp |
        | ... | proxy_ports=91 | subnets=99.1.1.0/24 |
    ...
    def cm91_onbox_dlp_policies_edit_url_categories(self,
                                                    name,
                                                    set_custom_all=None,
        ...
        *Examples*
        | CM91 Onbox DLP Policies Edit URL Categories  | three |
    ...
    def cm91_onbox_dlp_policies_edit_content(self,
                                             name,
        ...
        """Edit content setting for IDS policy from Configuration Master 9.1
        ...
        *Examples*
        | CM91 Onbox DLP Policies Edit Content | three | blocking_settings=custom |
        ...
        | CM91 Onbox DLP Policies Edit Content | zero | http_file_size=10 mb |
    ...
    def cm91_onbox_dlp_policies_edit_wbrs(self,
                                          name,
                                          settings_type=None,
                                          score=None,
                                          ):
        """Edit the WBRS for the IDS policy  from Configuration Master 9.1
        ...
        *Examples*
        | CM91 Onbox DLP Policies Edit WBRS | three | settings_type=custom  |
        | CM91 Onbox DLP Policies Edit WBRS | zero | settings_type=custom  |
        """
