# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm91/cm91_access_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $

from coeus90.gui.manager.access_policies import AccessPolicies


class Cm91AccessPolicies(AccessPolicies):
    """
    Keywords for Web -> Configuration Master 9.1 -> Access Policies
    """

    def _open_acc_pol_page(self):
        """Go to Access Policies configuration page."""

        self._navigate_to('Web', 'Configuration Master 9.1', 'Access Policies')

    def get_keyword_names(self):
        return ['cm91_access_policies_add',
                'cm91_access_policies_edit',
                'cm91_access_policies_delete',
                'cm91_access_policies_edit_protocols_and_user_agents',
                'cm91_access_policies_edit_objects',
                'cm91_access_policies_edit_url_categories',
                'cm91_access_policies_edit_applications',
                'cm91_access_policies_edit_anti_malware_and_reputation',
                'cm91_access_policies_edit_content_filtering_settings',
                'cm91_access_policies_disable_policy',
                'cm91_access_policies_enable_policy',
                'cm91_access_policies_is_enabled_policy',
                'cm91_access_policies_get_list',
                ]

    def cm91_access_policies_get_list(self):
        """
        ...
        Examples:
        | ${policies}= | CM91 Access Policies Get List |
    ...
    def cm91_access_policies_add(self,
                                 name,
                                 description=None,
                                 order=None,
                                 ...
                                 match_agents=None):
        """Adds new access policy from Configuration Master 9.1
        ...
        Examples:
        | CM91 Access Policies Add | myDefaultAccPol |
        | ... | description=This policy uses Global Identity Policy |


        | CM91 Access Policies Add | myOtherAccPol |
        | ... | description=This policy uses custom identity |
        | ... | identity=myID |

        | CM91 Access Policies Add | myNewPolicy |
        | ... | description=Test access policy |
        | ... | identity=Global Identity Policy |
        | ... | protocols=http |
        | ... | proxy_ports=9191, 3128 |
    ...
    def cm91_access_policies_edit(self,
                                  name,
                                  description=None,
                                  order=None,
                                  identity='Global Identity Policy',
                                  ...
                                  common_user_agents=None,
                                  match_agents=True):
        """Edits specified access policy from Configuration Master 9.1
        ...
        Example:
        | CM91 Access Policies Edit | myNewTestPolicy |
    ...
    def cm91_access_policies_delete(self, name):
        """Deletes specified access policy from Configuration Master 9.1

        `name`: name of access policy to be deleted.

        Example:
        | CM91 Access Policy Delete | myAccPol |
        """
        self.access_policies_delete(name)

    def cm91_access_policies_edit_protocols_and_user_agents(self,
                                                            name,
                                                            setting_type='custom',
                                                            block_protocols=None,
                                                            connect_ports=None,
                                                            block_user_agents=None):
        """Sets protocol blocking from Configuration Master 9.1
        ...
        | CM91 Access Policies Edit Protocols And User Agents | myAccPol |
        | ... | block_protocols=allow all |
        | ... | connect_ports=9191, 21, 443, 563, 8443, 20, 1-15 |
    ...
    def cm91_access_policies_edit_objects(self,
                                          name,
                                          setting_type='global',
                                          http_size=None,
                                          ftp_size=None,
        ...
        | CM91 Access Policies Edit Objects | myTestPolicy |
        | ... | setting_type=custom |
        | ... | http_size=1024 |
        | ... | ftp_size=1024 |
    ...
    def cm91_access_policies_edit_content_filtering_settings(self,
                                                             name,
                                                             setting_type='custom',
        ...
        | CM91 Access Policies Edit Content Filtering Settings | ${pol} |
        | ... | setting_type=global |
    ...
    def cm91_access_policies_edit_anti_malware_and_reputation(self,
                                                              name,
                                                              setting_type='custom',
                                                              wbrs_setting=None,
                                                              sua_setting=None,
        ...
        Settings from Configuration Master 9.1
        ...
        | CM91 Access Policies Edit Anti Malware And Reputation | ${pol} |
        | ... | setting_type=global |
    ...
    def cm91_access_policies_edit_applications(self,
                                               name,
                                               defaults=None,
                                               actions=None,
        ...
        | CM91 Access Policies Edit Applications | Global Policy |
        | ... | defaults=${defs} |
        | ... | actions=${apps} |

        | CM91 Access Policies Edit Applications | test |
        | ... | actions=${apps1} |
        """
    ...
    def cm91_access_policies_edit_url_categories(self,
                                                 name,
                                                 url_categories=None,
        ...
        | CM91 Access Policies Edit Url Categories | myNewTestPolicy |
        | ... | ${url_cats} |
        | ... | block |
        ...
        | CM91 Access Policies Edit Url Categories | testPolicyWithTimebasedCategories |
        | ... | ${url_cats} |

        | CM91 Access Policies Edit Url Categories | testPolicyWithRedirectCategories |
    ...
    def cm91_access_policies_enable_policy(self, name):
        """Enables existing policy from Configuration Master 9.1

        Parameters:
            - `name` policy name to enable

        Examples:
            | CM91 Access Policies Enable Policy | myDefaultAccPol |
        """
        self.access_policies_enable_policy(name)

    def cm91_access_policies_disable_policy(self, name):
        """Disables existing policy from Configuration Master 9.1

        Parameters:
            - `name` policy name to enable

        Examples:
            | CM91 Access Policies Disable Policy | myDefaultAccPol |
        """
        self.access_policies_disable_policy(name)

    def cm91_access_policies_is_enabled_policy(self, name):
        ...
        Examples:
            | ${enabled}= | CM91 Access Policies Is Enabled Policy | myDefaultAccPol |
        """
