# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm118/cm118_custom_url_categories.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm118/cm118_custom_url_categories.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1180.gui.manager.custom_url_categories import CustomUrlCategories
...
class Cm110CustomUrlCategories(CustomUrlCategories):
    """
    Keywords library for WebUI page  Web -> Configuration Master 11.8 -> Custom URL Categories
    """
    ...
    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.8', 'Custom and External URL Categories')

    def get_keyword_names(self):
        return [
            'cm118_custom_url_categories_add',
            'cm118_custom_url_categories_delete',
            'cm118_custom_url_categories_edit',
            'cm118_custom_url_categories_get_list',
        ]

    def cm118_custom_url_categories_get_list(self):
        """
        Returns: list of custom url categories

        Examples:

        | ${policies}= | CM118 Custom URL Category Get List |
    ...
    def cm118_custom_url_categories_add(self,
                                        name,
                                        sites=None,
                                        order=1,
                                        regexes=None,
        ...
        *Example*
        | CM118 Custom Url Categories Add | nameOfCategory | site1.com, site2.com | order=1 |
        | CM118 Custom Url Categories Add | nameOfCategory | order=1 | regexes=regex1, regex2 |
        """
        if feed_type == "external" and ext_feed_type == "office_365_service":
            ext_feed_location = "https://endpoints.office.com/endpoints/china?ServiceAreas=skype&TenantName=Cisco"
        self.custom_url_category_add(
            ...
            regexes=regexes,
            feed_type=feed_type,
            ext_feed_type=ext_feed_type,
            protocol=protocol,
            ext_feed_location=ext_feed_location,
            ext_feed_auto_update=ext_feed_auto_update

        )

    def cm118_custom_url_categories_edit(self,
                                         name,
                                         sites=None,
                                         order=None,
                                         regexes=None):
        ...
        *Examples*
        | CM118 Custom Url Categories Edit | nameOfCategory | site1.com, site2.com | order=1 |
        | CM118 Custom Url Categories Edit | nameOfCategory | order=1 | regexes=regex1 |
        """
    ...
    def cm118_custom_url_categories_delete(self, name):
        ...
        *Examples*
        | CM118 Custom Url Categories Delete | nameOfCategory |
        | CM118 Custom Url Categories Delete | Category1 |
        """
