#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm118/cm118_oms_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1180.gui.manager.oms_policies import OMS_Policies


class Cm110OmsPolicies(OMS_Policies):
    """
    Keywords library for WebUI page Web -> Configuration Master 11.8 -> Outbound Malware Scanning
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.8', 'Outbound Malware Scanning')

    def get_keyword_names(self):
        return [
            'cm118_oms_policies_add',
            'cm118_oms_policies_delete',
            'cm118_oms_policies_edit',
            'cm118_oms_policies_edit_destinations',
            'cm118_oms_policies_edit_amw_filters'
        ]

    def cm118_oms_policies_add(self,
                               name,
                               description=None,
                               order=None,
                               identities=None,
                               ...
                               match_agents=None):
        """Add new policy from Configuration Master 11.8
        ...
        *Examples*
        | CM118 OMS Policies Add | three | description=Adding policy  |
        ...
        | ... | user_agents=ie-all |
        | CM118 OMS Policies Add | zero | subnets=192.168.20.0/24  |
        """
    ...
    def cm118_oms_policies_edit(self,
                                name,
                                description=None,
                                order=None,
                                identities=None,
                                ...
                                common_user_agents=None,
                                match_agents=None):
        """Edits specified policy from Configuration Master 11.8
        ...
        *Examples*
        | CM118 OMS Policies Edit | three | description=Editing policy |
        ...
        | CM118 OMS Policies Edit | zero | subnets=192.168.20.0/24 |
        """
    ...
    def cm118_oms_policies_delete(self, name):
        """Deletes specified policy from Configuration Master 11.8
        ...
        *Example*
        | CM118 OMS Policies Delete | three |
        """
        self.oms_policies_delete(name)

    def cm118_oms_policies_edit_amw_filters(self,
                                            name,
                                            settings_type,
                                            amw_actions=None,
                                            amw_select_all=None,
        ...
        *Examples*
        | CM118 OMS Policies Edit AMW Filters | three | global |
    ...
    def cm118_oms_policies_edit_destinations(self,
                                             name,
                                             settings_type,
                                             dest_to_scan=None,
                                             cust_url=None,
