# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm118/cm118_identities.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm118/cm118_identities.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1180.gui.manager.identities import Identities


class Cm110Identities(Identities):
    """
    Keywords library for WebUI page Web -> Configuration Master 11.8 -> Identities
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 11.8', 'Identification Profiles')

    def get_keyword_names(self):
        return [
            'cm118_identities_add_policy',
            'cm118_identities_edit_policy',
            'cm118_identities_delete_policy',
            'cm118_identities_enable_policy',
            'cm118_identities_disable_policy',
            'cm118_identities_is_enabled_policy',
            'cm118_identities_get_list',
        ]

    def cm118_identities_get_list(self):
        """
        ...
        | ${policies}= | CM118 Identities Get List |
    ...
    def cm118_identities_add_policy(self,
                                    name,
                                    description=None,
                                    order=None,
                                    subnet=None,
        ...
        """Adds new identity policy from Configuration Master 11.8
    ...
    def cm118_identities_edit_policy(self,
                                     name,
                                     new_name=None,
                                     description=None,
                                     order=None,
        ...
        """Edits existing identity policy from Configuration Master 11.8
    ...
    def cm118_identities_delete_policy(self, name):
        """Deletes existing identity policy from Configuration Master 11.8

        *Parameters*
        - `name`: name of identity to be deleted.

        *Example*
        | CM118 Identities Delete Policy | myID |
        """
        self.identities_delete_policy(name)

    def cm118_identities_enable_policy(self, name):
        """Enables existing identity policy from Configuration Master 11.8

        *Parameters*
        - `name` name of identity to enable

        *Example*
        | CM118 Identities Disable Policy | myID |
        """

        self.identities_enable_policy(name)

    def cm118_identities_disable_policy(self, name):
        """Disables existing identity policy from Configuration Master 11.8
    ...
    def cm118_identities_is_enabled_policy(self, name):
        ...
        *Examples*
            | ${enabled}= | CM118 Identities Is Enabled Policy | myID |
        """
