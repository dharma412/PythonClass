# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm105/cm105_offbox_dlp_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1050.gui.manager.offbox_dlp_policies import OffboxDlpPolicies


class Cm105OffboxDlpPolicies(OffboxDlpPolicies):
    """
    Keywords for Web -> Configuration Master 10.5 -> External Data Loss Prevention
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 10.5', 'External Data Loss Prevention')

    def get_keyword_names(self):
        return [
            'cm105_offbox_dlp_policies_add',
            'cm105_offbox_dlp_policies_delete',
            'cm105_offbox_dlp_policies_edit',
            'cm105_offbox_dlp_policies_edit_destinations'
        ]

    def cm105_offbox_dlp_policies_add(self,
                                      name,
                                      description=None,
                                      order=1,
                                      ...
                                      user_agents=None,
                                      match_agents=True):
        """Add new DLP policy from Configuration Master 10.5
        ...
        *Examples*
        | CM105 Offbox DLP Policies Add | three | description=Adding policy  |
        ...
        | CM105 Offbox DLP Policies Add | zero |
        """
    ...
    def cm105_offbox_dlp_policies_edit(self,
                                       name,
                                       new_name=None,
                                       description=None,
                                       order=1,
                                       ...
                                       user_agents=None,
                                       match_agents=True):
        """Edit DLP policy from Configuration Master 10.5
        ...
        *Examples*
        | CM105 Offbox DLP Policies Edit |
        ...
        | CM105 Offbox DLP Policies Edit | zero | protocols=others |
        """
    ...
    def cm105_offbox_dlp_policies_delete(self, name):
        """Delete DLP policy from Configuration Master 10.5
        ...
        *Examples*
        | CM105 Offbox DLP Policies Delete | three |
        """
        self.offbox_dlp_policies_delete(name)

    def cm105_offbox_dlp_policies_edit_destinations(self,
                                                    name,
                                                    scan_uploads=None,
                                                    url_categories=None,
                                                    settings_type=None):
