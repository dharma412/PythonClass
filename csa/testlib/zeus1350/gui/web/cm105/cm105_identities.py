# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm105/cm105_identities.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# $Author: sarukakk $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm105/cm105_identities.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1050.gui.manager.identities import Identities


class Cm105Identities(Identities):
    """
    Keywords library for WebUI page Web -> Configuration Master 10.5 -> Identities
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 10.5', 'Identification Profiles')

    def get_keyword_names(self):
        return [
            'cm105_identities_add_policy',
            'cm105_identities_edit_policy',
            'cm105_identities_delete_policy',
            'cm105_identities_enable_policy',
            'cm105_identities_disable_policy',
            'cm105_identities_is_enabled_policy',
            'cm105_identities_get_list',
        ]

    def cm105_identities_get_list(self):
        """
        ...
        | ${policies}= | CM105 Identities Get List |
    ...
    def cm105_identities_add_policy(self,
                                    name,
                                    description=None,
                                    order=None,
                                    subnet=None,
        ...
        """Adds new identity policy from Configuration Master 10.5
    ...
    def cm105_identities_edit_policy(self,
                                     name,
                                     new_name=None,
                                     description=None,
                                     order=None,
        ...
        """Edits existing identity policy from Configuration Master 10.5
        ...
        *Examples*
           ...
           | ... | subnet=1.2.3.0/24 |
           | Identities Edit policy | subnet | proxy_ports=105, 3128 |
        """
    ...
    def cm105_identities_delete_policy(self, name):
        """Deletes existing identity policy from Configuration Master 10.5

        *Parameters*
        - `name`: name of identity to be deleted.

        *Example*
        | CM105 Identities Delete Policy | myID |
        """
        self.identities_delete_policy(name)

    def cm105_identities_enable_policy(self, name):
        """Enables existing identity policy from Configuration Master 10.5

        *Parameters*
        - `name` name of identity to enable

        *Example*
        | CM105 Identities Disable Policy | myID |
        """

        self.identities_enable_policy(name)

    def cm105_identities_disable_policy(self, name):
        """Disables existing identity policy from Configuration Master 10.5
    ...
    def cm105_identities_is_enabled_policy(self, name):
        ...
        *Examples*
            | ${enabled}= | CM105 Identities Is Enabled Policy | myID |
        """
