#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm105/cm105_saas_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $ $Author: sarukakk $

from coeus1050.gui.manager.saas_policies import SaasPolicies


class Cm105SaasPolicies(SaasPolicies):
    """
    Keywords library for WebUI page Web -> Configuration Master 10.5 -> SaaS Policies
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 10.5', 'SaaS Policies')

    def get_keyword_names(self):
        return [
            'cm105_saas_policies_enable_saas_application',
            'cm105_saas_policies_disable_saas_application',
            'cm105_saas_policies_add_saas_application',
            'cm105_saas_policies_edit_saas_application',
            'cm105_saas_policies_delete_saas_application',
        ]

    def cm105_saas_policies_enable_saas_application(self, name):
        """
        Enable SaaS Application Authentication Policy from Configuration Master 10.5
        ...
        *Examples*
        | CM105 Saas Policies Enable Application | myAppName |
        """
        self.saas_policies_enable_saas_application(name)

    def cm105_saas_policies_disable_saas_application(self, name):
        """Disable SaaS Application Authentication Policy  from Configuration Master 10.5
        ...
        *Examples*
        | CM105 Saas Policies Disable Application | myAppName |
        """
        self.saas_policies_disable_saas_application(name)

    def cm105_saas_policies_add_saas_application(self,
                                                 name,
                                                 sp_metadata,
                                                 description=None,
                                                 auth_realm=None,
        ...
        """Add SaaS Application policy from Configuration Master 10.5
        ...
        *Examples*
        ...
        | CM105 Saas Policies Add Saas Application | myAppPolicy |
        | ... | ${METADATA} |
        ...
        | CM105 Saas Policies Add Saas Application | zero | ${METADATA} |
        | ... | test policy |
        """
    ...
    def cm105_saas_policies_edit_saas_application(self,
                                                  name,
                                                  sp_metadata,
                                                  description=None,
                                                  auth_realm=None,
        ...
        """Edit SaaS Application from Configuration Master 10.5
        ...
        *Exceptions*
        ...
        | CM105 Saas Policies Edit Saas Application | myAppPolicy |
        | ... | ${ALT_METADATA} |
        | ... | description=test saas app |
        | ... | auth_realm=test |
        | ... | saas_sso_authentication_prompt=Transparently sign in SaaS users |
    ...
    def cm105_saas_policies_delete_saas_application(self, name):
        """Delete SaaS Application from Configuration Master 10.5
        ...
        *Example*
        | CM105 Saas Policies Delete Saas Application | myAppName |
        """
