# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm105/cm105_edit_policy_order.py#1 $
...
class Cm105EditPolicyOrder(GuiCommon):
    """ Keywords for CM105 Edit Policy Order page where policies
    can be ordered by drag-and-drop.
    """

    def get_keyword_names(self):
        return [
            'cm105_edit_policy_order',
        ]
    ...
    def cm105_edit_policy_order(self, policy, submit, *items):
        ...
        *Parameters:*
        ...
        to be reordered. It is string containing name of menu item in CM105 menu.
        Requried.
        ...
        *Examples:*
        | CM105 Edit Policy Order | Identities | ${True} |
        | Policy 1 | Policy 2 |

        | CM105 Edit Policy Order | SOCKS Policies | ${True} |
        | Policy 1 |
        | Policy 2 |
        | Policy 3 |
        | Policy 4 |
