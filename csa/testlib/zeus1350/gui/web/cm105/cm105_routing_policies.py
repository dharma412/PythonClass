# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm105/cm105_routing_policies.py#1 $
# $DateTime: 2019/09/18 01:46:35 $
# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/gui/web/cm105/cm105_routing_policies.py#1 $ $DateTime: 2019/09/18 01:46:35 $  $Author: sarukakk $

from coeus1050.gui.manager.routing_policies import RoutingPolicies


class Cm105RoutingPolicies(RoutingPolicies):
    """
    Keywords for Web -> Configuration Master 10.5 -> Routing Policies
    """

    def _open_page(self):
        self._navigate_to('Web', 'Configuration Master 10.5', 'Routing Policies')

    def get_keyword_names(self):
        return [
            'cm105_routing_policies_add',
            'cm105_routing_policies_delete',
            'cm105_routing_policies_edit',
            'cm105_routing_policies_edit_destination',
            'cm105_routing_policies_get_list',
        ]

    def cm105_routing_policies_get_list(self):
        """
    ...
    def cm105_routing_policies_add(self,
                                   ...
                                   match_agents=True):
        """
        Add new routing policy from Configuration Master 10.5
        ...
        *Examples*
        | CM105 Routing Policies Add | three | description=Adding policy |
    ...
    def cm105_routing_policies_edit(self,
                                    name,
                                    description=None,
                                    order=None,
                                    identities=None,
                                    ...
                                    match_agents=True):
        """
        Edit routing policy from Configuration Master 10.5
        ...
        *Examples*
        | CM105 RoutingPolicies Edit | three | description=Editing policy |
        | ... | order=None | identities=Global Identity Policy |
        ...
        | CM105 RoutingPolicies Edit | zero | new description |
        """
    ...
    def cm105_routing_policies_delete(self, name):
        """
        Delete routing policy from Configuration Master 10.5

        *Parameters*
        - `name`: name of the policy to delete.

        *Example*
        | CM105 RoutingPolicies Delete | three |

        """
        self.routing_policies_delete(name)

    def cm105_routing_policies_edit_destination(self, name, proxy_group):
        """
        Setup the destination for given routing policy from Configuration Master 10.5
        ...
        *Examples*
        | CM105 RoutingPolicies Edit Destination| three | upstream2 |
        | CM105 RoutingPolicies Edit Destination| three | Use Global Policy Settings |
