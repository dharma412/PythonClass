# $Id: //prod/main/sarf_centos/testlib/zeus1350/cli/keywords/userconfig.py#1 $
...
class UserConfig(CliKeywordBase):
    ...
    def user_config_policy_account(self, autolock=DEFAULT, attempts=DEFAULT, lm_display=DEFAULT,
                                   lm_change=DEFAULT, lm_method=DEFAULT, lm_file=DEFAULT, lm_input=DEFAULT,
                                   pwd_exp=DEFAULT, pwd_exp_period=DEFAULT, pwd_rem_display=DEFAULT,
                                   pwd_rem_period=DEFAULT,
                                   pwd_reset=DEFAULT):
