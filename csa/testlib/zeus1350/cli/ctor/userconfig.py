#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1350/cli/ctor/userconfig.py#1 $
...
class userconfigExternal(clictorbase.IafCliConfiguratorBase):
    ...
    def devopssetup(self, input_dict=None, **kwargs):
        ...
        param_map['group_attribute'] = ['group attribute to be matched in saml', DEFAULT]
        param_map['sso_string'] = ['toggle string for Dev Ops SSO', DEFAULT]
        param_map.update(input_dict or kwargs)
