...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/admin/ldap.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class LDAP(GuiCommon):
    ...
    def ldap_test_query(self, profile_name,
        ...
        *External Authentication Queries*:
        ...
        | `Login` | LDAP User ID |
        | `Passphrase (for LDAP BIND)` | LDAP User Password |
        | `Group Membership Login` | Group Member User ID |
