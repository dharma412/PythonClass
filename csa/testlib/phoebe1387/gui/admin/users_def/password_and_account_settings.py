...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/admin/users_def/password_and_account_settings.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
PASSWORD_REPETITIVE_SEQUENTIAL_CHECKBOX = ('Repetitive Or Sequential Characters In Passwords',
                                          "//input[@id='password_no_rep_seq_chars']")
...
class PasswordAndAccountSettings(InputsOwner):
    ...
    def set(self, new_value):
        self._set_checkboxes(new_value,
                             ...
                             PASSWORD_NO_USERNAME_RESEMBLANCE_CHECKBOX,
                             PASSWORD_REPETITIVE_SEQUENTIAL_CHECKBOX,
