...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/manager/mail_policies_def/base_policy_entry_settings.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class BasePolicyEntrySettings(InputsOwner):
    ...
    def _open_advanced_entries(self):
        ...
        for link_idx in xrange(1, 1 + links_count):
            if self.gui._is_visible(ADVANCED_LINK_BY_IDX(link_idx)):
