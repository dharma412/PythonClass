...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/manager/mail_policies_def/policy_settings.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
ENABLE_HAPPY_CLICKERS_CHECKBOX = "//input[@id='Phishingrcpt']"
...
class BasePolicySettings(InputsOwner):
    ...
    ENABLE_HAPPY_CLICKERS_LIST = ('Enable Happy Clickers List', None)
    ...
    def set(self, new_value, add_user=None):
        ...
        if self.ENABLE_HAPPY_CLICKERS_LIST[0] in new_value:
            if new_value['Enable Happy Clickers List'] == 'yes':
                self.gui._select_checkbox(ENABLE_HAPPY_CLICKERS_CHECKBOX)
            else:
                self.gui._unselect_checkbox(ENABLE_HAPPY_CLICKERS_CHECKBOX)
