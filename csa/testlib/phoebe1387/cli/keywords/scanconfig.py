...
class scanconfig(CliKeywordBase):
    ...
    def scan_config_protected_attachment_config(self, *args):	
        ...
        *Returns:*	
        None	
        *Examples:*	
        | Scanconfig Encrypted Attachment Config        |	
        | ... | scan_password_protected_for_inbound_mails=Y   |	
        | ... | scan_password_protected_for_outbound_mails=Y  |	
        """	
        kwargs = self._convert_to_dict(args)	
        self._cli.scanconfig().protected_attachment_config(**kwargs)	
    ...
    def scan_config_protected_attachment_config_status(self):	
        ...
        *Returns:*	
        A dictionary containing the status of password protected attachments decryption settings.	
            Keys:   Scan for password protected file for Inbound mails	
                    Scan for password protected file for Outbound mails	
        *Examples:*	
        | ${status}=                | Scanconfig Encrypted Attachment Config Status                                   |	
        | ${inbound}=               | Get From Dictionary | Scan for password protected file for Inbound mails  |	
        | Should Be Equal As String | ${inbound}          | enabled                                                   |	
        | ${outbound}=              | Get From Dictionary | Scan for password protected file for Outbound mails |	
        | Should Be Equal As String | ${outbound}         | disabled                                                  |	
        """	
        return self._cli.scanconfig().protected_attachment_config_status()
