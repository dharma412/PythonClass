#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/listenerconfig.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class listenerconfig(ccb.IafCliConfiguratorBase):
 ...
 = ['Enter the maximum', NO_DEFAULT]
        ...
        param_map['modify_mrph_banner'] = ['Would you like to specify a ' \
                                              ...
                                              'response?', NO]
        param_map['enable_mrpes'] = ['enable rate limiting per envelope sender?', DEFAULT]
        param_map['enable_dhap'] = ['Do you want to enable '
                                     'Directory Harvest Attack '
                                     'Prevention per host?', NO]
        ...
        param_map['virus_check'] = ['Would you like to enable ' \
                                              'anti-virus scanning?', \
                                               DEFAULT]
        param_map['sdr_check'] = ['Would you like to enable ' \
                                              'Sender Domain Reputation scanning?', \
                                               DEFAULT]
        param_map['virus_outbreak_filters'] = ['Would you like to enable ' \
                                                'Virus Outbreak Filters?', \
                                                DEFAULT]
        param_map['advanced_phishing_protection'] = ['Would you like to enable ' \
                                                     'Advanced Phishing Protection scanning?', \
                                                     DEFAULT] 
        param_map['graymail_detection'] = ['Would you like to enable ' \
                                           'Graymail scanning?', \
                                            DEFAULT]
        param_map['content_filters'] = ['Would you like to enable ' \
                                        'Content Filters?', \
                                        DEFAULT]
        param_map['message_filters'] = ['Would you like to enable ' \
                                        'Message Filters?', \
                                        DEFAULT]
        ...
        param_map['dk_vrfy'] = ['Would you like to enable '
        ...
        param_map['spf_change'] = ['Would you like to change SPF/SIDF settings?', DEFAULT]
        param_map['dmarc_vrfy'] = ['Would you like to enable DMARC verification?', DEFAULT]
...
class listenerconfigEdit(ccb.IafCliConfiguratorBase):
    ...
    def certificate(self, name):
        ...
        self._expect(['Do you really wish to use the', '>'], timeout=15)
...
class EditHatParameters(ccb.IafCliConfiguratorBase):
    ...
    def _edit_hat_params(self, hat_params, input_dict=None):
        ...
        param_map3['virus_check'] = ['Would you like to enable ' \
                                              'anti-virus scanning?', \
                                               DEFAULT]
        param_map3['sdr_check'] = ['Would you like to enable ' \
                                              'Sender Domain Reputation scanning', \
                                               DEFAULT]
        param_map3['virus_outbreak_filter'] = ['Would you like to enable ' \
                                               'Outbreak Filters?', \
                                               DEFAULT]
        param_map3['advanced_phishing_protection'] = ['Would you like to enable ' \
                                                      'Advanced Phishing Protection scanning?', \
                                                      DEFAULT]
        param_map3['graymail_detection'] = ['Would you like to enable ' \
                                           'Graymail scanning?', \
                                           DEFAULT]
        param_map3['content_filters'] = ['Would you like to enable ' \
                                         'Content Filters?', \
                                         DEFAULT]
        param_map3['message_filters'] = ['Would you like to enable ' \
                                          'Message Filters?', \
                                          DEFAULT]
        ...
        param_map3['smime_signature'] = ['Select the appropriate operation for the S/MIME signature processing', DEFAULT]
