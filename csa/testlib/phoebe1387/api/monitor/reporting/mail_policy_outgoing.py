...
class MailPolicyOutgoing(EsaApi):
    def get_keyword_names(self):
        return [
            'reporting_mail_policy_outgoing',
        ]

    def reporting_mail_policy_outgoing(self, category='', start_date=None, end_date=None, top=None, query_type=None, offset=None, limit=None):
        """
        *ESA Reporting API Keyword* to send API queries to
        _mail_policy_outgoing_ endpoint
        ...
        *Examples*
            | ${response}= | Reporting Mail Policy Outgoing      |
        ...
        url = self.construct_reporting_api_url(
            'mail_policy_outgoing', category, params)
