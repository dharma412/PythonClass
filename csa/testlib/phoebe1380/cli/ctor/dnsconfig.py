#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/dnsconfig.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class dnsconfig(ccb.IafCliConfiguratorBase):
    ...
    def edit(self,
        ...
        if self.root_servers:
            ...
            self._query_response(which_server) # hack: hard code for now. needs fixing. which_server?
