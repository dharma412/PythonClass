#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/alertconfig.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class alertconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def setup(self, input_dict=None, **kwargs):
        ...
        param_map['tls_support'] = \
        ['Do you want to enable TLS support to send alert messages', DEFAULT]
        param_map.update(input_dict or kwargs)
