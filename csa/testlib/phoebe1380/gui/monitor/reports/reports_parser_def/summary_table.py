...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/monitor/reports/reports_parser_def/summary_table.py#1 $
...
class SummaryTable(BaseReportingTable):
    ...
    def get_available_table_names(cls):
        return ['Incoming Mail Summary', 'Outgoing Mail Summary',
		        ...
		        'Summary of Messages Attempted to be Forwarded to Cisco Advanced Phishing Protection Cloud Service',
                'Summary of Messages handled by SDR']
