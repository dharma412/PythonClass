...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/admin/users.py#1 $
...
class Users(GuiCommon):
    ...
    def users_edit_account_password_restrictions(self, restrictions={}):
        ...
        *Parameters:*
        ...
        | `Repetitive Or Sequential Characters In Passwords` | whether to Must not contain
        three or more repetitive or sequential characters. Either ${True} or ${False} |
        ...
        *Examples:*
        ...
        | ... | Repetitive Or Sequential Characters In Passwords | ${True} |
