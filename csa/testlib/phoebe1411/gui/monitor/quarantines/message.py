#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/monitor/quarantines/message.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class QuarantinedMessage(QuarantinesCommon):
    ...
    def quarantines_message_release(self,
        ...
        *Examples*:
        ...
        self._select_quarantine(name=name, all=from_all)
        if delay:
            self.select_from_list_by_label(MESSAGE_DETAILS_MESSAGE_ACTION_LIST,
                delay)
        else:
            self.select_from_list_by_label\
...
class SpamQuarantinedMessage(QuarantinedMessage):
    ...
    def quarantines_spam_message_delete(self):
        ...
        *Examples*:
        ...
        if self._is_element_present("//*[@id='message_action1']"):
            self.select_from_list_by_label("//*[@id='message_action1']", '-- Delete')
    ...
    def quarantines_spam_message_release(self):
        ...
        *Examples*:
        ...
        """
        if self._is_element_present("//*[@id='message_action1']"):
            self.select_from_list_by_label("//*[@id='message_action1']", '-- Release')
            self.click_button("//*[@id='process_message']", "don't wait")
