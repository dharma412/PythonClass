...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/admin/user_roles_def/role_settings.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
LOGSUBSCRIPTION_RADIO_GROUP = ('Log Subscription',
                {'No access': "//input[@id='lognone']",
                                 'Log Subscription Access': "//input[@id='logunrestricted']"})
