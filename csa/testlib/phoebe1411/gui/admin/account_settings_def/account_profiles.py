#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/admin/account_settings_def/account_profiles.py#1 $
...
CLIENT_CREDENTIALS = ('Client credentials',
                      { 'Client Secret': "//input[@id='client_credentials_secret_id']",
                        'Client Certificate': "//input[@id='client_credentials_certificate_id']"} )
CLIENT_SECRET = ('Client Secret', "//input[@id='client_secret']")
