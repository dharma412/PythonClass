...
class SSLConfig(GuiCommon):
    ...
    def ssl_configuration_settings_edit(self, settings):
        ...
        *Parameters:*
        ...
        | Other TLS Client Services        | whether to enable TLS v1 for other TLS clients         |
        | Peer Certificate FQDN Validation | whether to enable FQDN validation for peer certifiates |
        | Peer Certificate X509 Validation | whether to enable X509 validation for peer certifiates |
        ...
        *Examples:*
        ...
        | END |
        | Set To Dictionary | ${settings} | Other TLS Client Services        | ${False} |
        | Set To Dictionary | ${settings} | Peer Certificate FQDN Validation | ${True}  |
        | Set To Dictionary | ${settings} | Peer Certificate X509 Validation | ${True}  |
        | SSL Configuration Settings Edit | ${settings} |
        """
