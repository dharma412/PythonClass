...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/manager/content_filters_def/properties_containers.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
FED_ACTION = "(//a[contains(text(),'Forged Email Detection')])[2]"
FED_CONDITION = "//a[contains(text(),'Forged Email Detection')]"
...
class PropertiesContainer(object):
    ...
    def _select(self, name):
        ...
        *Exceptions:*
        ...
        elif name == "Forged Email Detection Action":
            self.gui.click_button(FED_ACTION, "don't wait")
        elif name == "Forged Email Detection Condition":
            self.gui.click_button(FED_CONDITION, "don't wait")
        else:
