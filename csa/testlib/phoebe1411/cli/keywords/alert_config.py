#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/keywords/alert_config.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class AlertConfig(CliKeywordBase):
    ...
    def alert_config_setup(self,
        ...
        - `tls_support`: To enable TLS support to deliver alerts.  Default: 'Yes'.
        ...
        if tls_support:
            kwargs['tls_support'] = tls_support
