#!/usr/bin/env python
#$Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/keywords/licensesmart.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class licensesmart(CliKeywordBase):
    ...
    def license_smart_enable(self, enable_sl_on_all_machines_in_cluster='N'):
        ...
        *Example:*
        ...
        | License Smart Enable | enable_sl_on_all_machines_in_cluster=Y |
        | License Smart Enable | enable_sl_on_all_machines_in_cluster=N |
        """

        self._cli.licensesmart().enable(enable_sl_on_all_machines_in_cluster)
    ...
    def license_smart_register(self, *args):
        ...
        *Parameters:*
        ...
        - 'register_sl_on_all_machines_in_cluster': Registers smart license software
                                                    on all the machines in a cluster.
        *Return:*
        None
        ...
        *Examples:*
        ...
        []> register
         ...
         | ... | token=${token}                           |
         | ... | reregister=yes                           |
         | ... | register_sl_on_all_machines_in_cluster=Y |
