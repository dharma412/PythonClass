#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/keywords/delete_recipients.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class DeleteRecipients(CliKeywordBase):
    ...
    def deleterecipients_all(self, confirm='yes'):
        ...
        *Parameters*:
        - `confirm`: whether or not delete messages.
    ...
    def deleterecipients_address(self, address, confirm='yes'):
        ...
        *Example*:
        ...
        return self._cli.deleterecipients(how='sender', sender=address,
                                                                sure=confirm)
