...
class sslconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def other_client_tls(self, input_dict=None, **kwargs):
        self._query_response('OTHER_CLIENT_TLSV10')
    ...
    def peer_cert_fqdn(self, input_dict=None, **kwargs):
    ...
    def peer_cert_x509(self, input_dict=None, **kwargs):
        self._query_response('PEER_CERT_X509')
        if kwargs['enable'] == 'True':
            self._query_response('ENABLE')
        else:
            self._query_response('DISABLE')
