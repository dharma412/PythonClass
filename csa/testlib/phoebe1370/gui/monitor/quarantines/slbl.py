#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/monitor/quarantines/slbl.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class Slbl(QuarantinesCommon):
    ...
    def quarantines_slbl_edit_settings(self, action=None, max_entries=None):
        ...
        *Exceptions*:
        ...
        self.select_from_list_by_label(SLBL_BLOCK_LIST_ACTION, action)
