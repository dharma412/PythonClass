...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/services/antispam.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class Antispam(GuiCommon):
    ...
    @check_antispam_feature(True)
    def antispam_edit_settings(self, provider, **kwargs):
