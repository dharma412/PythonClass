...
class certconfig(CliKeywordBase):
    ...
    def certconfig_certificate_new(self, *args):
        ...
        *Parameters*:
        ...
        - `common_name`: Specify common name
    ...
    def certconfig_certificate_import(self, cert_name, filename, password):
        """
        ...
        *Examples*:
        ...
        try:
            self._cli.certconfig().certificate().\
              import_cert(cert_name, filename, password)
        except Exception,e:
            self._cli.restart()
            traceback.print_exc()
            raise e
    ...
    def certconfig_certificate_paste(self, name, cert, key,
          cert_overwrite=False, inter_cert_list=None, remove_cert_list=None):
        """
    ...
    def certconfig_certauthority_custom_import(self, filename):
        """
