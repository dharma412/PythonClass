#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/keywords/ether_config.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class EtherConfig(CliKeywordBase):
    ...
    def get_ether_config_media(self):
        """Capture output of Ethernet media settings.

        Examples:
        | Get Ether Config Media |

        """
        return self._cli.etherconfig().media_output()
