#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/coeus1201/cli/ctor/ntpconfig.py#1 $
...
class ntpconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def routingtable(self, table='Data'):
        self.level = 1
    ...
    def get_ntp_info(self):
        """ Return dictionary with currently configured NTPs.  """
