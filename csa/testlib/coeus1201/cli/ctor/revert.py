#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/coeus1201/cli/ctor/revert.py#1 $ $DateTime: 2019/08/14 09:58:47 $ $Author: uvelayut $
...
class revert(clictorbase.IafCliConfiguratorBase):
    ...
    def __call__(self, input_dict=None, **kwargs):
        ...
        param_map['version'] = ['select an AsyncOS version', DEFAULT, True]
        param_map['continue'] = ['Do you want to continue', NO]
        param_map['confirm'] = ['sure you want to continue', NO]
        param_map['wait_for_data'] = ['data to be synced', DEFAULT]

        param_map.update(input_dict or kwargs)

        self._process_input(param_map, do_restart=False, timeout=120)
