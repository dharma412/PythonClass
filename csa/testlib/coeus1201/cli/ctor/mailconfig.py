#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/coeus1201/cli/ctor/mailconfig.py#1 $
...
class mailconfig(clictorbase.IafCliConfiguratorBase):
    def __call__(self, email='test@test.qa', save_pw=YES):
        self._sess.writeln('mailconfig')
        self._query_response(email)
        self._query_response(save_pw, timeout=10)
