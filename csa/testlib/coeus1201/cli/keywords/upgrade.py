#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/coeus1201/cli/keywords/upgrade.py#1 $
...
class Upgrade(CliKeywordBase):
    ...
    def upgrade_downloadinstall(self,
        ...
        *Parameters:*
        ...
        - `version`: version to upgrade WSA to. Should be in format N.X.Y-ZZZ
    ...
    def upgrade_download(self, version=None, cancel='', delete=''):
        ...
        *Parameters:*
        ...
        - `version`: version of WSA to download . Should be in format N.X.Y-ZZZ
