##!/usr/bin/env python
# -*- coding: latin-1 -*-
# $Id: //prod/main/sarf_centos/testlib/coeus1201/gui/admin/system_upgrade.py#1 $
...
class SystemUpgrade(GuiCommon):
    ...
    def _open_page(self):
        ...
        self._navigate_to('System Administration', 'System Upgrade')
    ...
    def _click_download_install_button(self):
        ...
        upgrade_options_button = "//input[@id='upgrade_operation_upgrade']"
        self.click_button(upgrade_options_button)
    ...
    def _click_proceed_button_download(self):
        ...
        proceed_button = "xpath=//input[@type='submit']"
        self.click_button(proceed_button)
