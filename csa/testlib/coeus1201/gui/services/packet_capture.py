...
class PacketCapture(GuiCommon):
    def get_keyword_names(self):
        return ['packet_capture_start_gui',
                'packet_capture_stop_gui',
    ...
    def _open_page(self):
        self._navigate_to('Support and Help', 'Packet Capture')
    ...
    def _select_captured_files(self, filenames):
        ...
        _all = 'all'
        _top = 'top'
        _filename_option = lambda f: 'regexp:%s.*' % f
    ...
    def packet_capture_start_gui(self):
        """Start a packet capture.

        *Examples*:
        | Packet Capture Start Gui|
    ...
    def packet_capture_stop_gui(self):
        """Stop packet capture.

        *Examples*:
        | Packet Capture Stop |
        | ${cap_file} = | Packet Capture Stop Gui |
    ...
    def packet_capture_edit_settings(self,filters=None):
        """
