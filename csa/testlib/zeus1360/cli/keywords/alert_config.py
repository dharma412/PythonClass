#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1360/cli/keywords/alert_config.py#1 $ $DateTime: 2020/03/05 19:45:32 $ $Author: sarukakk $
...
class AlertConfig(CliKeywordBase):
    ...
    def alert_config_new(self,
        ...
        - `severity_levels`: Severity Levels. Specify level numbers
        ...
        self._cli.alertconfig().new(address, alert_classes, severity_levels)

    def alert_config_edit(self,
                          address,
                          alert_class,
                          severity_levels=''):
        ...
        self._cli.alertconfig().edit(address, alert_class, severity_levels)
    ...
    def alert_config_setup(self,
        ...
        - `max_alerts`: Maximum number of alerts to save. Default value: 50.
