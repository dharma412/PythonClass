#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1360/gui/management/administration/ssw.py#1 $
...
from zeus1361.cli.keywords.reset_config import ResetConfig
from zeus1361.cli.keywords.suspend import Suspend
from common.cli.clicommon import CliKeywordBase
from zeus1361.cli.keywords.passwd import Passwd
...
class SystemSetupWizard(GuiCommon):
    ...
    def _process_timezone_settings(self, region, country, timezone):
        ...
        self.select_from_list_by_label(region_option_combo, region)
        self.select_from_list_by_label(country_option_combo, country)
        self.select_from_list_by_label(timezone_option_combo, timezone)
