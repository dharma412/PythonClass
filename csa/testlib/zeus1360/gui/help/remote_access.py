#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1360/gui/help/remote_access.py#1 $ $DateTime: 2020/03/05 19:45:32 $ $Author: sarukakk $
...
class RemoteAccess(GuiCommon):
    ...
    def remote_access_enable(self, password="default_pass",
