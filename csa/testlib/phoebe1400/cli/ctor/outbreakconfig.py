#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/outbreakconfig.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class outbreakconfig(clictorbase.IafCliConfiguratorBase):
    ...
    class RequireActivationError(IafCliError): pass
    class LicenseAgreementError(IafCliError): pass
    class InvalidArgumentError(IafCliError): pass
