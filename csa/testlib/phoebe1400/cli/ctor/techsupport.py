#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/techsupport.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class techsupport(ccb.IafCliConfiguratorBase):
	...
	self._query_response('TUNNEL')
        if self._expect('Starting a tunnel on a virtual appliance without a license'):
