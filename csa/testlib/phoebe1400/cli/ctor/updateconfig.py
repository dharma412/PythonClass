# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/updateconfig.py#1 $
...
class updateconfig(ccb.IafCliConfiguratorBase):
    ...
    def dynamichost(self,input_dict=None, **kwargs):
        param_map = ccb.IafCliParamMap(end_of_command='Choose the operation')
        param_map['confirm_switch_to_cluster'] = ['Would you like to switch to', DEFAULT]
        param_map['choose_a_machine'] = ['Choose a machine', DEFAULT, 1]
    ...
    def validate_certificates(self,input_dict=None, **kwargs):
        param_map = ccb.IafCliParamMap(end_of_command='Choose the operation')
        param_map['confirm_switch_to_cluster'] = ['restricted to run in machine mode', DEFAULT]
