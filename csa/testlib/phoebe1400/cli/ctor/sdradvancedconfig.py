#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/sdradvancedconfig.py#1 $
...
class sdradvancedconfig(clictorbase.IafCliConfiguratorBase):
    ...
    def __call__(self, input_dict=None, **kwargs):
        ...
        param_map['sdr_match_exceptions_envelope_from_domain'] = ['Do you want exception list matches based on envelope-from domain', DEFAULT]
