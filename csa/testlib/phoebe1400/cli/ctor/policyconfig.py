#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/policyconfig.py#2 $
...
class policyconfigMain(clictorbase.IafCliConfiguratorBase):
    ...
    class PolicyDeleteError(IafCliError): pass
    class PolicyDeleteAttemptError(IafCliError): pass
    class PolicyMoveError(IafCliError): pass
    class PolicyMemberEmailError(IafCliError): pass
    class AsciiCharactersError(IafCliError): pass
    class PolicyRecipientNameError(IafCliError): pass
    class MachineModeError(IafCliError): pass
    ...
    def new(self, input_dict=None, **kwargs):
        ...
        param_map['enable_csa_happy_clickers'] = ['Would you like to enable Repeat Clickers List for this policy', NO]
        ...
        param_map['advanced_phishing_protection_enable'] = ['enable APP for this policy', YES]
        if kwargs.has_key('advanced_phishing_protection_enable') \
           and is_yes(kwargs['advanced_phishing_protection_enable']):
            param_map['advanced_phishing_protection_use_default_table'] = ['policy table default', YES]
            param_map['advanced_phishing_protection_enable_email_forwarding'] = \
                    ['Do you want to enable email forwarding', DEFAULT]
...
class policyconfigEdit(clictorbase.IafCliConfiguratorBase):
    ...
    class PolicyDeleteError(IafCliError): pass
    class PolicyMemberNameError(IafCliError): pass
    class PolicyMemberCreateError(IafCliError): pass
    class PolicyMemberDeleteError(IafCliError): pass
    class PolicyMemberEmailError(IafCliError): pass
    class AsciiCharactersError(IafCliError): pass
    class PolicyRecipientNameError(IafCliError): pass
    ...
    def advancedphishing(self):
        self._query_response('ADVANCEDPHISHING')
        return policyconfigEditAdvancedPhishing(self._get_sess())
...
class policyconfigEditAntispam(clictorbase.IafCliConfiguratorBase):
    ...
    class AntispamHeaderError(IafCliError): pass
    class AntispamLevelError(IafCliError): pass
    class FilterExistError(IafCliError): pass
    class HeaderCharacterError(IafCliError): pass
    class HeaderStringsError(IafCliError): pass
    class HeaderLengthError(IafCliError): pass
    class InvalidCharacterError(IafCliError): pass
...
class policyconfigEditAntivirus(clictorbase.IafCliConfiguratorBase):
    ...
    class DuplicateEntriesError(IafCliError): pass
    class HeaderCharacterError(IafCliError): pass
    class HeaderStringsError(IafCliError): pass
    class HeaderLengthError(IafCliError): pass
    class InvalidCharacterError(IafCliError): pass
...
class policyconfigEditAdvancedmalware(clictorbase.IafCliConfiguratorBase):
    ...
    class AdvancedmalwareHeaderError(IafCliError): pass
    class AdvancedmalwareLevelError(IafCliError): pass
    class FilterExistError(IafCliError): pass
    class HeaderCharacterError(IafCliError): pass
    class HeaderStringsError(IafCliError): pass
    class HeaderLengthError(IafCliError): pass
    ...
    def get_advancedmalware_param_map(self, advancedmalware_dict=None, status=DEFAULT, **kwargs):
        ...
        param_map['edit_action']                 = ['to edit the actions for Unscannable Message', DEFAULT]
        param_map['edit_action_message_error']   = ['to edit the actions for Unscannable Message due to message errors', DEFAULT]
        param_map['edit_action_rate_limit_hit']  = ['to edit the actions for Unscannable Message due to rate limit hit', DEFAULT]
        param_map['edit_action_amp_unavailable'] = ['to edit the actions for Unscannable Message due to AMP Service not available', DEFAULT]
        ...
        param_map['edit_action_file_analysis']   = ['to edit the actions for Messages with File Analysis Pending', DEFAULT]
        param_map['edit_action_message_errors']  = ['to edit the actions for Unscannable Message due to message errors', DEFAULT]
        param_map['edit_action_AMP_service']     = ['to edit the actions for Unscannable Message due to AMP Service not available', DEFAULT]
        ...
        param_map['analysis_drop_attachment']    = ['drop attachments with the file analysis verdict still pending', DEFAULT]
...
class policyconfigEditVofEdit(clictorbase.IafCliConfiguratorBase):
    ...
    class FileExtensionDeleteError(IafCliError): pass
    class FileExtensionCreateError(IafCliError): pass
    class FileExtensionInsertError(IafCliError): pass
    class ExtensionFormatError(IafCliError): pass
...
class policyconfigEditFilters(clictorbase.IafCliConfiguratorBase):
    ...
    class FilterEnableError(IafCliError): pass
    class FilterCountError(IafCliError): pass
...
class policyconfigFilters(clictorbase.IafCliConfiguratorBase):
    ...
    class FilterTargetExistError(IafCliError): pass
    class FilterMovePositionError(IafCliError): pass
    class FilterMoveSequenceError(IafCliError): pass
    class FilterExistError(IafCliError): pass
...
class policyconfigFiltersEdit(clictorbase.IafCliConfiguratorBase):
    ...
    class FilterEnableError(IafCliError): pass
    class FilterNameError(IafCliError): pass
    class FilterCreateError(IafCliError): pass
    class FilterActionAddError(IafCliError): pass
    class FilterEmailError(IafCliError): pass
    class FilterExistError(IafCliError): pass
    class FilterActionMimeError(IafCliError): pass
    class FilterRegularExpressionError(IafCliError): pass
    class FilterFingerprintsError(IafCliError): pass
    class FilterHostnameError(IafCliError): pass
    class FilterLdapGroupError(IafCliError): pass
    class FilterHeaderError(IafCliError): pass
    class FilterConditionError(IafCliError): pass
    class FilterDuplicateNameError(IafCliError): pass
    class FilterParameterError(IafCliError): pass
    ...
    def get_filter_add_param_map(self, filter_dict=None, save=False, **kwargs):
        ...
        param_map['file_hash_list_index']   = ['Enter the index', REQUIRED]
        ...
        param_map['url_in_attachments'] = ['Do you want this filter to scan for URLs within the message attachments', DEFAULT]
        ...
        param_map['sdr_external_threatfeed_source'] = ['Select the required External Threat Feed sources', DEFAULT, True]
        param_map['sdr_mail_from_header'] = ['Do you want to check for the sender domain based on the "mail-from" header', DEFAULT]
        param_map['sdr_from_header'] = ['Do you want to check for the sender domain based on the "from" header', DEFAULT]
        param_map['sdr_reply_to_header'] = ['Do you want to check for the sender domain based on the "reply-to" header', DEFAULT]
        param_map['sdr_other_header'] = ['Do you want to check for the sender domain based on any other header', DEFAULT]
        ...
        param_map['sender_domain_reputation_verdict'] = ['Choose a range of sender domain reputation verdicts', REQUIRED]
        ...
        param_map['sender_domain_reputation_age_condition'] = ['Choose the condition to filter the messages based on the sender domain age', DEFAULT]
        param_map['sender_domain_reputation_configure_domain_exception'] = ['Do you want to select a Domain exception list', DEFAULT]
        param_map['sender_domain_reputation_domain_exception_list'] = ['Select a Domain Exception list', DEFAULT, True]
        param_map['safe_print_action'] = ['Choose the safeprint action from the list', DEFAULT, True]
        param_map['safe_print_strip_unscannable_attachments'] = ['Do you want to strip unscannable attachments', DEFAULT]
...
class policyconfigEditGraymail(clictorbase.IafCliConfiguratorBase):
    ...
    class GraymailHeaderError(IafCliError): pass
    class GraymailLevelError(IafCliError): pass
    class FilterExistError(IafCliError): pass
    class HeaderCharacterError(IafCliError): pass
    class HeaderStringsError(IafCliError): pass
    class HeaderLengthError(IafCliError): pass
    ...
    def get_social_networking_email_param_map(self, social_networking_email_dict=None,
        ...
        if policy_type.lower()=='incoming':
            param_map = IafCliParamMap(end_of_command='enable actions')
            param_map['enable_social_networking_email_actions'] = ['messages identified as Social Networking Email', DEFAULT]
        else:
        ...
        param_map['social_networking_mail_action'] = ['to do with messages identified as Social Networking', DEFAULT, True]
        param_map['social_networking_mail_to_external_quarantine'] = ['Social Networking Email to an external quarantine', DEFAULT]
        param_map['social_networking_mail_external_host'] = ['enter the host to send Social Networking', status]
        param_map['social_networking_mail_archive_messages'] = ['archive messages identified as Social Networking', DEFAULT]
...
class policyconfigEditAdvancedPhishing(clictorbase.IafCliConfiguratorBase):
    """policyconfig->Edit->AdvancedPhishing"""

    class AdvancedPhishingProtectionParamError(IafCliError): pass
    
    new_line = 2
            
    def default(self):
        self._query_response('DEFAULT')
        self._to_the_top(self.new_line)
    ...
    def enable(self, **kwargs):
        self._query_response('ENABLE')
        if kwargs:
            if 'enable_email_forwarding' not in kwargs:
                raise self.AdvancedPhishingProtectionParamError('Mandatory parameter ' \
                    '"enable_email_forwarding" missing. Please pass Y or N '
                    'value for this parameter')
            self._query_response(kwargs['enable_email_forwarding'])
        else:
            self._query_response(DEFAULT)
        self._to_the_top(self.new_line)
