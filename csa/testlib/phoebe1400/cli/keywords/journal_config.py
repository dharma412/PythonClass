...
class JournalConfig(CliKeywordBase):
    ...
    def journal_config_enable(self, **kwargs):
        ...
        allow_traffic = kwargs.get('allow-traffic', 'external-inbound')

        return self._cli.journalconfig.enable(routing_mode, mailbox, journal_mailto, non_journal_action, allow_traffic)
