...
ARROW_CLOSED_SOCIAL_NETWORKING = "(//*[@id='arrow_closed'])[2]"
ARROW_CLOSED_BULK_EMAIL = "(//*[@id='arrow_closed'])[3]"
...
class GraymailEntrySettings(BasePolicyEntrySettings):
    ...
    def set(self, new_value):
        ...
        self.gui.click_element(ARROW_CLOSED_BULK_EMAIL, "don't wait")
        self.gui.click_element(ARROW_CLOSED_SOCIAL_NETWORKING, "don't wait")
