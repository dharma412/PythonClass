...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/manager/mail_flow_policies_def/policy_edit_controllers.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author
...
from policy_properties import Name, ConnectionBehavior, MaxMsgsPerCon, \
  ...
  SpamDetection, VirusProtection, TLS, AMPDetection, SenderDomainReputationVerification, \
  ...
  DMARCVerification, DMARCVerificationProfile, DMARCFeedbackReports, AdvancedPhishingProtection, \
  ContentFilters, MessageFilters,  VirusOutbreakFilters, GraymailDetection, RadioGroupProperty
...
class CustomPolicyEdit(PolicyEditContainer):
    def get_owned_properties(self):
        return (# Name
                ...
                SenderDomainReputationVerification,
                # Virus Outbreak Filters
                VirusOutbreakFilters,
                # Advanced Phishing Protection
                AdvancedPhishingProtection,
                # Graymail Detection
                GraymailDetection,
                # Content Filters
                ContentFilters,
