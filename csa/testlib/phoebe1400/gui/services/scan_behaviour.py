...
class ScanBehaviour(GuiCommon):
    def get_keyword_names(self):
        return ['scan_behaviour_edit_settings',
	        'scan_behaviour_get_global_settings',
    ...
    def scan_behaviour_edit_settings(self, settings):
        ...
        *Parameters:*
        ...
        'Enabled' or 'Disabled' |
	| Decrypt Inbound Password Protected Attachments | Enable Decryption of Password-protected	
        Attachments for Inbound Mail Traffic. Either 'Yes' or 'No' |	
        | Decrypt Outbound Password Protected Attachments | Enable Decryption of Password-protected	
        Attachments for Outbound Mail Traffic. Either 'Yes' or 'No' |
        | Probable Password for Analysis | Provide password for extracting files.
        Provide a list of value with format as - <action>|<value1><value2>.
        Accepted <action> values are - add, edit-password, edit-priority, delete.
        Accepted combinations - 
            add|<password_priority>|<password_value>
            edit-password|<old_password>|<new_password>
            edit-priority|<old_priority>|<new_priority>
            delete|<password>|
        | Enable Actions for Unscannable Messages due to decoding errors |	
        Ether 'Yes' or 'No'. Default: 'No' |	
        | Unscannable Decoding Error Action | Action to be applied on the messages	
        unscannable due to decoding error. Allowed values are: 'Devliver As Is' or	
        'Quarantine'. Default: 'Deliver As Is' |	
        | Unscannable Decoding Error Send To Quarnatine | Valid when action is	
        set to 'Quarantine' for above parameter. Default: 'Policy' |	
        | Unscannable Decoding Error Modify Message Subject | Message subject modifcation	
        action. Allowed values: 'No', 'Prepend' & 'Append'. Default: 'No' |	
        | Unscannable Decoding Error Message Subject | Valid when above parameter	
        is not set to 'No'. Default: '[WARNING: DECODE ERRORS OBSERVED DURING URL REWRITE]' |	
        | Unscannable Decoding Error Add Custom Header | Add a custom header to	
        message. Allowed values: 'Yes' or 'No'. Default: 'No' |	
        | Unscannable Decoding Error Custom Header Name | Valid when the above paramater	
        is set to 'Yes'. Default: Empty |	
        | Unscannable Decoding Error Custom Header Value | Valid when above parameter	
        is set to 'Yes'. Default: Empty |	
        | Unscannable Decoding Error Modify Recipient | Valid only when action is	
        set to 'Deliver As Is' | Allowed values: 'Yes' or 'No'. Default: 'No' |	
        | Unscannable Decoding Error Recipient Address | Valid when above parameter	
        is set to 'Yes'. Default: Empty |	
        | Unscannable Decoding Error Send To Alternate Destination Host | Valid	
        only when action is set to 'Deliver As Is' | Allowed values: 'Yes' or	
        'No'. Default: 'No' |	
        | Unscannable Decoding Error Alternate Destination Host | Valid when above	
        parameter is set to 'Yes'. Default: Empty |	
        | Enable Actions for Unscannable Messages due to Extraction Failures |	
        Ether 'Yes' or 'No'. Default: 'No' |	
        | Unscannable Extraction Failures Action | Action to be applied on the messages	
        unscannable due to decoding error. Allowed values are: 'Devliver As Is' or	
        'Quarantine'. Default: 'Deliver As Is' |	
        | Unscannable Extraction Failures Send To Quarnatine | Valid when action is	
        set to 'Quarantine' for above parameter. Default: 'Policy' |	
        | Unscannable Extraction Failures Modify Message Subject | Message subject modifcation	
        action. Allowed values: 'No', 'Prepend' & 'Append'. Default: 'No' |	
        | Unscannable Extraction Failures Message Subject | Valid when above parameter	
        is not set to 'No'. Default: '[WARNING: UNSCANNABLE EXTRACTION FAILED]' |	
        | Unscannable Extraction Failures Add Custom Header | Add a custom header to	
        message. Allowed values: 'Yes' or 'No'. Default: 'No' |	
        | Unscannable Extraction Failures Custom Header Name | Valid when the above paramater	
        is set to 'Yes'. Default: Empty |	
        | Unscannable Extraction Failures Custom Header Value | Valid when above parameter	
        is set to 'Yes'. Default: Empty |	
        | Unscannable Extraction Failures Modify Recipient | Valid only when action is	
        set to 'Deliver As Is' | Allowed values: 'Yes' or 'No'. Default: 'No' |	
        | Unscannable Extraction Failures Recipient Address | Valid when above parameter	
        is set to 'Yes'. Default: Empty |	
        | Unscannable Extraction Failures Send To Alternate Destination Host | Valid	
        only when action is set to 'Deliver As Is' | Allowed values: 'Yes' or	
        'No'. Default: 'No' |	
        | Unscannable Extraction Failures Alternate Destination Host | Valid when above	
        parameter is set to 'Yes'. Default: Empty |	
        | Enable Actions for Unscannable Messages due to RFC Violations |	
        Ether 'Yes' or 'No'. Default: 'No' |	
        | Unscannable RFC Violations Action | Action to be applied on the messages	
        unscannable due to decoding error. Allowed values are: 'Devliver As Is' or	
        'Quarantine'. Default: 'Deliver As Is' |	
        | Unscannable RFC Violations Send To Quarnatine | Valid when action is	
        set to 'Quarantine' for above parameter. Default: 'Policy' |	
        | Unscannable RFC Violations Modify Message Subject | Message subject modifcation	
        action. Allowed values: 'No', 'Prepend' & 'Append'. Default: 'No' |	
        | Unscannable RFC Violations Message Subject | Valid when above parameter	
        is not set to 'No'. Default: '[WARNING: UNSCANNABLE RFC NON-COMPLIANT]' |	
        | Unscannable RFC Violations Add Custom Header | Add a custom header to	
        message. Allowed values: 'Yes' or 'No'. Default: 'No' |	
        | Unscannable RFC Violations Custom Header Name | Valid when the above paramater	
        is set to 'Yes'. Default: Empty |	
        | Unscannable RFC Violations Custom Header Value | Valid when above parameter	
        is set to 'Yes'. Default: Empty |	
        | Unscannable RFC Violations Modify Recipient | Valid only when action is	
        set to 'Deliver As Is' | Allowed values: 'Yes' or 'No'. Default: 'No' |	
        | Unscannable RFC Violations Recipient Address | Valid when above parameter	
        is set to 'Yes'. Default: Empty |	
        | Unscannable RFC Violations Send To Alternate Destination Host | Valid	
        only when action is set to 'Deliver As Is' | Allowed values: 'Yes' or	
        'No'. Default: 'No' |	
        | Unscannable RFC Violations Alternate Destination Host | Valid when above	
        parameter is set to 'Yes'. Default: Empty |
        ...
        *Examples:*
        | ${password_data} | Create List        |
        | ... | add|0|test123                   |
        | ... | add|1|test1234                  |
        | ... | edit-priority|2|3               |
        | ... | edit-priority|3|2               |
        | ... | edit-password|test321|test12345 |
        | ... | delete|test4321                 |
        ...
        | ...  Enable Actions for Unscannable Messages due to decoding errors | Yes |	
        | ...  Unscannable Decoding Error Action | Quarantine |	
        | ...  Unscannable Decoding Error Send To Quarnatine | Policy |	
        | ...  Unscannable Decoding Error Modify Message Subject | Append |	
        | ...  Unscannable Decoding Error Message Subject | DE test subject |	
        | ...  Unscannable Decoding Error Add Custom Header | Yes |	
        | ...  Unscannable Decoding Error Custom Header Name | x-test-de-header-name |	
        | ...  Unscannable Decoding Error Custom Header Value | x-test-de-header-value |	
        | ...  Unscannable Decoding Error Modify Recipient | Yes |	
        | ...  Unscannable Decoding Error Recipient Address | de@test.rcpt |	
        | ...  Unscannable Decoding Error Send To Alternate Destination Host | Yes |	
        | ...  Unscannable Decoding Error Alternate Destination Host | de.alt.host |	
        | ...  Enable Actions for Unscannable Messages due to Extraction Failures | Yes |	
        | ...  Unscannable Extraction Failures Action | Deliver As Is |	
        | ...  Unscannable Extraction Failures Modify Message Subject | Prepend |	
        | ...  Unscannable Extraction Failures Message Subject | EF test subject |	
        | ...  Unscannable Extraction Failures Add Custom Header | Yes |	
        | ...  Unscannable Extraction Failures Custom Header Name | x-test-ef-header-name |	
        | ...  Unscannable Extraction Failures Custom Header Value | x-test-ef-header-value |	
        | ...  Unscannable Extraction Failures Modify Recipient | Yes |	
        | ...  Unscannable Extraction Failures Recipient Address | ef@rcpt.com |	
        | ...  Unscannable Extraction Failures Send To Alternate Destination Host | Yes |	
        | ...  Unscannable Extraction Failures Alternate Destination Host | ef.alt.host |	
        | ...  Enable Actions for Unscannable Messages due to RFC Violations | Yes |	
        | ...  Unscannable RFC Violations Action | Deliver As Is |	
        | ...  Unscannable RFC Violations Modify Message Subject | No |	
        | ...  Unscannable RFC Violations Add Custom Header | Yes |	
        | ...  Unscannable RFC Violations Custom Header Name | x-test-rfc-header-name |	
        | ...  Unscannable RFC Violations Custom Header Value | x-test-rfc-header-value |	
        | ...  Unscannable RFC Violations Modify Recipient | Yes |	
        | ...  Unscannable RFC Violations Recipient Address | rfc@rcpt.com |	
        | ...  Unscannable RFC Violations Send To Alternate Destination Host | Yes |	
        | ...  Unscannable RFC Violations Alternate Destination Host | rfc.alt.host |	
        | ...  Decrypt Inbound Password Protected Attachments | Yes |	
        | ...  Decrypt Outbound Password Protected Attachments | No |
        | ...  Probable Password for Analysis | ${password_data} |
    ...
    def scan_behaviour_import_list(self, filename):
        ...
        *Examples:*
        ...
        self._click_continue_button(text='Import')
    ...
    @go_to_page(PAGE_PATH)	
    @set_speed(0)	
    def scan_behaviour_get_global_settings(self, use_normalize=False):	
        """	
        Get Global Settings.	
        *Parameters*:	
        None	
        ...
        *Examples*:	
        | ${gl_settings} | Scan Behaviour Get Global Settings |	
        ...
        rows = int(self.get_matching_xpath_count('%s/tbody/tr' % GLOBAL_SETTINGS_TABLE))
        rowno = 1	
        text = lambda row: self.get_text('%s/tbody/tr[%s]' % (GLOBAL_SETTINGS_TABLE, row))	
        while rowno <= rows:
            tmp = text(rowno)	
            if tmp:	
                if tmp.lower().startswith('safe print settings'):	
                    tmp = re.sub(r'safe print settings ', '', tmp, re.IGNORECASE)	
                    key, value = re.search(r'(Maximum File.*?)\s+(\d+\S?)', tmp).groups()	
                    settings.__setattr__(self._normalize(key, use_normalize=use_normalize), value)	
                    key, value = re.search(r'(Maximum Page.*?)\s+(\d+\S?)', tmp).groups()	
                    settings.__setattr__(self._normalize(key, use_normalize=use_normalize), value)	
                    key, value = re.search(r'(Document.*?)\s+(\d+\S?)', tmp).groups()	
                    settings.__setattr__(self._normalize(key, use_normalize=use_normalize), value)	
                elif tmp.lower().startswith('scanning of password-protected'):
                    key = 'Scanning of Password-protected Attachments'
                    value = re.search(
                        r'Scanning of Password-protected Attachments:\s+(.*)\s+Priority', tmp, re.IGNORECASE).group(1)
                    settings.__setattr__(self._normalize(
                        key, use_normalize=use_normalize), value)
                    
                    key = 'Probable Password for Analysis'
                    value = {}
                    for data in re.findall(r'(\d+)\s+(\S+)', tmp):
                        value[data[1]] = data[0]
                    settings.__setattr__(self._normalize(
                        key, use_normalize=use_normalize), value)
                else:	
                    key, value = text(rowno).replace('?',':').split(':')	
                    settings.__setattr__(self._normalize(key, use_normalize=use_normalize), value)	
            rowno += 1	
        return settings 
