...
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/admin/network_access.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
CLI_ACTIVITY_TIMEOUT = ('CLI Inactivity Timeout',
                    "//input[@name='cli_session_timeout']")
...
class NetworkAccess(GuiCommon):
    ...
    def network_access_edit(self, settings={}):
        ...
        *Parameters:*
        ...
        | `CLI Inactivity Timeout` | cli inactivity timeout, minutes |
