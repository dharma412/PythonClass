...
class Ssw(GuiCommon):
    ...
    def _system_page(self,
        ...
        if region:
            self.select_from_list_by_label("xpath=//select[@id='region']", region)
        if country:
            self.select_from_list_by_label("xpath=//select[@id='country']", country)
        if timezone:
            self.select_from_list_by_label("xpath=//select[@id='timezone']", timezone)
	...
	| ... | password_option=generated |
        ...
        self._reset_config()
        self._info('Reset config complete...')
        ...
        self._info('Password genration complete...')
        self._check_action_result()

        self._info('Filling network page...')
