...
MONITORING.MONITORING_URL_PATH       = 'reporting'
...
Reports['Advanced Malware Protection'] = {'xpath':"//a[@translate='menu_slider.reporting.advancedMalwareProtection']",
                                  'href': "/reporting/advanced-malware-protection"}
Reports['Inbound SMTP Authentication'] = {'xpath':"//a[@translate='menu_slider.reporting.inboundAuth']",
                                  'href': "/reporting/inboundAuth"}
Reports['Mail Flow Details'] = {'xpath':"//a[@translate='menu_slider.reporting.mailFlowDetailsReports']",
                                  'href': "/reporting/mfdreports"}
Reports['Outbreak Filtering'] = {'xpath':"//a[@translate='menu_slider.reporting.outbreakFilters']",
                                  'href': "/reporting/outbreak-filters"}
Reports['Mail Policy Details'] = {'xpath':"//a[@translate='menu_slider.reporting.mailPolicy']",
                                  'href': "/reporting/mail-policy"}
Reports['Sender Domain Reputation'] = {'xpath':"//a[@translate='menu_slider.reporting.senderDomainReputation']",
                                  'href': "/reporting/sender-domain-reputation"}
Reports['My Favorite Reports'] = {'xpath':"//a[@translate='menu_slider.reporting.myReports']",
                                  'href': "/reporting/my-reports"}
