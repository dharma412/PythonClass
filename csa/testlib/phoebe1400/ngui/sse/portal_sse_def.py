...
PORTAL_SSE.USERNAME_FIELD = "//input[@id='email']"
...
PORTAL_SSE.TOKEN_EXP_TIME = "//select[@id='expireOn']/option"
PORTAL_SSE.SORT_BY_STATUS = "//span[contains(text(),'Status')]"
PORTAL_SSE.MIGRATE_LATER = "//input[@value='Migrate Later']"
