...
MESSAGE_TRACKING.MAIL_POLICY_NAME = "//*[@name='mail_policy_name' and @type='text']"
...
MESSAGE_TRACKING.SHOW_FILTER = "$ctrl.toggleFilterPanel()"
...
MESSAGE_TRACKING.MAIL_POLICY = 'mailPolicy'
...
MESSAGE_TRACKING.SEARCH_CRITERIA   = "//*[@id='message-tracking-results__table-container']"
...
class MailFlowDirection:
    Inbound = "//*[@field-name='mailPolicy.mailflow_direction_mp.inbound']"
    Outbound = "//*[@field-name='mailPolicy.mailflow_direction_mp.outbound']"


class SearchResult:
    total_count = 'ng-bind=$ctrl.totalCount'
    result_table_details = "//*[@id='message-tracking-results__table-details-title%s']"
    ...
    timestamp = "//*[@id='message-tracking-results__table-details-title%s']/div[3]/span[2]"
    message_checkbox = "/div[1]/div[1]/ngsma-search-result-checkbox"
    
    policy_match_header = "//*[@id='message-tracking-results__table-details%s']/div/div/div[4]/span[1]"
    policy_match_value = "//*[@id='message-tracking-results__table-details%s']/div/div/div[4]/span[2]"
    sender_group = "//*[@id='message-tracking-results__table-details%s']/div/div/div[5]/p"    
    sender_group_value = "//*[@id='message-tracking-results__table-details%s']/div/div/div[5]/span"
    sender_ip = "//*[@id='message-tracking-results__table-details%s']/div/div/div[6]/p"
    sender_ip_value = "//*[@id='message-tracking-results__table-details%s']/div/div/div[6]/span"

    sender = "//*[@id='message-tracking-results__table-details%s']/div[2]/div/div[1]/p"
    sender_value = "//*[@id='message-tracking-results__table-details%s']/div[2]/div/div[1]/span"
    recipient = "//*[@id='message-tracking-results__table-details%s']/div[2]/div/div[2]/p"
    recipient_value = "//*[@id='message-tracking-results__table-details%s']/div[2]/div/div[2]/span"
    subject = 	"//*[@id='message-tracking-results__table-details%s']/div[2]/div/div[3]/p"
    subject_value = "//*[@id='message-tracking-results__table-details%s']/div[2]/div/div[3]/span"
    sbrs_score = "//*[@id='message-tracking-results__table-details%s']/div[2]/div/div[4]/p"
    sbrs_score_value = 	"//*[@id='message-tracking-results__table-details%s']/div[2]/div/div[4]/span"
...
class SearchResultRemediate:
    ...
    remediation_status_go_back = "//*[@translate='buttons.back' and text()='Back To Tracking Search Form']"
    ...
    go_to_status_report = "//*[@translate='remediation.goto_status_report']"
...
class SearchResultMoreDetails:
    ...
    last_state_header = "//*[@translate='message-tracking.search.results.card_titles.last_state']"
    last_state_value = "//*[@translate='message-tracking.search.results.card_titles.last_state']/../div[2]/div"

    timestamp = "//*[@translate='message-tracking.search.results.card_titles.time']/../div[2]"
    mid = "//*[@translate='message-tracking.search.results.card_titles.MID']"
    mid_value = "//*[@translate='message-tracking.search.results.card_titles.MID']/../div[2]"
...
class ToastWidget:
    ...
    toast_widget = "//*[@class='md-toast-content']"
    toast_widget_content = "//*[@class='toast toast__content']"
    toast_widget_close_icon = "//*[@class='toast toast__icon-close']"
    view_details = "//*[text()='View Details']"

class ExportResults:

    Export = "//*[@title='Export']"
    Tracking_Results = {'All_Results':"//*[@translate='message-tracking.search.results.all_results']",
                         'Page_View_Results':"//*[@translate='message-tracking.search.results.page_view_results']"}