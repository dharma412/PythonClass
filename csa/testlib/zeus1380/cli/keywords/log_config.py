#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1380/cli/keywords/log_config.py#2 $
...
class LogConfig(CliKeywordBase):
    ...
    def _get_logconfig_dict(self, **kwargs):
        ...
        available_arguments = ('log_file', 'name', 'log_level', 'bytes_bounce',
            ...
            'time', 'include_pwd',
            'append_unique_id',
            'unique_id','rate_limit','time_range','number_of_events'
        )
    ...
    def log_config_new(self, *args):
        ...
        -  'rate_limit':rate limit for logged events
        - 'time_range':Time range in seconds for vent capture
        - 'number_of_events':Maximum number of events to be logged
