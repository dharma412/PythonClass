# $Id: //prod/main/sarf_centos/testlib/zeus1380/gui/management/administration/user_roles.py#3 $  $DateTime: 2020/08/10 11:37:41 $ $Author: sumitada $
...
class UserRoles(GuiCommon):
    ...
    def user_roles_email_role_add(self, name, description=None,
        ...
        quarantine_access=None, quarantine_type="spam"):
