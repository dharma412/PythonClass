#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1380/gui/help/technical_support_def/contact_techsupport_output_analysis.py#1 $ $DateTime: 2020/05/25 00:19:30 $ $Author: sarukakk $
...
HEADER_BY_NAME = lambda name: \
        "{0}[starts-with(normalize-space(),'{1}')]/following-sibling::td".\
