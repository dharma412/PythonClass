...
class RemediationReport(NGGuiCommon):
    ...
    def get_message_remediated_summary(self):
        ...
        for legend_index in range(1, 3):
            ...
            if self._is_visible(legend_xpath):
    ...
    def remediation_batches_detail(self):
        ...
        for eachrow in range(1, count):
            ...
            if status_match:
                col_dict['Status'] = {status_match.group(2): status_match.group(1)}
...
class Remediation:
    summary_tab = "//*[@translate='monitoring.reporting.summary']"
    ...
    total_summary_messages_remediated = '%s/div/div[2]' %summary_messages_remediated
    total_summary_messages_auto_remediated = '%s/div/div[2]' %summary_messages_auto_remediated
    total_summary_messages_search_and_remediated = '%s/div/div[2]' %summary_messages_search_and_remediated
    message_remediated_legend = '%s/div/div[4]'%summary_messages_remediated
    message_auto_remeediated_legend = '%s/div/div[4]' %summary_messages_auto_remediated
    message_search_and_remediated_legend = '%s/div/div[4]' %summary_messages_search_and_remediated
