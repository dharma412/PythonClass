#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/zeus1360/gui/management/services/centralized_web_configuration_manager.py#1 $ $DateTime: 2020/03/05 19:45:32 $ $Author: sarukakk $
...
class CentralizedWebConfigurationManager(GuiCommon):
    ...
    def get_keyword_names(self):
        return ['centralized_web_configuration_manager_enable',
                'centralized_web_configuration_manager_disable',
                ]
    ...
    def _is_iccm_disabled(self):
        return self._is_text_present('The Centralized Configuration '\
                                     'Manager service is currently disabled.')
    ...
    def centralized_web_configuration_manager_enable(self):
        """Enable Centralized Web Configuration Manager.
    ...
    def centralized_web_configuration_manager_disable(self):
        """Disable Centralized Web Configuration Manager.
