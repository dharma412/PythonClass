# $Id: //prod/main/sarf_centos/testlib/zeus1360/cli/ctor/updateconfig.py#1 $ $DateTime: 2020/03/05 19:45:32 $ $Author: sarukakk $
...
class updateconfig(CliConfiguratorBase):
    ...
    def validate_certificates(self, input_dict=None, **kwargs):
        param_map = ccb.IafCliParamMap(end_of_command='Choose the operation')
        param_map['validate_certificates'] = ['Should server certificates from Cisco update servers be validated?',DEFAULT]
