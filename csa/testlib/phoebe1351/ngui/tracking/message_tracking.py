...
from tracking import Remediation, URLCategories, WebInteractionTrackingMailflowDirection
...
from tracking import APPForwarding
...
class Tracking(NGGuiCommon):
    ...
    def message_tracking_remediate(self, mid=None, batch_name=None, \
        ...
        :param remediation_status_action : remediation_status_action to do Close/Go Back
        ...
        if confirm_remediation_action.lower() == 'apply':
            ...
            if remediation_status_action != 'Close':
                if remediation_status_action.lower() == 'go back':
                    self.click_ng_button(SearchResultRemediate.remediation_status_go_back, 'Go Back')
            else:
