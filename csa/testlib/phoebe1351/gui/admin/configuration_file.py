...
CLUSTER1_DROPDOWN_LIST = "//select[@id='42139C58085F90DF1884-008704B4C60B_group']"
CLUSTER2_DROPDOWN_LIST = "//select[@id='42131017EBBCC88E7727-FCF790F1D37C_group']"
...
#        self.click_button(LOAD_BUTTON)
        if cluster_load_mode.lower() == 'yes':
            value = "Main_Group"
            self._wait_until_element_is_present(LOAD_CLUSTER_CONFIG_PAGE, timeout=30)
            self.select_from_list(CLUSTER1_DROPDOWN_LIST,value)
            self.select_from_list(CLUSTER2_DROPDOWN_LIST,value)
