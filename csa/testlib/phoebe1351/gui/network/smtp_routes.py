#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/gui/network/smtp_routes.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class SmtpRoutes(GuiCommon):
    ...
    def smtp_routes_import(self,filename, confirm=True):
        ...
        *Examples*:
        ...
        self.select_from_list_by_label(IMPORT_LIST, filename)
