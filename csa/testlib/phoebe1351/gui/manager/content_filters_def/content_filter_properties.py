...
class URLReputationConditionProperty(ContentFilterProperty):
    ...
    def set(self, new_value):
        ...
        *Examples:*
        ...
        if 'malicious reputation url' in converted_dict.keys():
            self.gui._click_radio_button(self.MALICIOUS_RADIO)
        if 'suspect reputation url' in converted_dict.keys():
            self.gui._click_radio_button(self.NEUTRAL_RADIO)
        if 'clean reputation url' in converted_dict.keys():
            self.gui._click_radio_button(self.CLEAN_RADIO)
        if 'noscore reputation url' in converted_dict.keys():
