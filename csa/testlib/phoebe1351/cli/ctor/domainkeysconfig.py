#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1350/cli/ctor/domainkeysconfig.py#1 $ $DateTime: 2020/01/06 01:25:43 $ $Author: saurgup5 $
...
class domainkeysconfigProfiles(clictorbase.IafCliConfiguratorBase):
    ...
    class DomainProfileKeyNameError(IafCliError): pass
    class DomainNameError(IafCliError): pass
    class SelectorError(IafCliError): pass
    class KeyGeneratingError(IafCliError): pass
    class UserError(IafCliError): pass
    class InvalidDataKeyError(IafCliError): pass
    class UserDomainMatchError(IafCliError): pass
    class KeyLengthError(IafCliError): pass
    class AlgorithmError(IafCliError): pass
...
class domainkeysconfigKeys(clictorbase.IafCliConfiguratorBase):
    ...
    class DomainProfileKeyNameError(IafCliError): pass
    class InvalidDataKeyError(IafCliError): pass
    class PublicKeyError(IafCliError): pass
    class ImportError(IafCliError): pass
    class ExportError(IafCliError): pass
    class KeyLengthError(IafCliError): pass
...
class domainkeysconfigProfilesEdit(clictorbase.IafCliConfiguratorBase):
    ...
    class UserDomainMatchError(IafCliError): pass
    class KeyLengthError(IafCliError): pass
    class DomainProfileExistsError(IafCliError): pass
    class UserAlreadyAddedError(IafCliError): pass
    class UserPartDomainError(IafCliError): pass
