...
# $Id: //prod/main/sarf_centos/testlib/phoebe1210/gui/manager/rat.py#1 $ $DateTime: 2019/05/07 03:16:10 $ $Author: bimmanue $
...
class rat(AccessTableBase):
    ...
    def rat_recipient_edit(self, listener_name, old_address, **kwargs):
        ...
        *Examples*:
        ...
        self.click_button(RECIPIENT_EDIT_LINK(old_address))
