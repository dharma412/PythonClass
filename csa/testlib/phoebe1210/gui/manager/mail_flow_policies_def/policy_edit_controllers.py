...
# $Id: //prod/main/sarf_centos/testlib/phoebe1210/gui/manager/mail_flow_policies_def/policy_edit_controllers.py#1 $ $DateTime: 2019/05/07 03:16:10 $ $Author
...
from policy_properties import Name, ConnectionBehavior, MaxMsgsPerCon, \
    ...
    SpamDetection, VirusProtection, TLS, \
