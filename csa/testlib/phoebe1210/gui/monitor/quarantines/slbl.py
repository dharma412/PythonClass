#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1210/gui/monitor/quarantines/slbl.py#1 $ $DateTime: 2019/05/07 03:16:10 $ $Author: bimmanue $
...
class Slbl(QuarantinesCommon):
    ...
    def quarantines_slbl_edit_settings(self, action=None, max_entries=None):
        ...
        *Exceptions*:
        ...
        self._select_from_list_use_regex(SLBL_BLOCK_LIST_ACTION, action)
