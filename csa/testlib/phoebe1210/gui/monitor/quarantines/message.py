#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1210/gui/monitor/quarantines/message.py#1 $ $DateTime: 2019/05/07 03:16:10 $ $Author: bimmanue $
...
class QuarantinedMessage(QuarantinesCommon):
    ...
    def quarantines_message_release(self,
        ...
        *Examples*:
        ...
        self._select_quarantine(name=name, all=from_all)
        if delay:
            self.select_from_dropdown_list(MESSAGE_DETAILS_MESSAGE_ACTION_LIST,
                                           delay)
        else:
            self.select_from_dropdown_list \
...
class SpamQuarantinedMessage(QuarantinedMessage):
    ...
    def quarantines_spam_message_delete(self):
        ...
        *Examples*:
        ...
        if self._is_element_present("//*[@id='message_action1']"):
            self.select_from_dropdown_list("//*[@id='message_action1']", '-- Delete')
    ...
    def quarantines_spam_message_release(self):
        ...
        *Examples*:
        ...
        """
        if self._is_element_present("//*[@id='message_action1']"):
            self.select_from_dropdown_list("//*[@id='message_action1']", '-- Release')
            self.click_button("//*[@id='process_message']", "don't wait")
