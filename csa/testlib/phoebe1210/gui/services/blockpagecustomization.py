#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1210/gui/services/blockpagecustomization.py#1 $ $DateTime: 2019/05/07 03:16:10 $ $Author: bimmanue $
...
class blockPageCustomization(GuiCommon):
    ...
    @set_speed(0)
    def block_page_customization_edit_settings(self, logo_url=None, company_name=None, contact_info=None,
                                               default_lang=None):
