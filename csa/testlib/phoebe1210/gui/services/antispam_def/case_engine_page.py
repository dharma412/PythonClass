...
# $Id: //prod/main/sarf_centos/testlib/phoebe1210/gui/services/antispam_def/case_engine_page.py#1 $ $DateTime: 2019/05/07 03:16:10 $ $Author: bimmanue $
...
class CASEEnginePage(BaseEnginePage):
    ...
    @classmethod
    def get_markers(cls):
        return ('ironport', 'case')

    @classmethod
    def get_menu_entry_name(cls):
        return 'IronPort Anti-Spam'
