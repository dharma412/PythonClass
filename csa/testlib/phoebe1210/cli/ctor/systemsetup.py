# !/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1210/cli/ctor/systemsetup.py#1 $ $DateTime: 2019/05/07 03:16:10 $ $Author: bimmanue $
        ...
        if kwargs.has_key('%s_assign_second_ip' % _ethernet):
            self.param_map['%s_assign_second_ip' % _ethernet] = \
                ['Would you like to assign a second IP address for the "Data 1" interface',
                 kwargs['%s_assign_second_ip' % _ethernet]]
            self.param_map['%s_second_nickname' % _ethernet] = ['Please create a nickname for the "Data 1"', REQUIRED]
            self.param_map['%s_second_enable_ip4' % _ethernet] = ['Would you like to configure an IPv4 address',
                                                                  DEFAULT]
            ...
            self.param_map['%s_second_enable_ipv6' % _ethernet] = ['Would you like to configure an IPv6 address',
                                                                   DEFAULT]
