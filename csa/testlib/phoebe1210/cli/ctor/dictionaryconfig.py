#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1210/cli/ctor/dictionaryconfig.py#1 $ $DateTime: 2019/05/07 03:16:10 $ $Author: bimmanue $

"""
SARF CLI command: dictionaryconfig
"""
import clictorbase
...
class dictionaryconfig(clictorbase.IafCliConfiguratorBase):
    class DictionaryQuantityError(IafCliError):
        pass

    class DictionaryNameUseError(IafCliError):
        pass

    class DictionaryNameError(IafCliError):
        pass

    class WordError(IafCliError):
        pass
...
class dictconfigEdit(clictorbase.IafCliConfiguratorBase):
    ...
    class FileImportNameError(IafCliError):
        pass

    class WordMatchingError(IafCliError):
        pass

    class WordQuantityError(IafCliError):
        pass
