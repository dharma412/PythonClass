#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1210/cli/ctor/outbreakflush.py#1 $ $DateTime: 2019/05/07 03:16:10 $ $Author: bimmanue $
...
class outbreakflush(clictorbase.IafCliConfiguratorBase):
    class NoOutbreakFeatureKeyError(clictorbase.IafCliError):
        pass

    class OutbreakIsNotEnabledError(clictorbase.IafCliError):
        pass

    class FlushingRulesFailedError(clictorbase.IafCliError):
        pass
