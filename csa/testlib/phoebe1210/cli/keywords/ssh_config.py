#!/usr/bin/env python
# $Id: //prod/main/sarf_centos/testlib/phoebe1210/cli/keywords/ssh_config.py#1 $ $DateTime: 2019/05/07 03:16:10 $ $Author: bimmanue $
...
class SshConfig(CliKeywordBase):
    ...
    def sshconfig_edit_ssh_settings(self, pubkey_algorithms, cipher_algorithms, mac_methods, min_server_key_size,
                                    kex_algorithms, fips_mode=False):
