...
Initialize Suite
    ...
    Commit Changes
    Set Suite Variable  ${MAIL}  ${ldap_uid}@${CLIENT}
    Set Suite Variable  ${MAIL_LOCAL_ADDRESS}  newuser1@${CLIENT}
    ...
    LDAP Client Create User  uid=${ldap_uid}  password=${PASSWORD}
...
Finalize Suite
    Ldap Client Delete User  ${ldap_uid}
