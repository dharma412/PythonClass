...
Initialize Suite
    ...
    Set Suite Variable  ${MAIL_LOCAL_ADDRESS}  ldapad1@${CLIENT}
...
Tvh1337864c
    [Tags]  interop  Tvh1337864c  Tvh1339877c  Tvh1339879c  Tvh1339887c
    ...  Tvh1340101c  Tvh1330303c
    [Documentation]  To verify the functionality of  End User Spam Quarantine in SMA.
    ...  link:http://tims.cisco.com/view-entity.cmd?ent=1337864
    ...
    ...  7. Click on submit.
    ...  8. Navigate to System Administration -> LDAP and add a server profile with Active Directory as Server Type.
    ...
    Inject Custom Message  ${mbox_path}  ${PUBLIC_LISTENER.ipv4}
    Library Order SMA
    ...
    Log  ${cnt}
    Should Be Equal As Numbers  ${cnt}  7
...
Tvh1339876c
    [Tags]  interop  Tvh1339876c  Tvh1339878c  Tvh1339880c
    [Documentation]  To verify the functionality of  End User Spam Quarantine in SMA
    ...  when "Enable login without credentilas for quarantine access" is checked
    ...  link:https://tims.cisco.com/view-entity.cmd?ent=1339876
    ...  other steps same as Tvh1337864c
