# $Id: //prod/main/sarf_centos/tests/zeus1350/common_regression_tests/reporting/reporting_4.txt#8 $
...
Verify Pdf Report User
    ...
    ${out}=  Remove String  ${out}  ${SPACE}
    Should contain any  ${out}  ${msg}
    Log  ${out}
    Remove File  ${path}
...
Tvh662935c
    ...
    ...  reports contatin appropriate Reporting data\n
    ...  Verify user is able to generate pdf reports, and
    ...  reports contatin appropriate System Capacity data
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh662935c
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663750c
    [Tags]  srts  wsrts  Tvh662935c  Tvh663750c
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Tvh663810c
    ...
    ...  Finalize Tvh663810c
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh662935c
    ...
    ...  Day
    ...  Year
      Navigate To  Email  Reporting  Reporting Data Availability
      Select From List  xpath=//*[@id='date_range']  ${time_period}
      Verify Pdf Report  Data in time range: 100.0 % complete
    END
...
Tvh664136c
    [Documentation]  Verify user is able to generate pdf reports, and
    ...  reports contatin appropriate Internal Users data\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh664136c
    [Tags]  Tvh664136c  srts  wsrts
    [Setup]  Run Keywords
    ...  General Test Case Setup
    [Teardown]  Run Keywords
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh664136c
    ...
    ...  Year
      ...
      Select From List  xpath=//*[@id='date_range']  ${time_period}
      Verify Pdf Report User  ${CLIENT}
    END

Tvh663986c
    [Documentation]  Verify user is able to generate pdf reports, and
    ...  reports contatin appropriate content filters data\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663986c
    [Tags]  Tvh663986c  srts  wsrts
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Tvh663986c
    [Teardown]  Run Keywords
    ...  Finalize Tvh663986c
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663986c
    ...
    Switch TO SMA
    ${expected_columns}=  Create List
    ...  Content Filter           ${Tvh663986c_FILTER_NAME}
    ...
    ...  Day
    ...  Year
      Navigate To  Email  Reporting  Content Filters
      Select From List  xpath=//*[@id='date_range']  ${time_period}
      Verify Pdf Report  ${Tvh663986c_FILTER_NAME}
    END

Tvh663328c
    [Documentation]  Verify user is able to generate pdf reports, and
    ...  reports contatin appropriate DLP data\n
    [Tags]  srts  wsrts  Tvh663328c
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Tvh663810c
    [Teardown]  Run Keywords
    ...  Finalize Tvh663810c
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663328c
    ...
    ...  Day
    ...  Year
      Navigate To  Email  Reporting  DLP Incident
      Select From List  xpath=//*[@id='date_range']  ${time_period}
      Verify Pdf Report  ${DLP_POLICY_NAME}
    END

Tvh663149c
    [Documentation]  Verify user is able to generate pdf reports, and
    ...  reports contatin appropriate Outgoing Senders data\n
    ...  Verify user is able to generate pdf reports, and
    ...  reports contatin appropriate Outgoing Destinations data\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663149c
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663317c
    [Tags]  Tvh663149c  Tvh663317c  srts  wsrts
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Tvh663149c
    [Teardown]  Run Keywords
    ...  Finalize Tvh663149c
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663149c
    ...
    Select From List  xpath=//*[@id='date_range']  Day
    Verify Pdf Report  Sender Domain
    Sleep  10s

    Navigate To  Email  Reporting  Outgoing Senders
    Select From List  xpath=//*[@id='date_range']  Year
    Verify Pdf Report  Sender Domain
    Sleep  10s

    Navigate To  Email  Reporting  Outgoing Destinations
    Select From List  xpath=//*[@id='date_range']  Day
    Verify Pdf Report  ${CLIENT}
    Sleep  10s
...
Tvh663223c
    [Documentation]  When some e-mail groups are configured and ungrouped
    ...  appliances, Turn consolidation from off to on,
    ...  verify that all data in a group is preserved\n
    ...  When some e-mail groups are configured and ungrouped appliances
    ...  Turn consolidation from off to on,
    ...  verify that data that were not in a group is displayed\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663223c
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663586c
    [Tags]  srts  wsrts  Tvh663223c  Tvh663586c
    [Setup]  Run Keywords
    ...  General Test Case Setup
    [Teardown]  Run Keywords
    ...  Finalize Tvh663296c
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663223c
    ...
    FOR  ${connection_type}
    ...   ${clean_messages_column_index}
    ...   ${view_data_for}  IN
    ...  Outgoing  5  Group: ${REPORTING_GROUP_NAME}
    ...  Incoming  2  Group: ${REPORTING_GROUP_NAME}
    ...  Outgoing  5  Group: ${Reporting_group_name2}
    ...  Incoming  2  Group: ${Reporting_group_name2}
    ...  Outgoing  5  All Email Appliances
    ...  Incoming  2  All Email Appliances
      Verify Mail Summary Reporting On SMA
      ...  connection_type=${connection_type}
      ...  column_index_to_check=${clean_messages_column_index}
      ...  expected_column_value=${MESSAGES_COUNT}
      ...  view_data_for=${view_data_for}
    END

Tvh663296c
    [Documentation]  When some e-mail groups are configured and ungrouped appliances,
    ...  Turn consolidation from on to off, verify that
    ...  data that were not in a group is discarded\n
    ...  When some e-mail groups are configured and ungrouped appliances,
    ...  Turn consolidation from on to off,
    ...  verify that data that were not in a group is discarded\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663296c
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh662957c
    [Tags]  srts  wsrts  Tvh663296c  Tvh662957c
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Enable Consolidated Reporting On SMA
    [Teardown]  Run Keywords
    ...
    ...  Disable Consolidated Reporting On SMA
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663296c
...
Tvh663622c
    [Documentation]  When some e-mail groups are configured and ungrouped
    ...  Verify Overview page can be viewed for e-mail groups\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663622c
    [Tags]  srts  wsrts  Tvh663622c
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Tvh663622c
    [Teardown]  Run Keywords
    ...  Finalize Tvh663622c
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663622c

    FOR  ${connection_type}  ${clean_messages_column_index}  IN
    ...  Incoming  16
    ...  Outgoing  5
      Verify Mail Summary Reporting On SMA
      ...  connection_type=${connection_type}
      ...  column_index_to_check=${clean_messages_column_index}
      ...  expected_column_value=${MESSAGES_COUNT}
      ...  view_data_for=Group: ${REPORTING_GROUP_NAME}
    END
