# $Id: //prod/main/sarf_centos/tests/zeus1350/common_regression_tests/reporting/reporting_1.txt#8 $
...
Initialize Suite
    ...
    HAT Sender Group Edit Settings  ${PRIVATE_LISTENER.name}  ALL
    ...  policy=RELAYED
    Commit Changes
...
Initialize Tvh663323c
    ...
    Inject ${CONNECTIONS} Clean Messages To Private Listener With TLS Option ${False}
...
Do SMA System Capacity Verification
    Email Reporting Check Chart Presence  Average Time Spent in Work Queue
    Email Reporting Check Chart Presence  Average Messages in Work Queue
    Email Reporting Check Chart Presence  Maximum Messages in Work Queue Should
    Email Reporting Check Chart Presence  Total Incoming Connections
    Email Reporting Check Chart Presence  Total Incoming Messages
    Email Reporting Check Chart Presence  Average Incoming Message Size (Bytes)
    Email Reporting Check Chart Presence  Total Incoming Message Size (Bytes)
    Email Reporting Check Chart Presence  Total Outgoing Connections
    Email Reporting Check Chart Presence  Total Outgoing Messages
    Email Reporting Check Chart Presence  Average Outgoing Message Size (Bytes)
    Email Reporting Check Chart Presence  Total Outgoing Message Size (Bytes)
    Email Reporting Check Chart Presence  Overall CPU Usage
    Email Reporting Check Chart Presence  CPU by Function
    Email Reporting Check Chart Presence  Memory Page Swapping
...
Do Tvh663629c Verification
    Email Reporting Check Chart Presence  Average Time Spent in Work Queue
    Email Reporting Check Chart Presence  Average Messages in Work Queue
    Email Reporting Check Chart Presence  Maximum Messages in Work Queue
    Switch TO ESA
    Run Keyword And Ignore Error  Start CLI Session If Not Open
...
*** Test Cases ***
Tvh663884c
    [Documentation]  when centralized reporting is enabled,\n
    ...  Create a scheduled report that relies on\n
    ...  a group, then delete the group and Verify that it deletes\n
    ...  the scheduled report automatically\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663884c
    [Tags]  srts  wsrts  Tvh663884c  Tvh663990c
    [Setup]  General Test Case Setup
    [Teardown]  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663884c

    Switch To SMA
    Centralized Email Reporting Enable
    Page Should Contain  Email Appliance Reporting Groups
    Page Should Contain Button  Add Group...

    Centralized Email Reporting Group Add  ${REPORTING_GROUP_NAME}  ${ESA}
    Commit Changes

    Navigate To  Email  Reporting  Scheduled Reports
    Click Element  xpath=//input[@value='Add Scheduled Report...']
    Select From List  xpath=//select[@id='report_type']  Executive Summary
    Wait Until Page Loaded
    Page Should Contain Element  xpath=//select[@id='host_id']
    Select From List  xpath=//select[@id='host_id']  Group: ${REPORTING_GROUP_NAME}
    Click Element  xpath=//input[@value='Submit']
    Sleep  5
    Page Should Contain  The Scheduled Report "Executive Summary" was added
    Commit Changes
    ...
    Navigate To  Email  Reporting  Scheduled Reports
    Page Should Contain  There are no Scheduled Reports defined.

Tvh663068c
    [Documentation]  when centralized reporting is enabled, Verify that removing\n
    ...  ESA appliance permanently from SMA results an update on the group's membership\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663068c\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh662923c
    [Tags]  srts  wsrts  Tvh663068c  Tvh662923c
    [Setup]  General Test Case Setup
    [Teardown]  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663068c

    Switch To SMA
    Centralized Email Reporting Group Add  ${REPORTING_GROUP_NAME}  ${ESA}
    Commit Changes
    Page Should Contain Link  ${REPORTING_GROUP_NAME}

    Security Appliances Delete Email Appliance  ${ESA}
    Commit Changes

    Centralized Email Reporting Enable
    Page Should Contain  No Appliances Selected
...
Tvh663714c
    [Documentation]  when centralized reporting is enabled,\n
    ...  Verify that user can create multiple groups\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663714c
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663805c
    [Tags]  srts  wsrts  Tvh663714c  Tvh663805c
    [Setup]  General Test Case Setup
    [Teardown]  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663714c

    Set Test Variable  ${Reporting_group_name2}  test_group_2
    Switch To SMA
    Centralized Email Reporting Group Add  ${REPORTING_GROUP_NAME}  ${ESA}
    Commit Changes

    Centralized Email Reporting Group Add  ${Reporting_group_name2}  ${ESA}
    Commit Changes
    Page Should Contain Link  ${REPORTING_GROUP_NAME}
    Page Should Contain Link  ${Reporting_group_name2}

    Centralized Email Reporting Group Delete  ${REPORTING_GROUP_NAME}
    Page Should Contain  The Group ${REPORTING_GROUP_NAME} was removed.
    Centralized Email Reporting Group Delete  ${Reporting_group_name2}
    Commit Changes

Tvh664267c
    [Documentation]  when centralized reporting is enabled,\n
    ...  Verify that user can remove appliances from a group\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh664267c
    [Tags]  srts  wsrts  Tvh664267c
    [Setup]  General Test Case Setup
    [Teardown]  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh664267c

    Switch To SMA
    Centralized Email Reporting Group Add  ${REPORTING_GROUP_NAME}  ${ESA}
    Commit Changes
    Page Should Contain  ${ESA}

    Centralized Email Reporting Group Edit  ${REPORTING_GROUP_NAME}  appliances=${EMPTY}
    Commit Changes
    Page Should Contain  No Appliances Selected
    Centralized Email Reporting Group Delete  ${REPORTING_GROUP_NAME}

Tvh663197c
    [Documentation]  Verify data on charts and tables\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663197c
    [Tags]  Tvh663197c  srts  wsrts
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Email Reporting Group Test
    ...
    ...  Finalize Email Reporting Group Test
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663197c
...
Tvh663133c
    [Documentation]  Verify data on charts and tables\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663133c
    [Tags]  srts  wsrts  Tvh663133c
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Outgoing Destinations Reporting Test Case
    ...  Initialize Tvh663133c
    ...
    ...  Finalize Outgoing Destinations Reporting Test Case
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663133c

    ${total_msgs_count}=  Evaluate  ${CLEAN_MSGS_COUNT} + ${SPAM_MSGS_COUNT}
    ${expected_columns}=  Create List
    ...  Clean               ${CLEAN_MSGS_COUNT}
    ...  Spam Detected       ${SPAM_MSGS_COUNT}
    ...  Total Threat        ${SPAM_MSGS_COUNT}
    ...  Total Messages      ${total_msgs_count}
    Verify Mail Reporting On SMA
    ...  table_name=Sender Details
...
Tvh664204c
    [Documentation]  Verify data on charts and tables\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh664204c
    [Tags]  Tvh664204c  srts  wsrts
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Tvh664204c
    [Teardown]  Run Keywords
    ...  Finalize Tvh664204c
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh664204c

    Set Test Variable  ${total_msgs_count}  10
    ${log_pattern1}=  Set Variable  Dropped by content filter .* in the inbound table
    ${log_pattern2}=  Set Variable  Dropped by content filter .* in the outbound table
    Switch TO ESA
    Inject Messages
    ...  mbox-filename=${RAR_EXE}
    ...  num-msgs=${total_msgs_count}
    ...  inject-host=${ESA_PUBLIC_LISTENER_IP}

    Verify And Wait For Log Records  ${log_pattern1} >= ${total_msgs_count}
    Roll Over Now  mail_logs
    ...
    Verify And Wait For Log Records  ${log_pattern2} >= ${total_msgs_count}

    Switch TO SMA
    ${expected_columns}=  Create List
    ...  Content Filter           ${Tvh664204c_FILTER_NAME}
    ...  Messages                 ${total_msgs_count}
    Verify Mail Reporting On SMA
    ...  table_name=Incoming Content Filter Matches
    ...  expected_columns=${expected_columns}
    ...  time_period=Day

    Email Reporting Check Chart Presence  Top Incoming Content Filter Matches

    ${expected_columns}=  Create List
    ...  Content Filter           ${Tvh664204c_FILTER_NAME}
    ...  Messages                 ${total_msgs_count}
    Verify Mail Reporting On SMA
    ...  table_name=Outgoing Content Filter Matches
    ...  expected_columns=${expected_columns}
    ...  time_period=Day

    Email Reporting Check Chart Presence  Top Outgoing Content Filter Matches

Tvh663810c
    [Documentation]  Verify data on charts and tables\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663810c
    [Tags]  srts  wsrts  Tvh663810c  Tvh663252c
    [Setup]  Run Keywords
    ...  General Test Case Setup
    [Teardown]  Run Keywords
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663810c

    Set Test Variable  ${total_msgs_count}  1
    Switch TO ESA
    Inject Messages
    ...  mbox-filename=${SPAM}
    ...  num-msgs=${total_msgs_count}
    ...
    Switch TO SMA
    ${expected_columns}=  Create List
    ...  Incoming Spam Detected   ${total_msgs_count}
    Verify Mail Reporting On SMA
    ...  table_name=User Mail Flow Details
    ...  expected_columns=${expected_columns}
    ...  left_chart=Top Users by Clean Incoming Messages
    ...  right_chart=Top Users by Clean Outgoing Messages
    ...  time_period=Day

     Email Reporting Check Chart Presence  Top Users by Clean Incoming Messages

Tvh663865c
    [Documentation]  Verify data on charts and tables\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663865c
    [Tags]  Tvh663865c  srts  wsrts
    [Setup]  Run Keywords
    ...  General Test Case Setup
    [Teardown]  Run Keywords
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663865c
...
Tvh663071c
    [Documentation]  Verify sorting and columns reordering on tables\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663071c
    [Tags]  srts  wsrts  Tvh663071c
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Outgoing Destinations Reporting Test Case
    ...  Initialize Tvh664182c
    ...
    Set Test Variable  ${TEST_ID}  Tvh663071c
    ...
    Email Report Table Sort Column  ${table_name}
    ...
    ${col_index_before}=  Email Report Table Get Column Index  ${table_name}
    ...  Clean  should_navigate_to_table=${False}
    Email Report Table Drag Column  ${table_name}
    ...  Clean  Spam Detected  should_navigate_to_table=${False}
    Sleep  10
    ${col_index_after}=  Email Report Table Get Column Index  ${table_name}
    ...  Clean  should_navigate_to_table=${False}
    Should Not Be Equal As Integers  ${col_index_before}  ${col_index_after}

Tvh664182c
    [Documentation]  Verify sorting and columns reordering on tables\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh664182c
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh664160c
    [Tags]  Tvh664182c  Tvh664160c  srts  wsrts
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Outgoing Destinations Reporting Test Case
    ...  Initialize Tvh664182c
    ...
    ...  Finalize Outgoing Destinations Reporting Test Case
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh664182c
...
Tvh664309c
    [Documentation]  Verify sorting and columns reordering on tables\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh664309c
    [Tags]  Tvh664309c  srts  wsrts
    [Setup]  Run Keywords
    ...  General Test Case Setup
    [Teardown]  Run Keywords
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh664309c

    Set Test Variable  ${table_name}  Virus Types Detail
    Set Test Variable  ${total_msgs_count}  5
    Switch TO ESA
    Inject Messages
    ...  mbox-filename=${EICAR_COM_ZIP}
    ...  num-msgs=${total_msgs_count}
    ...
    Email Report Table Sort Column  ${table_name}
    ...  Incoming Messages  should_navigate_to_table=${False}
    ${cnt} =  Get Matching Xpath Count
    ...  //table[@summary]/thead/tr/th[starts-with(.//text(), "Incoming Messages")]//span[@class="dt-sort-disabled"]
    Should Be True  ${cnt} > 0

    ${col_index_before}=  Email Report Table Get Column Index  ${table_name}
    ...  Total Infected Messages  should_navigate_to_table=${False}
    Email Report Table Drag Column  ${table_name}
    ...  Total Infected Messages  Incoming Messages  should_navigate_to_table=${False}
    Sleep  10
    ${col_index_after}=  Email Report Table Get Column Index  ${table_name}
    ...  Total Infected Messages  should_navigate_to_table=${False}
    Should Not Be Equal As Integers  ${col_index_before}  ${col_index_after}
...
Tvh663921c
    [Documentation]  Verify sorting and columns reordering on tables\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663921c
    [Tags]  Tvh663921c  srts  wsrts
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Tvh663921c
    [Teardown]  Run Keywords
    ...  Finalize Tvh663921c
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663921c
    ...
    Email Report Table Sort Column  ${table_name}
    ...  Incoming Virus Detected  should_navigate_to_table=${False}
    ${cnt} =  Get Matching Xpath Count
    ...  //table[@summary]/thead/tr/th[starts-with(.//text(), "Incoming Virus Detected")]//span[@class="dt-sort-disabled"]
    Should Be True  ${cnt} > 0

    ${col_index_before}=  Email Report Table Get Column Index  ${table_name}
    ...  Incoming Clean  should_navigate_to_table=${False}
    Email Report Table Drag Column  ${table_name}
    ...  Incoming Clean  Incoming Spam Detected  should_navigate_to_table=${False}
    Sleep  10
    ${col_index_after}=  Email Report Table Get Column Index  ${table_name}
    ...  Incoming Clean  should_navigate_to_table=${False}
    Should Not Be Equal As Integers  ${col_index_before}  ${col_index_after}
...
Tvh663215c
    [Documentation]  Verify sorting and columns reordering on tables\n
    ...  http://tims.cisco.com/warp.cmd?ent=Tvh663215c
    [Tags]  Tvh663215c  srts  wsrts
    [Setup]  Run Keywords
    ...  General Test Case Setup
    ...  Initialize Tvh663215c
    [Teardown]  Run Keywords
    ...  Finalize Tvh663215c
    ...  General Test Case Teardown
    Set Test Variable  ${TEST_ID}  Tvh663215c
    ...
    ${col_index_before}=  Email Report Table Get Column Index  ${table_name}
    ...  Stopped as Invalid Recipients  should_navigate_to_table=${False}
    Email Report Table Drag Column  ${table_name}
    ...  Stopped as Invalid Recipients  Total Attempted  should_navigate_to_table=${False}
    Sleep  10
    ${col_index_after}=  Email Report Table Get Column Index  ${table_name}
    ...  Stopped as Invalid Recipients  should_navigate_to_table=${False}
    Should Not Be Equal As Integers  ${col_index_before}  ${col_index_after}
