# $Id: //prod/main/sarf_centos/variables/error_log_branches/coeus75.py#1 $
...
LOG_ERROR_PATTERNS = [
    ...
    '-v -E "\[Errno 2\] No such file or directory.*/data/tmp/sophos/ide.*egg/sophos_update.py"', # Bug 90152
    ...
    # skip in coeus75 because of bug CSCzv44441; it should be fixed in coeus80
