# $Id: //prod/main/sarf_centos/variables/environment/cs1_lab.py#3 $
# $DateTime: 2019/06/12 01:54:47 $
# $Author: revlaksh $

"""
==============================================================================
                        CS1 Lab Test Environment
==============================================================================
Robot variable file for .cs1 lab.
...
IIS_SERVER = 'ad01.cs1'
IIS_SERVER_UNIX_FORMAT = 'ad02.cs1'
...
# Upstream proxy
UPSTRM_PROX1 = "sarf-squid.cs1"

# SSW
# M1 is an alias for Management Interface
...
AD1_USER = 'user1'
AD1_USER_PW = 'pass1'
AD1_BASE_DN = 'cn=Users,dc=ad01,dc=cs1'
AD1_BIND_BASE_DN = 'cn=user1,cn=Users,dc=ad01,dc=cs1'
...
AD2_USER = 'user1'
AD2_USER_PW = 'pass1'
AD2_BASE_DN = 'cn=Users,dc=ad02,dc=cs1'
AD2_BIND_BASE_DN = 'cn=user1,cn=Users,dc=ad02,dc=cs1'
AD2_BIND_BASE_PW = 'pass1'
AD2_JOIN_USER = 'administrator'
AD2_JOIN_PW = 'Cisco1234$'

#Windows 2008 Active Directory server
WIN2K8_AD_SERVER = 'ad01.cs1'
WIN2K8_AD_DOMAIN = 'AD01.CS1'
...
LDAP_AUTH_SERVER = 'ad1.cs1'
LDAP_AUTH_PORT = '389'
LDAP_BASE_DN = 'dc=ad01,dc=cs1'
USER_NAME_ATTR = 'uid'
USER_FILTER_QUERY     =  'objectclass'
LDAP_ADMIN_DN = 'cn=administrator,cn=Users,dc=ad01,dc=cs1'
...
RADIUS_SERVER = 'radius-server.cs1'
RADIUS_PORT = '1812'
...
THIRD_PARTY_TOOLS_UPDATE_SERVER = 'updater1.cs1.devit.ciscolabs.com:443'
UPDATE_SERVER = 'updater1.cs1.devit.ciscolabs.com'
UPDATE_SERVER_01  = 'updater1.cs1.devit.ciscolabs.com'
...
NTLM_AUTH_SERVER_01 =   'ntlm-server01.cs1'
NTLM_AUTH_SERVER_02 =   'ntlm-server02.cs1'
NTLM_AUTH_SERVER_03 =   'ntlm-server03.cs1'
NTLM_AUTH_SERVER_04 =   'ntlm-server04.cs1'
NTLM_AUTH_SERVER_05 =   'ntlm-server05.cs1'
NTLM_AUTH_SERVER_06 =   'ntlm-server06.cs1'
NTLM_AUTH_SERVER_07 =   'ntlm-server07.cs1'
NTLM_AUTH_SERVER_08 =   'ntlm-server08.cs1'
NTLM_AUTH_SERVER_09 =   'ntlm-server09.cs1'
NTLM_AUTH_SERVER_10 =   'ntlm-server10.cs1'

AD_DOMAIN_01        =   'FOREST01.CS1'
AD_DOMAIN_02        =   'FOREST02.CS1'
AD_DOMAIN_03        =   'FOREST03.CS1'
AD_DOMAIN_04        =   'FOREST04.CS1'
AD_DOMAIN_05        =   'FOREST05.CS1'
AD_DOMAIN_06        =   'FOREST06.CS1'
AD_DOMAIN_07        =   'FOREST07.CS1'
AD_DOMAIN_08        =   'FOREST08.CS1'
AD_DOMAIN_09        =   'FOREST09.CS1'
AD_DOMAIN_10        =   'FOREST10.CS1'
...
#EXTERNAL LDAP
EX_BASE_DN            =  'dc=openldap-server01,dc=cs1'
...
EX_LDAP_AUTH_SERVER = 'openldap-server01.cs1'
EX_LDAP_ADMIN_PASS = 'ironport'
EX_LDAP_ADMIN_DN = 'cn=ldapadmin,dc=openldap-server01,dc=cs1'

#FEEDS_SERVERS
FEED_SERVER        =     'ad01.cs1'
NGINX_SERVER       =     'nginxserver.cs1'
LIGHTTPD_SERVER    =     'lighttpdserver.cs1'

#WCCP ROUTER IP. This IP Adrress belongs to CS1 Lab
...
#Required for KEYTAB testing
UPQ_DNS_IP           =    '10.10.201.154'
KERBEROS_HOST    =    'wsa113-client02.cs1'
KERBEROS_USER    =    'root'
KERBEROS_PASSWD  =    'cisco123'
KUSER            =    'administrator'
KPASSWD          =    'ironport'
AD1_SERVER_KEYTAB =   'W2012-01.AD04.CS1'
AD1_DOMAIN_KEYTAB =   'W2012-01.AD04.CS1'
AD1_JOIN_USER_KEYTAB = 'administrator'
AD1_JOIN_PW_KEYTAB =   'ironport'
KERBEROS_HA_SERVICEUSER = 'haserviceuser'
KERBEROS_HA_PW          = 'ironport'

#Required for NTPAUTH testing
UPQ_NTP_SERVER     =   '10.56.60.17'
UPQ_NTP_KEY_ID     =   '1'
UPQ_NTP_KEY_VALUE  =   'Ironport'
