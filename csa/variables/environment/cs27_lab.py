# $Id: //prod/main/sarf_centos/variables/environment/cs27_lab.py#1 $
# $DateTime: 2019/05/28 00:19:36 $
# $Author: sarukakk $

"""
==============================================================================
 cs27 PCloud lab Test Environment
==============================================================================
Robot variable file for .cs27 lab.
...
"""
==============================================================================
 cs27 PCloud lab Test Environment for WSA
==============================================================================
"""
REGION = 'America'
...
IIS_SERVER = 'ad1.cs27'
#IIS_SERVER_UNIX_FORMAT = 'ad2.cs27'
...
# Upstream proxy
#UPSTRM_PROX1 = "squid-server01.cs27"
...
AD1_SERVER = 'ad1.kosmos.cs27'
AD1_SERVER_IP = '10.10.13.221'
AD1_DOMAIN = 'KOSMOS.CS27'
AD1_NET_DOMAIN = 'KOSMOS'
AD1_USER = 'user1'
AD1_USER_PW = 'Ironport123'
AD1_BASE_DN = 'cn=Users,dc=kosmos,dc=cs27'
AD1_BIND_BASE_DN = 'cn=user1,cn=Users,dc=kosmos,dc=cs27'
...
RADIUS_SERVER = 'radius-server01.cs27'
RADIUS_PORT = '1812'
RADIUS_SECRET = 'cisco123'
RADIUS_USER = 'user1'
RADIUS_USER_PASSWORD = 'user1pass'
RADIUS_CLASS_ATTRIBUTE = 'user1'
# RADIUS_CLASS_ATTRIBUTE = 'radadmins'  -- Old value - Changed on 30-oct-2020
...
#ISE Server Details
ISE_SERVER_HOST_NAME = 'ISESErver.cs27.devit.ciscolabs.com'
...
KERBEROSE_CLIENT_HOST = 'Kerberos-client02.cs27'
...
"""
==============================================================================
 cs27 PCloud lab Test Environment for ESA
==============================================================================
"""
...
LDAP_AUTH_SERVER = 'LdapServer.cs27'
...
#LDAP_ADMIN_DN = 'cn=administrator,cn=Users,dc=ad1,dc=cs27'
#LDAP_ADMIN_PASS = 'Cisco1234$'
LDAP_BIND_BASE_DN = 'cn=administrator,cn=Users,dc=ad1,dc=cs27'
...
NTP_SERVER     =   'ntp-server.cs27'
NTP_SERVER_IP  =   '10.10.13.231'
NTP_KEY_ID     =   '498'
NTP_KEY_VALUE  =   'NTPv4'
...
TEST_USER_GROUP_MAPPING = 'lys-alpha-users'
