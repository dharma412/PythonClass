...
atlas_newuser= os.path.join(path,'atlas_newuser.json')
...
with open(atlas_newuser) as jsonfile:
    newuser_data=json.load(jsonfile)
...
newuser_data['newuser']['username']=newuser_data['newuser']['username']+allowed_characters
ATLAS_CUSTOMER_DATA = get_namedtuple(customer_data['customer'])
ATLAS_NEWUSER_DATA =get_namedtuple(newuser_data['newuser'])
